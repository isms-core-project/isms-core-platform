...
def create_investigation_workflow_sheet(ws, styles):
    ...
    incident_type_dv = DataValidation(type="list",
        formula1='"Malware,Brute Force Attack,Unauthorized Access,Data Exfiltration,DDoS,Phishing,Insider Threat,Configuration Error,Other"',
        allow_blank=True)
...
def create_analysis_tools_sheet(ws, styles):
    ...
    example_data = [
        ...
        "Centralized log aggregation and analysis", "15", "Daily",
...
def create_approval_signoff_sheet(ws, styles):
    ...
    acknowledgments = [
        ...
        "☐ Alert management assessed and tuning prioritized",
