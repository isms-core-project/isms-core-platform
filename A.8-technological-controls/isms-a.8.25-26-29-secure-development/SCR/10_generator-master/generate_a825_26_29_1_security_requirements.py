...
def build_application_inventory_sheet(wb, styles, validations):
    ...
    example_data = [
        ...
        ["Finance Dashboard", "APP-005", "Carol Davis", "High", "High Risk", "React + Node.js", "AWS Cloud", "SOX, GDPR", "No", "2025-01-08"],
    ]
...
def build_requirements_documentation_sheet(wb, styles, validations):
    ...
    example_data = [
        ["Customer Portal", "Yes", "/docs/security-requirements/APP-001-sec-req.pdf", "2025-01-10", "Yes", "Jane Doe", "2025-01-12", 95, 90, 100],
        ["Internal HR System", "Yes", "/docs/security-requirements/APP-002-sec-req.pdf", "2024-11-20", "Yes", "John Smith", "2024-11-25", 85, 80, 90],
        ["Marketing Website", "Partial", "/docs/security-requirements/APP-003-baseline.pdf", "2024-12-15", "Yes", "Alice Johnson", "2024-12-18", 60, 50, 70],
        ["Employee Portal", "Yes", "/docs/security-requirements/APP-004-sec-req.pdf", "2024-11-15", "Yes", "Bob Williams", "2024-11-18", 88, 85, 92],
        ["Finance Dashboard", "Yes", "/docs/security-requirements/APP-005-sec-req.pdf", "2025-01-05", "Yes", "Carol Davis", "2025-01-07", 92, 88, 95],
    ]
...
def build_threat_modeling_sheet(wb, styles, validations):
    ...
    # Example data with formulas
    example_data = [
        ["Customer Portal", "Yes", "STRIDE", "/docs/threat-models/APP-001-threat-model.pdf", "2025-01-08", "Yes", "Yes", "Yes", "✅ Approved", "Jane Doe"],
        ["Internal HR System", "Yes", "STRIDE", "/docs/threat-models/APP-002-threat-model.pdf", "2024-11-18", "Yes", "Yes", "Yes", "✅ Approved", "John Smith"],
        ["Marketing Website", "No", "N/A", "", "", "No", "No", "No", "❌ Not Approved", ""],
        ["Employee Portal", "Yes", "STRIDE", "/docs/threat-models/APP-004-threat-model.pdf", "2024-11-12", "Yes", "Yes", "Partial", "⏳ Pending", "Bob Williams"],
        ["Finance Dashboard", "Yes", "STRIDE", "/docs/threat-models/APP-005-threat-model.pdf", "2025-01-03", "Yes", "Yes", "Yes", "✅ Approved", "Carol Davis"],
    ]
...
def build_evidence_register_sheet(wb, styles, validations):
    ...
    cell = ws['A2']
    cell.value = "Centralized register of all security requirements evidence"
    apply_style(cell, styles['subheader'])
    ...
    # Example data
    example_data = [
        ["Security Requirements", "Customer Portal", "APP-001 Security Requirements v1.2", "/docs/security-requirements/APP-001-sec-req.pdf", "2025-01-10", "Jane Doe", "Current"],
        ...
        ["Security Requirements", "Internal HR System", "APP-002 Security Requirements v1.0", "/docs/security-requirements/APP-002-sec-req.pdf", "2024-11-20", "John Smith", "Current"],
        ...
        ["Security Requirements", "Marketing Website", "APP-003 Baseline Security Requirements", "/docs/security-requirements/APP-003-baseline.pdf", "2024-12-15", "Alice Johnson", "Outdated"],
    ]
