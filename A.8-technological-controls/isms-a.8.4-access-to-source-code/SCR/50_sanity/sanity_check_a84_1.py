...
**Usage:**
    python3 sanity_check_a84_1.py ISMS-IMP-A.8.4.1_Repository_Access_YYYYMMDD.xlsx
...
def main():
    if len(sys.argv) < 2:
        ...
        print("\nExample:")
        print("  python3 sanity_check_a84_1.py ISMS-IMP-A.8.4.1_Repository_Access_20250125.xlsx")
        print("\nExit codes:")
