...
Cross-platform recovery capabilities SHALL be documented in recovery procedures (ISMS-IMP-A.8.13-14-5.30-S2, S3) and validated through annual testing per Section 2.3.4.
...
- Standardized template maintained in ISMS-IMP-A.8.13-14-5.30-S4 (Recovery Testing Process)
