...
Control A.8.13 requirements, supporting evidence-based validation of data
...
Basic Usage:
    python3 generate_a813_1_backup_inventory.py

Advanced Usage:
    # Generate with custom output directory
    python3 generate_a813_1_backup_inventory.py --output /path/to/dir
    
    # Generate with specific date suffix
    python3 generate_a813_1_backup_inventory.py --date 20250125
...
Control Reference:    ISO/IEC 27001:2022 Annex A Control A.8.13
