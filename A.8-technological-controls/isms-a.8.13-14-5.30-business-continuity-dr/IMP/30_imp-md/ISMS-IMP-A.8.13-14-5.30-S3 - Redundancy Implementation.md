...
| Attribute | Value |
|-----------|-------|
| **Document ID** | ISMS-IMP-A.8.13-14-5.30-S3 |
| **Version** | 1.0 |
| **Assessment Area** | Redundancy & High Availability Implementation |
| **Related Policy** | ISMS-POL-A.8.13-14-5.30, Section 2.2 (Redundancy Requirements) |
| **Related Assessment** | ISMS-IMP-A.8.13-14-5.30-S1 (BIA - provides RTO requirements) |
...
**END OF ISMS-IMP-A.8.13-14-5.30-S3**
