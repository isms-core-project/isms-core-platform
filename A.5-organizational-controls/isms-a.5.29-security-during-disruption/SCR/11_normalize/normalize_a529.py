...
"""
================================================================================
A.5.29 Workbook Normalizer
================================================================================

Normalizes all A.5.29 workbooks to ensure consistent formatting, styling,
and structure across all generated Excel files.

Usage:
    python3 normalize_a529.py
================================================================================
"""
...
def normalize_workbook(filepath: Path) -> bool:
    ...
    try:
        ...
        for ws in wb.worksheets:
            ...
            # Ensure column headers have consistent styling
            if ws.max_row >= 3:
                for cell in ws[3]:
                    if cell.value:
...
def main() -> int:
    ...
    workbooks = list(WORKBOOK_DIR.glob("ISMS-IMP-A.5.29*.xlsx"))

    if not workbooks:
        logger.info("No A.5.29 workbooks found to normalize")
        return 0
