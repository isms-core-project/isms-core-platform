...
def create_detection_mechanisms(ws, styles):
    ...
    questions = [
        ("Q1", "SIEM", "What SIEM platform(s) does [Organization] use?", "Text"),
        ...
        ("Q24", "Coverage", "Category 2: Unauthorized Access Detection", "Yes/Partial/No"),
...
def create_alert_handling(ws, styles):
    ...
    questions = [
        ...
        ("Q37", "Triage", "How are alerts prioritized in queue?", "Automated/Manual/FIFO/No Process"),
        ...
        ("Q47", "Playbooks", "Playbook: Unauthorized Access", "Yes/No"),
...
def create_detection_effectiveness(ws, styles):
    ...
    questions = [
        ...
        ("Q107", "Coverage", "Coverage gaps prioritized?", "Yes/No"),
