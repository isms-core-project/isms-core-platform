...
your organization's specific vendor management processes, contract requirements,
...
def create_workbook() -> Workbook:
    ...
    sheets = [
        ...
        "5. Data Sovereignty",
        "6. Forensics & Audit",
        "7. Jurisdictional Risk",      # NEW in v1.0
...
def main():
    ...
    logger.info("[7/10] Creating 7. Jurisdictional Risk sheet (NEW - CLOUD Act)...")
    ...
    logger.info("  7.  Jurisdictional Risk (NEW - CLOUD Act assessment)")
