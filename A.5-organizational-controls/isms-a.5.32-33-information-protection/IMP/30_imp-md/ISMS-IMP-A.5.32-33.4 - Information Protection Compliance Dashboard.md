**ISMS-IMP-A.5.32-33.4 - Information Protection Compliance Dashboard**
...
| Attribute | Value |
|-----------|-------|
| **Document ID** | ISMS-IMP-A.5.32-33.4 |
| **Version** | 1.0 |
...
**Dashboard Name:** ISMS-IMP-A.5.32-33.4 - Information Protection Compliance Dashboard
...
- [ ] ISMS-IMP-A.5.32-33.1 - IP Rights Inventory (current period)
...
**Filename:** `ISMS-IMP-A.5.32-33.4_Information_Protection_Compliance_Dashboard_[YYYYMMDD].xlsx`
