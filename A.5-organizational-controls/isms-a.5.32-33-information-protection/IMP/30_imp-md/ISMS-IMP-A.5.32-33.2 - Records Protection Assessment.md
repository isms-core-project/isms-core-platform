**ISMS-IMP-A.5.32-33.2 - Records Protection Assessment**
...
| Attribute | Value |
|-----------|-------|
| **Document ID** | ISMS-IMP-A.5.32-33.2 |
| **Version** | 1.0 |
...
**Assessment Name:** ISMS-IMP-A.5.32-33.2 - Records Protection Assessment
...
|------------|-------|--------------------------|
| ISMS-IMP-A.5.32-33.1 | IP Rights Inventory | Provides IP classification that may apply to records |
| **ISMS-IMP-A.5.32-33.2** | **Records Protection** | **Core - HOW records are protected** |
| ISMS-IMP-A.5.32-33.3 | Retention & Disposal | Uses protection assessment to inform disposal decisions |
...
**Filename:** `ISMS-IMP-A.5.32-33.2_Records_Protection_Assessment_[YYYYMMDD].xlsx`
...
|----------|-----------------|---------------|
| ISMS-IMP-A.5.32-33.1 | IP classification | IP records protection requirements |
| ISMS-IMP-A.5.32-33.3 | Retention schedule | Protection informs disposal |
| ISMS-IMP-A.5.32-33.4 | Dashboard | Metrics feed dashboard |
