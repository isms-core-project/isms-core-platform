...
def create_instructions_sheet(ws, styles):
    ...
    instructions = [
        ...
        "- Restricted: Cross-cut shredding P-5, NIST 800-88 Purge, witnessed destruction",
        "- Confidential: Cross-cut shredding P-4, NIST 800-88 Clear",
...
def create_disposal_method_matrix_sheet(ws, styles):
    ...
    methods = [
        ["Restricted", "Cross-cut P-5, witnessed incineration",
         ...
         "NIST 800-88 Purge, cryptographic erasure",
        ...
        ["Confidential", "Cross-cut shredding P-4",
         ...
         "NIST 800-88 Clear, secure deletion",
