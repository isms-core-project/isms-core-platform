...
"""
================================================================================
A.5.32-33 Sanity Check Script
================================================================================

Validates all A.5.32-33 Information Protection workbooks for:
...
Usage:
    python3 sanity_check_a532_33.py
================================================================================
"""
...
EXPECTED_WORKBOOKS = {
    "A.5.32-33.1": {
        ...
        "required_sheets": [
            ...
            "Third_Party_IP_Register",
            "Software_License_Compliance",
            "Gap_Analysis",
            "Evidence_Register",
            "Approval_SignOff",
        ]
...
def check_workbook(filepath: Path, expected_sheets: list) -> tuple:
    ...
    try:
        ...
        if formula_count > 0:
            ...
            # Not all workbooks require formulas, so this is just informational
            pass
