...
| **Related IMPs** | ISMS-IMP-A.5.10-11.2, ISMS-IMP-A.5.10-11.3, ISMS-IMP-A.5.10-11.4 |
| **Version** | 1.0 |
...
| **Output Filename** | `ISMS-IMP-A.5.10-11.1_Acceptable_Use_Policy_Assessment_YYYYMMDD.xlsx` |
...
```python
# =============================================================================
# ISMS-IMP-A.5.10-11.1 - Acceptable Use Policy Assessment Generator
# =============================================================================
...
mv ISMS-IMP-A.5.10-11.1_*.xlsx ../90_workbooks/
```
