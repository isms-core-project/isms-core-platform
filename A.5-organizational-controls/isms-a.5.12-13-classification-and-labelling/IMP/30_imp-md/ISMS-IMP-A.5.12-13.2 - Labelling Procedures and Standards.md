# ISMS-IMP-A.5.12-13.2 - Labelling Procedures and Standards
...
| Field | Value |
|-------|-------|
| **Document ID** | ISMS-IMP-A.5.12-13.2 |
| **Version** | 1.0 |
...
|   |   |   |-- ISMS-IMP-A.5.12-13.2_Labelling_Procedures_20260204.xlsx
|   |   |-- Evidence/
|   |   |   |-- Standards/
...
| Property | Value |
|----------|-------|
| Filename | `ISMS-IMP-A.5.12-13.2_Labelling_Procedures_and_Standards_YYYYMMDD.xlsx` |
