# ISMS-IMP-A.5.12-13.3 - Asset Classification Inventory
...
| Field | Value |
|-------|-------|
| **Document ID** | ISMS-IMP-A.5.12-13.3 |
| **Version** | 1.0 |
...
|   |   |   |-- ISMS-IMP-A.5.12-13.3_Asset_Classification_Inventory_20260204.xlsx
|   |   |-- Evidence/
|   |   |   |-- Inventory-Exports/
...
| Property | Value |
|----------|-------|
| Filename | `ISMS-IMP-A.5.12-13.3_Asset_Classification_Inventory_YYYYMMDD.xlsx` |
...
| ISMS-IMP-A.5.12-13.1 | Classification Scheme Definition | Classification scheme |
| ISMS-IMP-A.5.12-13.2 | Labelling Procedures and Standards | Labelling standards |
| ISMS-IMP-A.5.12-13.4 | Compliance Dashboard | Compliance monitoring |
| ISMS-IMP-A.5.12-13.5 | Consolidation Dashboard | Executive view |
