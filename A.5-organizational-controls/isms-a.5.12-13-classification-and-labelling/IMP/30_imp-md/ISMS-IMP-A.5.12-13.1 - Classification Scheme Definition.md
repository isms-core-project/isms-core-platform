# ISMS-IMP-A.5.12-13.1 - Classification Scheme Definition
...
| Field | Value |
|-------|-------|
| **Document ID** | ISMS-IMP-A.5.12-13.1 |
| **Version** | 1.0 |
...
|   |   |   |-- ISMS-IMP-A.5.12-13.1_Classification_Scheme_20260204.xlsx
|   |   |-- Evidence/
|   |   |   |-- Regulatory-Analysis/
...
| Property | Value |
|----------|-------|
| Filename | `ISMS-IMP-A.5.12-13.1_Classification_Scheme_Definition_YYYYMMDD.xlsx` |
...
| ISMS-IMP-A.5.12-13.2 | Labelling Procedures and Standards | Labelling implementation |
| ISMS-IMP-A.5.12-13.3 | Asset Classification Inventory | Asset tracking |
