...
"""
================================================================================
A.5.12-13 Workbook Normalizer
================================================================================

Normalizes all A.5.12-13 Classification and Labelling workbooks to ensure
consistent formatting, styling, and structure across all generated Excel files.

Usage:
    python3 normalize_a512_13.py
================================================================================
"""
...
CLASSIFICATION_COLORS = {
    "PUBLIC": "74C0FC",       # Blue
    "INTERNAL": "69DB7C",     # Green
    "CONFIDENTIAL": "FFA94D", # Orange
    "RESTRICTED": "FF6B6B"    # Red
}
...
def main() -> int:
    ...
    workbooks = list(WORKBOOK_DIR.glob("ISMS-IMP-A.5.12-13*.xlsx"))

    if not workbooks:
        logger.info("No A.5.12-13 workbooks found to normalize")
        return 0
