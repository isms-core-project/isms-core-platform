...
"""
================================================================================
ISMS A.5.30/14/5.30 - Assessment File Normalization Utility
================================================================================
...
formula linking in the ISMS-IMP-A.5.30.S5 BC/DR Compliance Dashboard. It scans
...
- ISMS-IMP-A.5.30.S1.xlsx
- ISMS-IMP-A.5.30.S2.xlsx
- ISMS-IMP-A.5.30.S3.xlsx
...
- Validates Document ID matches one of:
  * ISMS-IMP-A.5.30.S1 (Backup Inventory)
  * ISMS-IMP-A.5.30.S2 (Redundancy Analysis)
  * ISMS-IMP-A.5.30.S3 (RPO/RTO Compliance)
  * ISMS-IMP-A.5.30.S4 (Testing Results)
...
Basic Usage:
    ...
    python3 normalize_a530_assessments.py

Advanced Usage:
    # Specify source and output directories
    python3 normalize_a530_assessments.py --source ./assessments --output ./Dashboard_Sources
    
    # Automated mode (no prompts)
    python3 normalize_a530_assessments.py --source ./assessments --auto-confirm
...
Output Files:
    Normalized assessment workbooks:
        - ISMS-IMP-A.5.30.S1.xlsx (Backup Inventory)
        - ISMS-IMP-A.5.30.S2.xlsx (Redundancy Analysis)
        - ISMS-IMP-A.5.30.S3.xlsx (RPO/RTO Compliance)
        - ISMS-IMP-A.5.30.S4.xlsx (Testing Results)
...
Workflow Examples:
    ...
    1. Initial normalization (before first dashboard generation):
       python3 normalize_a530_assessments.py --source ./completed_assessments --output ./Dashboard_Sources
    
    2. Re-normalization after assessment updates:
       python3 normalize_a530_assessments.py --auto-confirm
    
    3. Automated integration in scripts:
       python3 normalize_a530_assessments.py --source "$ASSESSMENT_DIR" --output "$DASHBOARD_DIR" -y
...
Related Documents:
    ...
    - ISMS-IMP-A.5.30.S1: Backup Inventory Assessment (Source File)
    - ISMS-IMP-A.5.30.S2: Redundancy Analysis Assessment (Source File)
    - ISMS-IMP-A.5.30.S3: RPO/RTO Compliance Matrix (Source File)
    - ISMS-IMP-A.5.30.S4: BC/DR Testing Results Tracker (Source File)
    - ISMS-IMP-A.5.30.S5: BC/DR Compliance Dashboard (Target for linking)

Related Scripts:
    - generate_a530_1_backup_inventory.py
    - generate_a530_2_redundancy_analysis.py
    - generate_a530_3_rpo_rto_compliance.py
    - generate_a530_4_testing_results.py
    - generate_a530_5_compliance_dashboard.py
...
Excel external workbook formulas reference specific filenames:
    ='[ISMS-IMP-A.5.30.S1.xlsx]Backup_Inventory'!$B$15
...
EXPECTED_DOCS = {
    "ISMS-IMP-A.5.30.S1": {
        ...
        "normalized": "ISMS-IMP-A.5.30.S1.xlsx"
    },
    "ISMS-IMP-A.5.30.S2": {
        "title": "Redundancy Analysis & SPOF Assessment",
        "normalized": "ISMS-IMP-A.5.30.S2.xlsx"
    },
    "ISMS-IMP-A.5.30.S3": {
        "title": "RPO/RTO Compliance Matrix",
        "normalized": "ISMS-IMP-A.5.30.S3.xlsx"
    },
    "ISMS-IMP-A.5.30.S4": {
        "title": "BC/DR Testing Results Tracker",
        "normalized": "ISMS-IMP-A.5.30.S4.xlsx"
    },
}
...
def create_manifest(results, output_dir):
    ...
    with open(manifest_path, 'w') as f:
        ...
        f.write("Control A.5.30 - Information Backup\n")
        f.write("=" * 80 + "\n\n")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Normalize A.5.30 assessment files for dashboard linking',
...
Examples:
  ...
  python3 normalize_a530_assessments.py --source ./assessments --auto-confirm
    ...
    print("ISO/IEC 27001:2022 - Control A.5.30: Information Backup")
    print("=" * 80)
    print()
    ...
    print()
    print("NEXT STEPS:")
    print(f"  1. Generate dashboard: python3 generate_a530_5_dashboard.py")
