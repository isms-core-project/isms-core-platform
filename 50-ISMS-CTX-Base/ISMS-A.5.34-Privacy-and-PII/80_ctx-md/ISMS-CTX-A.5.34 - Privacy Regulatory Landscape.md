...
## 2. GDPR (General Data Protection Regulation) - Detailed Context

### 2.1 GDPR Overview and Applicability
...
### 2.2 GDPR Territorial Scope (Article 3)
...
### 2.3 GDPR Core Principles (Article 5)
...
### 2.4 GDPR Legal Bases - Practical Interpretation
...
### 2.5 GDPR Special Category Data (Article 9)
...
### 2.6 GDPR Penalties and Enforcement
...
## 3. FADP (Swiss Federal Act on Data Protection) - Detailed Context

### 3.1 FADP Overview (Revised nDSG)
...
### 3.2 FADP Scope and Applicability
...
### 3.3 FADP Key Definitions (Article 5)
...
### 3.4 FADP Data Protection Principles (Article 6)
...
### 3.5 FADP Data Security (Article 8)
...
### 3.7 FADP Data Breach Notification (Article 24)
...
### 3.8 FADP Cross-Border Data Transfers (Articles 16-17)
...
### 3.9 FADP vs. Old Swiss Data Protection Act
...
## 4. GDPR vs. FADP - Comparative Analysis
...
### 4.4 Common Pitfalls in Dual Compliance
...
## 5. International Data Transfer Mechanisms - Deep Dive

### 5.1 Why Cross-Border Transfer Restrictions Exist
...
### 5.2 Adequacy Decisions - Detailed Context
...
### 5.3 Standard Contractual Clauses (SCCs) - Practical Guidance
...
### 5.5 Derogations (Last Resort Exceptions)
...
## 6. Privacy Frameworks and Standards - Landscape

### 6.1 ISO/IEC 27701:2019 - Privacy Information Management System
...
## 7. Enforcement Landscape - Context from Notable Cases

### 7.1 Key Lessons from Major Enforcement Actions
...
## 8. Practical Takeaways for Implementation

### 8.1 Key Questions for Privacy Program Design
...
### 8.2 Regulatory Evolution - Stay Current
