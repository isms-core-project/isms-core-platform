...
│    cancels and replaces the 2015 first edition)                 │
...
**Standard**: ISO/IEC 27017:2026 (Ed. 2) — Information technology — Security techniques — Code of practice for information security controls based on ISO/IEC 27002 for cloud services. Published 2026-07-29, cancels and replaces the 2015 first edition.
...
**Primary Home**: ISO 27017 is referenced in **ISMS-POL-00** (Tier 3) as a cloud security best practice, and is available as its own standalone product pack (Cloud Sec) on the ISMS CORE Platform. Its presence in PRIV-POL-00 is as a privacy-supporting reference only.
...
**Reference**: ISO/IEC 27017:2026, Information security controls for cloud services
...
- ISO/IEC 27017:2026: [if cloud-related controls]
```
...
|---------|---------|--------|-------|
| ISO/IEC 27017:2026 | Ed. 2, 2026 | Active — Tier 3 | Cloud security baseline (supports 27018 implementation); supersedes the 2015 first edition |
...
|---------|-------|--------------|
| ISO/IEC 27017:2026 | Cloud security baseline | priv-a.2.4 and priv-a.2.5 processor packs |
