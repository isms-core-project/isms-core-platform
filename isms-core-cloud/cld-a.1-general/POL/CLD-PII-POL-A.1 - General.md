...
This policy and the CLD-PII-POL-A.X policy suite applies to:
...
|------|-----------------|
| **CISO / Cloud Security Manager** | Maintains the CLD-PII-POL-A.X policy suite; ensures technical controls meet ISO 27018:2025 Annex A requirements; reports on cloud PII processor compliance |
...
| Control Implementation Documentation | Documentation of how each CLD-PII-POL-A.X control is implemented per service | Current version + previous versions for 3 years from supersession |
...
Auditors verifying compliance with CLD-PII-POL-A.1 should expect to find:
