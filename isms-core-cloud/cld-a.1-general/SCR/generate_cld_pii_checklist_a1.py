...
# =============================================================================
"""
CLD-PII-CHK-A.1 — General (Public Cloud PII Processor) Compliance Checklist
...
# DOCUMENT METADATA
# =============================================================================
DOCUMENT_ID = "CLD-PII-CHK-A.1"
CONTROL_ID = "A.1"
CONTROL_NAME = "General"
SOURCE_POLICY = "CLD-PII-POL-A.1"

# =============================================================================
# REQUIREMENTS DATA — extracted from CLD-PII-POL-A.1
# =============================================================================
...
REQUIREMENTS = OrderedDict([
    ("PII Processor Role Obligations", [
        ...
        ("A.1-04", "Control Implementation Map",
         "The organisation shall maintain a Control Implementation Map linking each CLD-PII-POL-A.X policy to the technical and organisational measures implementing it. The map shall be available to auditors and to PII controllers upon request, demonstrating the completeness of the ISO/IEC 27018:2025 Annex A implementation."),
    ]),

    ("Contract and Sub-processor Framework", [
        ("A.1-05", "Written Contract Requirement",
         "The organisation shall process PII only where a written contract with the PII controller is in place. The contract shall address at minimum: the scope of processing; security obligations; breach notification; sub-processor arrangements; data return or deletion; and audit rights — in accordance with CLD-PII-POL-A.11.11."),
        ...
        ("A.1-07", "Sub-processor Prior Consent",
         "The organisation shall engage sub-processors only with the prior written consent of the PII controller. General authorisation from the controller (covering a class of sub-processors) is acceptable where the service agreement provides for it, subject to the advance notification requirements in CLD-PII-POL-A.8.1."),
        ("A.1-08", "Sub-processor Accountability",
         "The organisation remains fully accountable to PII controllers for the performance of sub-processors' obligations. Sub-processor non-compliance is treated as processor non-compliance for the purposes of the controller agreement. Sub-processor arrangements are governed in detail by CLD-PII-POL-A.11.12."),
    ]),
])
