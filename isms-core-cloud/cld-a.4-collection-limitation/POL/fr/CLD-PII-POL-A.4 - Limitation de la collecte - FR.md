...
| **Identifiant du document** | CLD-PII-POL-A.4 |
...
**Note sur le principe** : La Section A.4 opère au niveau des principes. Cette politique traduit ce principe en obligations opérationnelles spécifiques pour les services cloud de [Organisation]. Les méthodes techniques de minimisation des données — incluant l'anonymisation, la pseudonymisation et la gestion des fichiers temporaires — sont traitées dans CLD-PII-POL-A.5.
...
- Les méthodes techniques d'anonymisation et d'effacement des fichiers temporaires — traitées dans CLD-PII-POL-A.5
...
Les auditeurs vérifiant la conformité à CLD-PII-POL-A.4 doivent s'attendre à trouver :
