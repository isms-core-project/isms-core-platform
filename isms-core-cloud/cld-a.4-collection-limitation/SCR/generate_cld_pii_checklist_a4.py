...
# =============================================================================
"""
CLD-PII-CHK-A.4 — Collection Limitation Compliance Checklist
...
# DOCUMENT METADATA
# =============================================================================
DOCUMENT_ID = "CLD-PII-CHK-A.4"
CONTROL_ID = "A.4"
CONTROL_NAME = "Collection Limitation"
SOURCE_POLICY = "CLD-PII-POL-A.4"

# =============================================================================
# REQUIREMENTS DATA — extracted from CLD-PII-POL-A.4
# =============================================================================
