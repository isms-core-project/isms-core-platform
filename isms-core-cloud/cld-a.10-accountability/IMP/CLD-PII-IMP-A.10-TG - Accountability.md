<!-- ISMS-CORE:IMP:CLD-PII-IMP-A.10-TG:cloud:TG:a.10 -->
...
| **Document ID** | CLD-PII-IMP-A.10-TG |
...
| `security_measures` *| Text | Reference to CLD-PII-POL-A.11 controls implemented for this processing |
...
### Breach Notification Required Content (per CLD-PII-POL-A.10.1)
...
Issue to the PII controller upon completion of end-of-contract disposal (Option B per CLD-PII-POL-A.10.3).
...
This certificate confirms that [Organisation] has completed the secure disposal of all PII processed on behalf of **[Controller name]** under service agreement **[ref]**, in accordance with CLD-PII-POL-A.10.3 and ISO/IEC 27018:2025 Control A.10.3.
...
|------------|-----------------|-------|---------------|--------|-------|
| Processor RoPA current and complete | CLD-PII-POL-A.10 | DPO | | | |
| All incidents notified within 24 hours | CLD-PII-POL-A.10.1 | DPO | | | |
| Breach notification records retained 5 years | CLD-PII-POL-A.10.2 | DPO | | | |
| CLD-PII-POL-A.X policy version history maintained | CLD-PII-POL-A.10.2 | DPO | | | |
| All terminated agreements have return/disposal confirmation | CLD-PII-POL-A.10.3 | DPO | | | |
| Certificates of destruction on file for all disposal cases | CLD-PII-POL-A.10.3 | DPO | | | |
| Sub-processor disposal confirmed for all terminated agreements | CLD-PII-POL-A.10.3 | CISO | | | |
| Annual DPO Accountability Review completed | CLD-PII-IMP-A.10-UG | DPO | | | |
...
3. DOCUMENT RETENTION COMPLIANCE
   - CLD-PII-POL-A.X versions archived per schedule: Yes / Gaps noted
