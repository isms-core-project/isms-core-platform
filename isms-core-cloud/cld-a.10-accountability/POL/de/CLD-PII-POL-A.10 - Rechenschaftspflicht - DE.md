...
|---------------|---------------------|
| CLD-PII-POL-A.X Cloud-Sicherheitsrichtlinien (alle Versionen) | 5 Jahre ab Versionssupersession |
...
| PII-Offenlegungsaufzeichnungen (CLD-PII-POL-A.6.2-Register) | 5 Jahre ab Offenlegung |
...
Alle CLD-PII-POL-A.X-Richtliniendokumente müssen eine Versionshistorie führen, die Dokumentversion, Datum, Autor und Zusammenfassung der Änderungen erfasst. Vorgängerversionen müssen gemäss dem obigen Aufbewahrungsplan aufbewahrt werden.
...
| Dokumentenversionsarchiv | Alle Vorgängerversionen der CLD-PII-POL-A.X-Richtlinien | 5 Jahre ab Versionssupersession |
...
Prüfende, die die Compliance mit CLD-PII-POL-A.10 verifizieren, sollten Folgendes vorfinden:
...
- Versionshistorie für alle CLD-PII-POL-A.X-Richtliniendokumente mit plankonformer Aufbewahrung
