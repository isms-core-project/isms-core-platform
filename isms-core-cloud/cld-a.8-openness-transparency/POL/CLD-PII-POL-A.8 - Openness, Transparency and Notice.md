...
- CLD-PII-POL-A.11 (Information Security — §11.12: Sub-contracted PII processing)
- CLD-PII-POL-A.12 (Privacy Compliance — geographical disclosure)
...
- Sub-processor contract content and security flow-down — addressed in CLD-PII-POL-A.11 (§11.12)
- Geographic location of PII processing — addressed in CLD-PII-POL-A.12.1
- Legally compelled disclosure notifications — addressed in CLD-PII-POL-A.6.1
...
[Organisation] SHALL conduct a documented security and privacy due diligence assessment of each sub-processor before engagement. The results SHALL be referenced in the Sub-Processor Register and the assessment methodology is addressed in CLD-PII-POL-A.11 (§11.12).
...
Auditors verifying compliance with CLD-PII-POL-A.8 should expect to find:
