...
# =============================================================================
"""
CLD-PII-CHK-A.3 — Purpose Legitimacy and Specification Compliance Checklist
...
# DOCUMENT METADATA
# =============================================================================
DOCUMENT_ID = "CLD-PII-CHK-A.3"
CONTROL_ID = "A.3.1-2"
CONTROL_NAME = "Purpose Legitimacy and Specification"
SOURCE_POLICY = "CLD-PII-POL-A.3"

# =============================================================================
# REQUIREMENTS DATA — extracted from CLD-PII-POL-A.3
# =============================================================================
