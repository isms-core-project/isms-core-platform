...
- CLD-PII-POL-A.11 (§11.12 — Unterbeauftragte PII-Verarbeitung)
...
- **Unterauftragsverarbeiter-Standorte**: Alle geografischen Standorte der gemäss CLD-PII-POL-A.11 (§11.12) beauftragten Unterauftragsverarbeiter
...
Prüfende, die die Compliance mit CLD-PII-POL-A.12 verifizieren, sollten Folgendes vorfinden:

- Ein aktuelles PII-Verarbeitungsstandort-Register, das alle Speicher-, Verarbeitungs- und Transitstandorte einschliesslich Unterauftragsverarbeiter abdeckt — konsistent mit der veröffentlichten Unterauftragsverarbeiter-Liste (CLD-PII-POL-A.8.1)
