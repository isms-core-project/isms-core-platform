<!-- ISMS-CORE:POLICY:CLD-POL-A.7-IT:cloud:POL:a.7 -->
**CLD-POL-A.7 — Esattezza e qualità**
...
| **Identificativo del documento** | CLD-POL-A.7 |
...
- CLD-POL-A.2 (Consenso e scelta — cooperazione per i diritti degli interessati)
...
Gli auditor che verificano la conformità a CLD-POL-A.7 devono aspettarsi di trovare:
