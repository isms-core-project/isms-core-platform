...
**CLD-PII-IMP-A.7-UG — Accuracy and Quality — User Guide**
...
| **Document ID** | CLD-PII-IMP-A.7-UG |
| **Related Policy** | CLD-PII-POL-A.7 (Accuracy and Quality) |
...
- CLD-PII-POL-A.7 (Accuracy and Quality — the governing policy)
- CLD-PII-IMP-A.7-TG (Accuracy and Quality — Technical Guide)
- CLD-PII-POL-A.2 (Consent and Choice — data subject rights cooperation)
- CLD-PII-POL-A.9 (Individual Participation and Access — controller tools for subject access)
- CLD-PII-POL-A.6 (Use, Retention and Disclosure Limitation — retention and deletion)
...
Rectification requests SHALL be submitted by the controller to the Cloud Service Delivery contact designated in the service agreement. All requests are logged in the Rectification Request Log (see CLD-PII-IMP-A.7-TG) upon receipt.
...
- A pre-correction snapshot of the affected record is captured and retained in the Audit Trail (see CLD-PII-IMP-A.7-TG)
