<!-- ISMS-CORE:POLICY:CLD-POL-A.12-FR:cloud:POL:a.12 -->
**CLD-POL-A.12 — Conformité en matière de protection des données**
...
| **Identifiant du document** | CLD-POL-A.12 |
...
- CLD-POL-A.11 (§11.12 — Traitement des DCP sous-traité)
...
- **Emplacements des sous-traitants ultérieurs** : Tous les emplacements géographiques des sous-traitants ultérieurs engagés conformément à CLD-POL-A.11 (§11.12)
...
Les sous-traitants ultérieurs sont contractuellement tenus de notifier [Organisation] de tout changement de l'emplacement géographique de leurs opérations de traitement des DCP dans les 10 jours ouvrables suivant le changement (conformément aux exigences des accords de sous-traitants ultérieurs de CLD-POL-A.11 §11.12). [Organisation] DOIT examiner les données d'emplacement des sous-traitants ultérieurs au minimum annuellement dans le cadre de l'audit annuel des sous-traitants ultérieurs en vertu de CLD-POL-A.11 §11.12, et mettre à jour le Registre des emplacements de traitement des DCP en conséquence.
...
Les auditeurs vérifiant la conformité avec CLD-POL-A.12 devraient s'attendre à trouver :

- Un Registre des emplacements de traitement des DCP actuel couvrant tous les emplacements de stockage, de traitement et de transit, y compris les sous-traitants ultérieurs — cohérent avec la liste publiée des sous-traitants ultérieurs (CLD-POL-A.8.1)
