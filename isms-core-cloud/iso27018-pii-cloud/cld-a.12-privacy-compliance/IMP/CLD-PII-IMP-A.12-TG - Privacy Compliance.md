<!-- ISMS-CORE:IMP:CLD-PII-IMP-A.12-TG:cloud:TG:a.12 -->
**CLD-PII-IMP-A.12-TG — Privacy Compliance — Technical Guide**
...
| **Document ID** | CLD-PII-IMP-A.12-TG |
| **Related Policy** | CLD-PII-POL-A.12 (Privacy Compliance) |
...
- CLD-PII-POL-A.12 (Privacy Compliance — the governing policy)
- CLD-PII-IMP-A.12-UG (Privacy Compliance — User Guide)
- CLD-PII-POL-A.11 (Information Security — sub-processor and security control obligations)
...
|---------|-------------|--------|-------------------|-------------------|
| **A.1 — General** | | | | |
| A.1 (principle) | Public cloud PII processor obligations established | ☐ Compliant / ☐ Partial / ☐ Gap | CLD-PII-POL-A.1 | |
| **A.2 — Consent and Choice** | | | | |
| A.2.1 | Co-operation for withdrawal of consent / rights | ☐ Compliant / ☐ Partial / ☐ Gap | CLD-PII-POL-A.2 | |
| **A.3 — Purpose Legitimacy** | | | | |
| A.3 (principle) | Processing only per documented controller instructions | ☐ Compliant / ☐ Partial / ☐ Gap | CLD-PII-POL-A.3 | |
| **A.4 — Collection Limitation** | | | | |
| A.4 (principle) | PII collection limited to what controllers supply | ☐ Compliant / ☐ Partial / ☐ Gap | CLD-PII-POL-A.4 | |
| **A.5 — Data Minimisation** | | | | |
| A.5.1 | PII minimised in service delivery | ☐ Compliant / ☐ Partial / ☐ Gap | CLD-PII-POL-A.5 | |
| A.5.2 | Temporary files erased after use | ☐ Compliant / ☐ Partial / ☐ Gap | CLD-PII-POL-A.5 | |
| **A.6 — Use, Retention and Disclosure** | | | | |
| A.6.1 | Purpose limitation — no secondary use | ☐ Compliant / ☐ Partial / ☐ Gap | CLD-PII-POL-A.6 | |
| A.6.2 | No disclosure without controller instruction | ☐ Compliant / ☐ Partial / ☐ Gap | CLD-PII-POL-A.6 | |
| A.6.3 | Disclosure log maintained | ☐ Compliant / ☐ Partial / ☐ Gap | CLD-PII-POL-A.6 | |
| A.6.4 | Retention schedule and deletion on expiry | ☐ Compliant / ☐ Partial / ☐ Gap | CLD-PII-POL-A.6 | |
| **A.7 — Accuracy and Quality** | | | | |
| A.7 (principle) | Rectification and quality mechanisms available | ☐ Compliant / ☐ Partial / ☐ Gap | CLD-PII-POL-A.7 | |
| **A.8 — Openness, Transparency and Notice** | | | | |
| A.8.1 | Sub-processor list disclosed and maintained | ☐ Compliant / ☐ Partial / ☐ Gap | CLD-PII-POL-A.8 | |
| A.8.2 | Controller notified of sub-processor changes | ☐ Compliant / ☐ Partial / ☐ Gap | CLD-PII-POL-A.8 | |
| **A.9 — Individual Participation and Access** | | | | |
| A.9 (principle) | Rights fulfilment capabilities documented and tested | ☐ Compliant / ☐ Partial / ☐ Gap | CLD-PII-POL-A.9 | |
| **A.10 — Accountability** | | | | |
| A.10.1 | Breach notification within 24 hours of detection | ☐ Compliant / ☐ Partial / ☐ Gap | CLD-PII-POL-A.10 | |
| A.10.2 | Document retention schedule enforced | ☐ Compliant / ☐ Partial / ☐ Gap | CLD-PII-POL-A.10 | |
| A.10.3 | PII return / disposal on contract termination | ☐ Compliant / ☐ Partial / ☐ Gap | CLD-PII-POL-A.10 | |
| **A.11 — Information Security** | | | | |
| A.11.1 | NDAs in place for all personnel with PII access | ☐ Compliant / ☐ Partial / ☐ Gap | CLD-PII-POL-A.11 | |
| A.11.2 | Hardcopy PII restrictions enforced | ☐ Compliant / ☐ Partial / ☐ Gap | CLD-PII-POL-A.11 | |
| A.11.3 | Backup restoration logged and controlled | ☐ Compliant / ☐ Partial / ☐ Gap | CLD-PII-POL-A.11 | |
| A.11.4 | Physical media encrypted or destroyed before leaving premises | ☐ Compliant / ☐ Partial / ☐ Gap | CLD-PII-POL-A.11 | |
| A.11.5 | Unencrypted portable devices prohibited | ☐ Compliant / ☐ Partial / ☐ Gap | CLD-PII-POL-A.11 | |
| A.11.6 | TLS 1.2+ enforced for PII in transit | ☐ Compliant / ☐ Partial / ☐ Gap | CLD-PII-POL-A.11 | |
| A.11.7 | Hardcopy disposal by certified cross-cut shredding | ☐ Compliant / ☐ Partial / ☐ Gap | CLD-PII-POL-A.11 | |
| A.11.8 | Unique user IDs — no shared accounts on PII systems | ☐ Compliant / ☐ Partial / ☐ Gap | CLD-PII-POL-A.11 | |
| A.11.9 | User ID lifecycle managed (provisioning to deactivation) | ☐ Compliant / ☐ Partial / ☐ Gap | CLD-PII-POL-A.11 | |
| A.11.10 | Authorised User Register maintained and attested quarterly | ☐ Compliant / ☐ Partial / ☐ Gap | CLD-PII-POL-A.11 | |
| A.11.11 | Contract measures in all DPAs | ☐ Compliant / ☐ Partial / ☐ Gap | CLD-PII-POL-A.11 | |
| A.11.12 | Sub-processors under equivalent contracts; audited annually | ☐ Compliant / ☐ Partial / ☐ Gap | CLD-PII-POL-A.11 | |
| A.11.13 | Pre-used storage cryptographically erased before reallocation | ☐ Compliant / ☐ Partial / ☐ Gap | CLD-PII-POL-A.11 | |
| **A.12 — Privacy Compliance** | | | | |
| A.12.1 | PII Processing Locations Register maintained and disclosed | ☐ Compliant / ☐ Partial / ☐ Gap | CLD-PII-POL-A.12 | |
| A.12.2 | Transfer destinations documented with valid transfer mechanisms | ☐ Compliant / ☐ Partial / ☐ Gap | CLD-PII-POL-A.12 | |
...
| 5 | CLD-PII-POL-A.1 through A.12 — all current policy versions accessible | DPO | ☐ Ready | |
...
2. AFFECTED CONTROLS / OBLIGATIONS
   [List A.12 and other CLD-PII-POL-A.X controls affected, and the nature of the impact]
