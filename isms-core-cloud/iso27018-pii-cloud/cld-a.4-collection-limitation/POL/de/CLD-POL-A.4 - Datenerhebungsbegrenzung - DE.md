<!-- ISMS-CORE:POLICY:CLD-POL-A.4-DE:cloud:POL:a.4 -->
...
- Technische Anonymisierungs- und Löschungsmethoden für temporäre Dateien — behandelt in CLD-POL-A.5
...
Prüfende, die die Compliance mit CLD-POL-A.4 verifizieren, sollten Folgendes vorfinden:
