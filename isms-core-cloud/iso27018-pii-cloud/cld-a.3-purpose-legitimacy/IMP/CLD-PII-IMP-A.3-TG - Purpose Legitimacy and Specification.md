...
| **Document ID** | CLD-PII-IMP-A.3-TG |
...
This record is completed whenever [Organisation] receives controller instructions that appear to require unlawful processing under CLD-PII-POL-A.3 or CLD-PII-IMP-A.3-UG, Part 3.
