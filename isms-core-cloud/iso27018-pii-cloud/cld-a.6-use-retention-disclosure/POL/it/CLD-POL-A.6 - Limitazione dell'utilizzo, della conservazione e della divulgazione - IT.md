<!-- ISMS-CORE:POLICY:CLD-POL-A.6-IT:cloud:POL:a.6 -->
...
| **Identificativo del documento** | CLD-POL-A.6 |
...
- CLD-POL-A.10 (Accountability — notifica delle violazioni, restituzione/smaltimento)
...
- I periodi di conservazione primari per i DCP a riposo — questi sono stabiliti dalle istruzioni del titolare del trattamento dei DCP e inclusi negli accordi di servizio. Laddove un'istruzione di conservazione sia in conflitto con un blocco legale o un'ordinanza di conservazione vincolante, [Organizzazione] conserva i DCP per il periodo legalmente richiesto e notifica il titolare del trattamento. Vedere CLD-POL-A.10.3 per la restituzione e lo smaltimento al termine del contratto.
- La restituzione o lo smaltimento dei DCP alla risoluzione del contratto — trattato in CLD-POL-A.10.3
...
Gli auditor che verificano la conformità a CLD-POL-A.6 devono aspettarsi di trovare:
