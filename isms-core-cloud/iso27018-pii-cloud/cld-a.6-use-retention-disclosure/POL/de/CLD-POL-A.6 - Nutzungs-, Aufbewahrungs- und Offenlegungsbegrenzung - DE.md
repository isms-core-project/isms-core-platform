<!-- ISMS-CORE:POLICY:CLD-POL-A.6-DE:cloud:POL:a.6 -->
...
- CLD-POL-A.5 (Datenminimerung)
- CLD-POL-A.10 (Rechenschaftspflicht — Verletzungsmeldung, Rückgabe/Entsorgung)
...
- Primäre Datenaufbewahrungsfristen für ruhende PII — diese werden durch die Weisungen des PII-Verantwortlichen festgelegt und in Dienstleistungsverträgen aufgenommen. Steht eine Aufbewahrungsanweisung im Widerspruch zu einem Legal Hold oder einer zwingenden Aufbewahrungsanordnung, bewahrt [Organisation] PII für den gesetzlich vorgeschriebenen Zeitraum auf und benachrichtigt den Verantwortlichen. Siehe CLD-POL-A.10.3 für Rückgabe und Entsorgung nach Vertragsende.
- Rückgabe oder Entsorgung von PII bei Vertragsbeendigung — behandelt in CLD-POL-A.10.3
...
Prüfende, die die Compliance mit CLD-POL-A.6 verifizieren, sollten Folgendes vorfinden:
