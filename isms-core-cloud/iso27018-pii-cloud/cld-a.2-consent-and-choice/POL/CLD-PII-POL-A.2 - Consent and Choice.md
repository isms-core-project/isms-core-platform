...
All sub-processors engaged by [Organisation] SHALL be contractually required to provide equivalent data subject rights cooperation capabilities and response timeframes — in accordance with CLD-PII-POL-A.11 (§11.12 — Sub-Processor Obligations).
...
Auditors verifying compliance with CLD-PII-POL-A.2 should expect to find:
