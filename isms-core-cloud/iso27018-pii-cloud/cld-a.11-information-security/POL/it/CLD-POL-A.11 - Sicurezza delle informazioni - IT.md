<!-- ISMS-CORE:POLICY:CLD-POL-A.11-IT:cloud:POL:a.11 -->
...
| **Identificativo del documento** | CLD-POL-A.11 |
...
- CLD-POL-A.5 (Minimizzazione dei dati — cancellazione dei file temporanei)
- CLD-POL-A.8 (Apertura, trasparenza — divulgazione dei sub-responsabili del trattamento)
- CLD-POL-A.10 (Accountability — notifica delle violazioni)
...
**La perdita o il furto** di qualsiasi dispositivo portatile che potenzialmente contenga DCP DEVE essere segnalato immediatamente al RSSI e al RPD e trattato come incidente di sicurezza DCP ai sensi di CLD-POL-A.10.1 e ISMS-POL-A.5.24-28.
...
- Requisiti di notifica delle violazioni (notifica al titolare del trattamento entro 24 ore per CLD-POL-A.10.1)
- Obblighi di assistenza ai diritti degli interessati (per CLD-POL-A.2.1 e CLD-POL-A.9)
...
- Requisiti di approvazione dei sub-responsabili del trattamento (per CLD-POL-A.8.1)
- Restituzione o cancellazione dei DCP alla cessazione (per CLD-POL-A.10.3)
...
[Organizzazione] DEVE imporre a tutti i sub-responsabili del trattamento, tramite contratti vincolanti, **obblighi equivalenti** a quelli di questa politica e dell'intera suite CLD-POL-A.X. I contratti con i sub-responsabili del trattamento DEVONO:
...
I revisori che verificano la conformità a CLD-POL-A.11 dovrebbero aspettarsi di trovare:
