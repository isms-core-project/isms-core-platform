<!-- ISMS-CORE:POLICY:CLD-POL-A.1-FR:cloud:POL:a.1 -->
...
| **Identifiant du document** | CLD-POL-A.1 |
...
Cette politique et la suite de politiques CLD-POL-A.X s'appliquent à :
...
|------|----------------|
| **RSSI / Responsable Sécurité Cloud** | Maintient la suite de politiques CLD-POL-A.X ; veille à ce que les contrôles techniques répondent aux exigences de l'Annex A d'ISO 27018:2025 ; rend compte de la conformité du sous-traitant de DCP en cloud |
...
| Documentation de mise en œuvre des contrôles | Documentation de la manière dont chaque contrôle CLD-POL-A.X est mis en œuvre par service | Version actuelle + versions précédentes pendant 3 ans à compter de la supersession |
...
Les auditeurs vérifiant la conformité à CLD-POL-A.1 doivent s'attendre à trouver :
