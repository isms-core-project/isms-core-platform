<!-- ISMS-CORE:POLICY:CLD-POL-A.1-IT:cloud:POL:a.1 -->
...
| **Identificativo del documento** | CLD-POL-A.1 |
...
Questa politica e la suite di politiche CLD-POL-A.X si applicano a:
...
|-------|---------------|
| **RSSI / Responsabile Sicurezza Cloud** | Mantiene la suite di politiche CLD-POL-A.X; garantisce che i controlli tecnici soddisfino i requisiti dell'Annex A di ISO 27018:2025; riferisce sulla conformità del responsabile del trattamento di DCP nel cloud |
...
| Documentazione di implementazione dei controlli | Documentazione di come ciascun controllo CLD-POL-A.X è implementato per servizio | Versione attuale + versioni precedenti per 3 anni dalla supersessione |
...
Gli auditor che verificano la conformità a CLD-POL-A.1 devono aspettarsi di trovare:
