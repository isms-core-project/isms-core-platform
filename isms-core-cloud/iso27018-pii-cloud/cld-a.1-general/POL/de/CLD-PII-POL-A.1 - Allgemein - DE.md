<!-- ISMS-CORE:POLICY:CLD-PII-POL-A.1-DE:cloud:POL:a.1 -->
...
- CLD-PII-POL-A.10 (Rechenschaftspflicht)
- CLD-PII-POL-A.11 (Informationssicherheit)
- CLD-PII-POL-A.12 (Datenschutz-Compliance)
...
Diese Richtlinie und die CLD-PII-POL-A.X-Richtliniensuite gilt für:
...
[Organisation] darf PII nur verarbeiten, wenn ein schriftlicher Vertrag mit dem PII-Verantwortlichen besteht. Dieser Vertrag muss mindestens den Verarbeitungsumfang, Sicherheitspflichten, Benachrichtigung bei Datenschutzverletzungen, Unterauftragsverarbeiter-Regelungen, Datenrückgabe/-löschung und Prüfrechte regeln — gemäss CLD-PII-POL-A.11 (§11.11 — Vertragsanforderungen).
...
[Organisation] darf Unterauftragsverarbeiter nur mit vorheriger schriftlicher Zustimmung des PII-Verantwortlichen einsetzen. Alle Unterauftragsverarbeiter müssen durch gleichwertige Datenschutzpflichten gebunden sein. [Organisation] bleibt gegenüber dem Verantwortlichen für die Compliance der Unterauftragsverarbeiter verantwortlich. Unterauftragsverarbeiter-Regelungen werden im Detail durch CLD-PII-POL-A.11 (§11.12 — Pflichten der Unterauftragsverarbeiter) geregelt.
...
|-------|---------------------|
| **ISB / Cloud Security Manager** | Pflegt die CLD-PII-POL-A.X-Richtliniensuite; stellt sicher, dass technische Kontrollen die Anforderungen von ISO 27018:2025 Annex A erfüllen; berichtet über die Compliance des Cloud-PII-Auftragsverarbeiters |
...
| Dokumentation der Kontrollumsetzung | Dokumentation der Umsetzung jeder CLD-PII-POL-A.X-Kontrolle pro Dienst | Aktuelle Version + Vorgängerversionen für 3 Jahre nach Ablösung |
...
Prüfende, die die Compliance mit CLD-PII-POL-A.1 verifizieren, sollten Folgendes vorfinden:
