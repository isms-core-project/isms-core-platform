...
**CLD-PII-IMP-A.8-UG — Openness, Transparency and Notice — User Guide**
...
| **Document ID** | CLD-PII-IMP-A.8-UG |
| **Related Policy** | CLD-PII-POL-A.8 (Openness, Transparency and Notice) |
...
- CLD-PII-POL-A.8 (Openness, Transparency and Notice — the governing policy)
- CLD-PII-IMP-A.8-TG (Openness, Transparency and Notice — Technical Guide)
- CLD-PII-POL-A.1 (General — processor relationship and service scope)
- CLD-PII-POL-A.11.12 (Sub-contracted PII processing — security flow-down to sub-processors)
- CLD-PII-POL-A.12 (Privacy Compliance — geographic disclosure of processing locations)
...
| Geographic Processing Locations | Trust portal | Countries or regions where PII processing occurs (per CLD-PII-POL-A.12) |
...
- A copy of the current Sub-Processor Register (see CLD-PII-IMP-A.8-TG)
...
4. Record the notification in the Controller Advance Notice log (see CLD-PII-IMP-A.8-TG)
...
2. Provide the ISO 27018 Transparency Disclosure (see CLD-PII-IMP-A.8-TG) and any available certification evidence
