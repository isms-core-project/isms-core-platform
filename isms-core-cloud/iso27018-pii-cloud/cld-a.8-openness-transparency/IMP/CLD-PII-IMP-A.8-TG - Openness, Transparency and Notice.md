...
| **Document ID** | CLD-PII-IMP-A.8-TG |
...
- CLD-PII-POL-A.11.12 (Sub-contracted PII processing)
...
|----------------|------------|----------|----------------|-------------|--------|
| Sub-Processor List | CLD-PII-POL-A.8 / GDPR Art. 28(2) | Trust portal (subscriber-accessible) | v___ | ___ | [ ] Current / [ ] Requires Update |
| Privacy Policy (processor-facing) | GDPR Art. 13–14 / FADP | [Organisation] website | v___ | ___ | [ ] Current / [ ] Requires Update |
| ISO 27018 Controls Summary | CLD-PII-POL-A.8 / ISO 27018:2025 | Trust portal | v___ | ___ | [ ] Current / [ ] Requires Update |
| Geographic PII Processing Locations | CLD-PII-POL-A.12 | Trust portal | v___ | ___ | [ ] Current / [ ] Requires Update |
...
| 7 | DPO | Sends controller notification where required (see CLD-PII-IMP-A.8-UG Part 2.3) |
