<!-- ISMS-CORE:POLICY:CLD-POL-A.8-DE:cloud:POL:a.8 -->
**CLD-POL-A.8 — Offenheit, Transparenz und Mitteilung**
...
- CLD-POL-A.11 (Informationssicherheit — §11.12: Unterbeauftragte PII-Verarbeitung)
- CLD-POL-A.12 (Datenschutz-Compliance — geografische Offenlegung)
...
- Vertragsinhalt und Sicherheitsweiterleitung bei Unterauftragsverarbeitern — behandelt in CLD-POL-A.11 (§11.12)
- Geografischer Standort der PII-Verarbeitung — behandelt in CLD-POL-A.12.1
- Benachrichtigungen bei gesetzlich erzwungenen Offenlegungen — behandelt in CLD-POL-A.6.1
...
[Organisation] muss vor der Beauftragung jedes Unterauftragsverarbeiters eine dokumentierte Sicherheits- und Datenschutz-Due-Diligence-Beurteilung durchführen. Die Ergebnisse müssen im Unterauftragsverarbeiter-Register referenziert werden; die Beurteilungsmethodik wird in CLD-POL-A.11 (§11.12) behandelt.
...
Prüfende, die die Compliance mit CLD-POL-A.8 verifizieren, sollten Folgendes vorfinden:
