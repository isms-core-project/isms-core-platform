<!-- ISMS-CORE:POLICY:CLD-POL-A.10-FR:cloud:POL:a.10 -->
...
| **Identifiant du document** | CLD-POL-A.10 |
...
|----------------|----------------------|
| Politiques de sécurité cloud CLD-POL-A.X (toutes versions) | 5 ans à compter de la supersession de version |
...
| Enregistrements de divulgation de DCP (registre CLD-POL-A.6.2) | 5 ans à compter de la divulgation |
...
Tous les documents de politique CLD-POL-A.X DOIVENT maintenir un historique des versions capturant la version du document, la date, l'auteur et le résumé des modifications. Les versions précédentes DOIVENT être conservées conformément au calendrier de conservation ci-dessus.
...
| Archive des versions des documents | Toutes les versions précédentes des politiques CLD-POL-A.X | 5 ans à compter de la supersession de version |
...
Les auditeurs vérifiant la conformité à CLD-POL-A.10 doivent s'attendre à trouver :
...
- Un historique des versions pour tous les documents de politique CLD-POL-A.X avec une conservation conforme au calendrier
