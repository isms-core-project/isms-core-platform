...
|---------------|-------------------|
| CLD-PII-POL-A.X cloud security policies (all versions) | 5 years from version supersession |
...
| PII disclosure records (CLD-PII-POL-A.6.2 register) | 5 years from disclosure |
...
All CLD-PII-POL-A.X policy documents SHALL maintain a version history capturing document version, date, author, and summary of changes. Previous versions SHALL be retained in accordance with the retention schedule above.
...
| Document Version Archive | All previous versions of CLD-PII-POL-A.X policies | 5 years from version supersession |
...
Auditors verifying compliance with CLD-PII-POL-A.10 should expect to find:
...
- Version history for all CLD-PII-POL-A.X policy documents with retention conforming to the schedule
