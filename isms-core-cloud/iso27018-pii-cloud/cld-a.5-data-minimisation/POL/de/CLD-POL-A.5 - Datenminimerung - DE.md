<!-- ISMS-CORE:POLICY:CLD-POL-A.5-DE:cloud:POL:a.5 -->
...
- CLD-POL-A.11 (Informationssicherheit — umfasst portable Datenträger, Verschlüsselung, Entsorgung)
...
- Aufbewahrungsfristen für primäre PII-Datenspeicher — behandelt in CLD-POL-A.6
- Sichere Entsorgung physischer Speichermedien — behandelt in CLD-POL-A.11
...
Dies wird im Detail in CLD-POL-A.11 (§11.13 — Zugang zu Daten auf zuvor genutztem Datenspeicherplatz) behandelt. Mandantenisolierungstests müssen mindestens jährlich und nach wesentlichen Änderungen an der Speicherinfrastruktur durchgeführt werden.
...
Prüfende, die die Compliance mit CLD-POL-A.5 verifizieren, sollten Folgendes vorfinden:
