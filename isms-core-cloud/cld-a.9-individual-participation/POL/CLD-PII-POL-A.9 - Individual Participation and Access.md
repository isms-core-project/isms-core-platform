...
- CLD-PII-POL-A.2 (Consent and Choice — A.2.1 co-operation on rights)
...
**Principle Note**: ISO/IEC 27018:2025 Annex A, Section A.9 is a principle-level section with no additional sub-controls beyond the main body of the standard. The operational mechanism for co-operation on data subject rights is addressed in CLD-PII-POL-A.2.1.
...
- Specific technical capabilities for individual rights (export, deletion, restriction, portability) — detailed in CLD-PII-POL-A.2.1
- Correction and update mechanisms — addressed in CLD-PII-POL-A.7
...
Auditors verifying compliance with CLD-PII-POL-A.9 should expect to find:
