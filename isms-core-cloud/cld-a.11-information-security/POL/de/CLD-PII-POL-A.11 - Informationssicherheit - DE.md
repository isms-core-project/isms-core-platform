<!-- ISMS-CORE:POLICY:CLD-PII-POL-A.11-DE:cloud:POL:a.11 -->
...
- CLD-PII-POL-A.5 (Datenminimerung — Löschung temporärer Dateien)
- CLD-PII-POL-A.8 (Offenheit, Transparenz — Unterauftragsverarbeiter-Offenlegung)
- CLD-PII-POL-A.10 (Rechenschaftspflicht — Verletzungsmeldung)
...
**Verlust oder Diebstahl** jedes portablen Geräts, das möglicherweise PII enthält, muss sofort dem ISB und DSB gemeldet und als PII-Sicherheitsvorfall gemäss CLD-PII-POL-A.10.1 und ISMS-POL-A.5.24-28 behandelt werden.
...
- Anforderungen zur Verletzungsmeldung (Verantwortlichen-Benachrichtigung innerhalb von 24 Stunden gemäss CLD-PII-POL-A.10.1)
- Unterstützungspflichten bei Betroffenenrechten (gemäss CLD-PII-POL-A.2.1 und CLD-PII-POL-A.9)
...
- Anforderungen zur Unterauftragsverarbeiter-Genehmigung (gemäss CLD-PII-POL-A.8.1)
- PII-Rückgabe oder -Löschung bei Beendigung (gemäss CLD-PII-POL-A.10.3)
...
[Organisation] muss allen Unterauftragsverarbeitern über bindende Verträge **gleichwertige Pflichten** wie in dieser Richtlinie und der vollständigen CLD-PII-POL-A.X-Suite auferlegen. Unterauftragsverarbeiter-Verträge müssen:
...
- Verletzungsmeldung an [Organisation] innerhalb von 12 Stunden nach Erkennung verlangen (um die 24-Stunden-Verantwortlichen-Meldepflicht von [Organisation] gemäss CLD-PII-POL-A.10.1 zu ermöglichen) — diese 12-Stunden-Anforderung ist eine **verpflichtende Klausel** in allen Unterauftragsverarbeiter-Vereinbarungen; der Rechts-/Compliance-Beauftragte pflegt die Standardvorlage für Unterauftragsverarbeiter-Vereinbarungen
...
Prüfende, die die Compliance mit CLD-PII-POL-A.11 verifizieren, sollten Folgendes vorfinden:
