...
| **Document ID** | CLD-PII-IMP-A.11-TG |
...
- CLD-PII-POL-A.10 (Accountability — breach notification and disposal)
...
Use this classification table when triaging A.11-related security events. Classification determines urgency of breach notification under CLD-PII-POL-A.10.1.
