...
# =============================================================================
"""
CLD-PII-CHK-A.11 — Information Security Compliance Checklist
...
# DOCUMENT METADATA
# =============================================================================
DOCUMENT_ID = "CLD-PII-CHK-A.11"
CONTROL_ID = "A.11.1-13"
CONTROL_NAME = "Information Security"
SOURCE_POLICY = "CLD-PII-POL-A.11"

# =============================================================================
# REQUIREMENTS DATA — extracted from CLD-PII-POL-A.11
# =============================================================================
...
REQUIREMENTS = OrderedDict([
    ...
    ("Contracts, Sub-processors and Storage", [
        ...
        ("A.11.12-01", "Sub-processor Equivalent Obligations (A.11.12)",
         "The organisation shall impose on all sub-processors via binding contract obligations equivalent to those in CLD-PII-POL-A.11 and the full CLD-PII-POL-A.X suite. Sub-processor contracts shall: mirror data protection obligations from the controller-processor agreement; require prior written consent before any further sub-processing; include audit rights for the organisation; require breach notification to the organisation within 12 hours of detection; and require PII return or disposal upon sub-processor engagement termination."),
