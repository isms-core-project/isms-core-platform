...
- CLD-PII-POL-A.11 (Information Security — covers portable media, encryption, disposal)
...
- Retention periods for primary PII data stores — addressed in CLD-PII-POL-A.6
- Secure disposal of physical storage media — addressed in CLD-PII-POL-A.11
...
This is addressed in detail in CLD-PII-POL-A.11 (§11.13 — Access to data on pre-used data storage space). Multi-tenant isolation tests SHALL be performed at minimum annually and following any material change to storage infrastructure.
...
Auditors verifying compliance with CLD-PII-POL-A.5 should expect to find:
