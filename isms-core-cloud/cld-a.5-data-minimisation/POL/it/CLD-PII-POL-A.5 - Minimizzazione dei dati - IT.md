...
| **Identificativo del documento** | CLD-PII-POL-A.5 |
...
- CLD-PII-POL-A.11 (Sicurezza delle informazioni — supporti portatili, cifratura, smaltimento)
...
- I periodi di conservazione per i principali archivi di DCP a riposo — trattati in CLD-PII-POL-A.6
- Lo smaltimento sicuro dei supporti di archiviazione fisici — trattato in CLD-PII-POL-A.11
...
Questo aspetto è trattato in dettaglio in CLD-PII-POL-A.11 (§11.13 — Accesso ai dati sullo spazio di archiviazione precedentemente utilizzato). I test di isolamento multi-tenant DEVONO essere eseguiti al minimo annualmente e dopo qualsiasi modifica materiale all'infrastruttura di archiviazione.
...
Gli auditor che verificano la conformità a CLD-PII-POL-A.5 devono aspettarsi di trovare:
