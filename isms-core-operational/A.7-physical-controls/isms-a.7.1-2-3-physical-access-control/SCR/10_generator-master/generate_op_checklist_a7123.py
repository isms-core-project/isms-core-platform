...
# =============================================================================
"""
ISMS-OP-CHK-A.7.1-2-3 — Physical Access Control Compliance Checklist

Controls A.7.1-2-3: Physical Access Control
...
# DOCUMENT METADATA
# =============================================================================
DOCUMENT_ID = "ISMS-OP-CHK-A.7.1-2-3"
CONTROL_ID = "A.7.1-2-3"
CONTROL_NAME = "Physical Access Control"
SOURCE_POLICY = "ISMS-OP-POL-A.7.1-2-3"

# =============================================================================
# REQUIREMENTS DATA — extracted from ISMS-OP-POL-A.7.1-2-3
# =============================================================================

REQUIREMENTS = OrderedDict([
    ("Physical Security Perimeters", [
        ("A.7.1-2-3-01", "Define And Document Security Zones Using",
         "The organisation shall define and document security zones using the following classification:."),
        ("A.7.1-2-3-02", "Be Documented On Floor Plans With",
        ...
        ("A.7.1-2-3-05", "Be Secured, Particularly At Ground Level",
        ...
        ("A.7.1-2-3-08", "Ventilation Points And Service Openings",
         "Ventilation points and service openings shall not provide a bypass route into secured areas."),
        ("A.7.1-2-3-09", "Suitable Intrusion Detection Systems",
        ...
        ("A.7.1-2-3-10", "Partitions Between Controlled,",
        ...
        ("A.7.1-2-3-13", "Building Perimeter Inspections",
         "Building perimeter inspections shall be performed at minimum annually."),
        ("A.7.1-2-3-14", "Restricted And High-Security Zone",
        ...
        ("A.7.1-2-3-15", "Inspection Findings",
        ...
        ("A.7.1-2-3-16", "[Organisation]-Controlled Areas (Cages,",
         "[Organisation]-controlled areas (cages, rooms, floors) shall be clearly delineated and documented."),
        ("A.7.1-2-3-17", "Contractual Requirements For Physical",
        ...
        ("A.7.1-2-3-18", "Supplier Assurance Evidence (Iso 27001",
        ...
        ("A.7.1-2-3-19", "Documented Risk Acceptance With",
        ...
        ("A.7.1-2-3-20", "Shared Infrastructure (Lifts, Corridors,",
        ...
        ("A.7.1-2-3-21", "Key And Card Management For Building",
        ...
        ("A.7.1-2-3-22", "Information Processing Facilities",
    ...
    ("Physical Entry Controls", [
        ...
        ("A.7.1-2-3-39", "Access Control Tokens (Badges, Cards,",
        ...
        ("A.7.1-2-3-47", "Access Log Retention*: Physical Access",
        ...
        ("A.7.1-2-3-48", "Sign In At Reception Before Proceeding",
        ...
        ("A.7.1-2-3-49", "Present Valid Photographic",
         "Visitors shall present valid photographic identification."),
        ("A.7.1-2-3-50", "Visitor Badges",
        ...
        ("A.7.1-2-3-54", "Visitor Access To High-Security Zones",
        ...
        ("A.7.1-2-3-58", "Contractor Access",
         "Contractor access shall be time-limited and logged."),
        ("A.7.1-2-3-59", "Contractors Accessing Restricted Or",
        ...
        ("A.7.1-2-3-60", "External Maintenance On Security Systems",
        ...
        ("A.7.1-2-3-61", "Access To Delivery And Loading Areas",
        ...
        ("A.7.1-2-3-62", "Delivery And Loading Areas",
        ...
        ("A.7.1-2-3-63", "External Doors Of A Delivery And",
    ...
    ("Securing Offices, Rooms", [
        ...
        ("A.7.1-2-3-83", "Physical Access To Networking Equipment",
        ...
        ("A.7.1-2-3-92", "Personnel Working In Secure Areas",
        ...
        ("A.7.1-2-3-93", "Compliance With Office, Meeting Room,",
...
# CHANGES: Auto-generated from ISMS-OP-POL-A.7.1-2-3
# =============================================================================
