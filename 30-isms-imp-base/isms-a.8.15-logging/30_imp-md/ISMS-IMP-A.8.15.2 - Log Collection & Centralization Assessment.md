...
- SIEM Name (e.g., Splunk, ELK Stack, QRadar, Azure Sentinel, Chronicle, LogRhythm)
...
- Collection Coverage % = (Forwarding / Expected) × 100%
...
### 6.1 Pitfall: "We think logs are forwarding but haven't verified"
...
### 6.2 Pitfall: "All logs go to SIEM" (without checking WHICH SIEM)
...
### 6.3 Pitfall: "Encryption is on because we use Syslog over TCP"
...
### 6.4 Pitfall: "Collection is 100% reliable" (ignoring gaps/delays)
...
### 6.5 Pitfall: "We'll fix gaps later" (without documenting gaps)
...
### 6.6 Pitfall: "Evidence collection can wait until audit"
...
- [ ] Policy references correct (all references point to ISMS-POL-A.8.15 v2.0 consolidated policy)
...
- B: SIEM Name (Splunk, ELK, QRadar, Azure Sentinel...)
- C: Vendor
- D: Version/Build
...
- Q: Overall Compliance - Formula: IF J="Compliant" AND P="Compliant" "✓" ELSE "✗"
...
- Overall Compliance % = COUNTIF(Q:Q,"✓ Compliant") / Total * 100
...
- FROM Sheet 8: WHERE Overall Compliance = "✗ Non-Compliant" AND Exception ID blank
...
|--------|-------------------------|--------|--------|
| SIEM Availability | =Sheet7!B7 | ≥99.5% | IF ✓/✗ |
| Collection Coverage % | =Sheet5!SummaryCell | ≥98% | IF ✓/✗ |
| Encryption Compliance % | =Sheet8!SummaryCell | 100% | IF ✓/✗ |
| Authentication Compliance % | =Sheet8!SummaryCell | 100% | IF ✓/✗ |
...
- ✅ External dependency on IMP-A.8.15.1 documented
- ✅ All 11 sheets specified with formulas, validation, formatting
- ✅ Python script customization points marked
- ✅ Integration points with other assessments documented
- ✅ Completely generic language (no industry/size/technology assumptions)
- ✅ Follows IMP-A.8.15.1 structure exactly

---

**END OF ISMS-IMP-A.8.15.2 ASSESSMENT DOCUMENT**

---

*This implementation assessment enables systematic verification of log collection infrastructure and SIEM integration per ISMS-POL-A.8.15 Sections 2.2, 2.3, and 2.4. Assessment workbook provides objective evidence for ISO 27001 audit validation of Control A.8.15 implementation - Domain 2: Log Collection & Centralization.*