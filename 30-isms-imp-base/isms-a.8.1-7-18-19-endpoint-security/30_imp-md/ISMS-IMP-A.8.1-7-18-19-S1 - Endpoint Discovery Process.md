...
- Access to Active Directory, Azure AD, or LDAP
...
- **Active Directory Access**: Read access to Active Directory, Azure AD, or LDAP
...
- [ ] 17. Owner names match user directory (AD, Azure AD)
...
1. **Inventory** - Complete endpoint inventory with mandatory attributes
2. **Classification** - Endpoint classification by type, ownership, criticality
3. **Discovery_Methods** - Discovery methods used and their effectiveness
4. **Quality_Metrics** - Inventory quality tracking over time
5. **Evidence** - Supporting evidence for inventory accuracy
6. **Gaps** - Undiscovered endpoints and remediation plans
...
*This implementation guide provides comprehensive instructions for completing the Endpoint Discovery Process assessment. For policy requirements, refer to ISMS-POL-A.8.1-7-18-19, Section 2.1.1-2.1.2. For technical implementation procedures, refer to discovery platform documentation (Intune, Jamf, SCCM, etc.).*