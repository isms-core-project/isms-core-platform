...
- [ ] Configuration audit tools (Nessus, Qualys, Azure Security Center, AWS Config)
...
**Step 7: Complete Sheet 6 - Encryption-Based Access**
...
**Step 10: Complete Evidence Register (Sheet 7)**

Document all collected evidence with links.

**Step 11: Approval & Sign-Off (Sheet 8)**
...
### 7.1 Understanding Access Control Metrics
...
|---------|-----------|---------|------|-------------------|
| 1 | Instructions & Legend | User guide and access control reference | ~60 | Pre-populated |
| 2 | OS Access Controls | File system permission audits | 253 | User completes |
| 3 | Database Access Controls | Database grant and role audits | 253 | User completes |
| 4 | Application Access Controls | Application RBAC and permission audits | 253 | User completes |
| 5 | API Access Controls | API authentication and authorization | 253 | User completes |
| 6 | Network Segmentation | Network zone segmentation verification | 103 | User completes |
| 7 | Encryption-Based Access | Encryption as access control | 253 | User completes |
| 8 | Compliance Summary | Overall access control metrics | ~30 | Auto-calculated |
| 9 | Evidence Register | Evidence tracking | 53 | User completes |
| 10 | Approval & Sign-Off | Three-level approval | ~25 | User completes |

**Total Workbook:** 10 sheets, ~1,500 rows of structured data collection
...
### 2.2 Compliance Calculation (Column K)
...
## 3. Sheet 3: Database Access Controls
...
### 3.2 Compliance Calculation (Column L)
...
## 4. Sheet 4: Application Access Controls
...
### 4.2 Compliance Calculation (Column L)
...
### 5.2 Compliance Calculation (Column L)
...
## 6. Sheet 6: Network Segmentation
...
### 6.2 Compliance Calculation (Column K)
...
## 7. Sheet 7: Encryption-Based Access
...
### 7.2 Encryption Required (Column H)

```excel
=IF(OR(D5="Confidential", D5="Restricted"), "Yes", "No")
```

### 7.3 Compliance Calculation (Column L)
...
## 8. Sheet 8: Compliance Summary (Dashboard)

### 8.1 Metrics Calculated
...
## 9. Sheet 9: Evidence Register

Standard evidence tracking sheet.

---

## 10. Sheet 10: Approval & Sign-Off

Three-level approval process.

---

## 11. Python Script Integration

### 11.1 Script Purpose

**Script:** `generate_a8235_5_access_restrictions.py`

### 11.2 Running the Script
