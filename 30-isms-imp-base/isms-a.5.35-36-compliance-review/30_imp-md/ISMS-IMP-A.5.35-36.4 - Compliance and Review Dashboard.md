# ISMS-IMP-A.5.35-36.4 — Compliance and Review Dashboard

---

| Field | Value |
|-------|-------|
| **Document ID** | ISMS-IMP-A.5.35-36.4 |
...
- [ ] Completed ISMS-IMP-A.5.35-36.1 (Independent Review Planning & Tracking)
- [ ] Completed ISMS-IMP-A.5.35-36.2 (Compliance Assessment)
- [ ] Completed ISMS-IMP-A.5.35-36.3 (Findings & Remediation Management)
...
1. **Review_ID** - Link to ISMS-IMP-A.5.35-36.1
...
|---------------|-------------|------------------|
| Underlying Assessments | Completed ISMS-IMP-A.5.35-36.1-3 | ISMS Evidence Library |
...
- Filename: `ISMS-IMP-A.5.35-36.4_Compliance_and_Review_Dashboard_YYYYMMDD.xlsx`
...
| Column | Header | Width | Content |
|--------|--------|-------|---------|
| A | Review_ID | 14 | Link to ISMS-IMP-A.5.35-36.1 |
