...
### 4.1 Domain 1: Security Requirements Definition
...
### 4.3 Domain 3: Secure Architecture & Design
...
### 4.4 Domain 4: Developer Security Training
...
### 4.5 Domain 5: Development Environment Security
...
### 4.6 Domain 6: Security Planning & Resource Allocation
...
### 4.7 Interpreting Status Dropdown Options
...
### 5.2 Where Evidence Typically Resides
...
### 5.4 Evidence Register Population
...
### 5.5 Evidence Quality Standards
...
### 8.1 Internal Review (Before Submission)
...
| 2 | Security_Requirements | Requirements definition process assessment | User input (yellow cells) |
| 3 | Threat_Modeling | Threat modeling practices evaluation | User input (yellow cells) |
| 4 | Architecture_Design | Secure design process assessment | User input (yellow cells) |
| 5 | Training_Awareness | Developer security training evaluation | User input (yellow cells) |
| 6 | Development_Environment | Environment security controls assessment | User input (yellow cells) |
| 7 | Planning_Resources | Security planning and resource allocation | User input (yellow cells) |
| 8 | Summary_Dashboard | Executive overview and compliance metrics | Auto-calculated |
| 9 | Evidence_Register | Supporting documentation tracking | User input (yellow cells) |
| 10 | Gap_Analysis | Non-compliant items and remediation plan | Auto-populated + user input |
| 11 | Approval_Sign_Off | Formal approval workflow | User input (yellow cells) |

### Common Column Structure (Assessment Sheets 2-7)
...
## Sheets 2-7: Assessment Domain Sheets

### Sheet 2: Security_Requirements

**Purpose**: Assess security requirements definition processes
...
6. Are security requirements traced to design and implementation?
7. Are security requirements updated when project scope changes?
8. Is requirements documentation retained per retention policy?
9. Are security requirement templates provided to project teams?
10. Are security requirements integrated into product backlog/user stories?

**Column D (Policy Reference)**: References ISMS-POL-A.8.28 Section 2.1.1
...
### Sheet 3: Threat_Modeling

**Purpose**: Evaluate threat modeling practices

**Questions** (12 total):
1. Is threat modeling performed for high-risk applications?
2. Do threat models include system overview, threat identification, prioritization, and mitigation strategies?
3. Are threat models reviewed and approved by Security Architects?
4. Is threat modeling performed early in SDLC (design phase)?
5. Is threat modeling methodology documented (STRIDE, PASTA, Attack Trees)?
6. Are threat models maintained and updated when architecture changes?
7. Do threat models include architecture diagrams with trust boundaries?
8. Are threats prioritized using risk scoring (CVSS, DREAD)?
9. Are mitigation strategies documented for identified threats?
10. Is threat modeling training provided to architects and developers?
11. Are threat models accessible to development and security teams?
12. Is threat modeling effectiveness measured (vulnerabilities prevented)?

**Column structure**: Same as Sheet 2  
**Policy Reference**: ISMS-POL-A.8.28 Section 2.1.2

---

### Sheet 4: Architecture_Design

**Purpose**: Assess secure architecture and design practices

**Questions** (10 total):
1. Are security-by-design principles documented and applied?
2. Are architecture security reviews conducted for new applications?
3. Do architecture reviews include Security Architect participation?
4. Are secure design patterns documented and promoted?
5. Are architecture diagrams maintained showing security controls?
6. Are architecture decisions documented (ADRs) including security rationale?
7. Is architecture documentation version-controlled and accessible?
8. Are security architecture standards published (IAM, crypto, network security)?
9. Is reference architecture provided for common use cases?
10. Are architecture security reviews documented and approved?

**Column structure**: Same as Sheet 2  
**Policy Reference**: ISMS-POL-A.8.28 Section 2.1.3

---

### Sheet 5: Training_Awareness

**Purpose**: Evaluate developer security training program

**Questions** (12 total):
1. Do 100% of developers complete initial security training within 30 days of hire?
2. Do 90%+ of developers complete annual security refresher training?
3. Is language-specific security training available (Python, Java, JavaScript, etc.)?
4. Is Security Champions program established (1:10 ratio recommended)?
5. Are Security Champions provided advanced security training?
6. Is training effectiveness measured (vulnerability reduction, assessment scores)?
7. Are training records retained for 3+ years?
8. Is training curriculum updated annually based on threat landscape?
9. Is hands-on secure coding training provided (labs, exercises)?
10. Are developers trained on secure use of organizational tools (SAST, SCA)?
11. Is security training completion tracked in LMS?
12. Are training completion metrics reported to management?

**Column structure**: Same as Sheet 2  
**Policy Reference**: ISMS-POL-A.8.28 Section 2.1.4

---

### Sheet 6: Development_Environment
...
8. Are CI/CD pipelines secured (no secrets in logs, RBAC applied)?
9. Are SAST/DAST/SCA tools integrated into CI/CD pipelines?
10. Are security gates configured in pipelines (fail build on Critical/High findings)?
11. Is test data security managed (production data not used without approval)?
12. Are development environments isolated from production?
13. Is source code backed up and recoverable?
14. Are secrets managed via secret manager (no hardcoded credentials)?
15. Is developer security baseline audit performed periodically?
...
### Sheet 7: Planning_Resources

**Purpose**: Assess security planning and resource allocation
...
9. Are security resource needs forecasted (tools, training, headcount)?
10. Is security capacity planning performed (Application Security Team bandwidth)?
...
|--------|---------|--------|
| Total Assessment Items | `=COUNTA(Security_Requirements!$C$4:$C$13) + COUNTA(Threat_Modeling!$C$4:$C$15) + ...` | Number |
| Compliant Items (✅) | `=COUNTIF(Security_Requirements!$E$4:$E$13,"✅ Compliant") + ...` | Number, green |
| Partial Items (⚠️) | `=COUNTIF(Security_Requirements!$E$4:$E$13,"⚠️ Partial") + ...` | Number, yellow |
| Non-Compliant Items (❌) | `=COUNTIF(Security_Requirements!$E$4:$E$13,"❌ Non-Compliant") + ...` | Number, red |
| Planned Items (🔄) | `=COUNTIF(Security_Requirements!$E$4:$E$13,"🔄 Planned") + ...` | Number, blue |
| N/A Items | `=COUNTIF(Security_Requirements!$E$4:$E$13,"N/A") + ...` | Number, gray |
| **Overall Compliance Rate** | `=(Compliant / (Total - N/A)) * 100` | Percentage, bold |

**Domain Compliance Breakdown** (Rows 12-20):

| Domain | Total Items | Compliant | Partial | Non-Compliant | Compliance % |
|--------|-------------|-----------|---------|---------------|--------------|
| Security Requirements | 10 | [Formula] | [Formula] | [Formula] | [Formula] |
| Threat Modeling | 12 | [Formula] | [Formula] | [Formula] | [Formula] |
| Architecture & Design | 10 | [Formula] | [Formula] | [Formula] | [Formula] |
| Training & Awareness | 12 | [Formula] | [Formula] | [Formula] | [Formula] |
| Development Environment | 15 | [Formula] | [Formula] | [Formula] | [Formula] |
| Planning & Resources | 10 | [Formula] | [Formula] | [Formula] | [Formula] |

**Top Gaps Requiring Attention** (Rows 22-30):
