...
### 4.1 Domain 1: Coding Standards Adoption
...
### 4.3 Domain 3: DAST & Security Testing Tools
...
### 4.4 Domain 4: IDE Plugins & Linters
...
### 4.5 Domain 5: Tool Effectiveness & Metrics
...
The Standards & Tools Assessment workbook consists of 12 sheets:

| Sheet # | Sheet Name | Purpose | Input Type |
|---------|------------|---------|------------|
| 1 | Instructions | Assessment guidance | Read-only |
| 2 | Coding_Standards | Standards documentation and adoption | User input |
| 3 | SAST_SCA_Tools | Static analysis and dependency scanning | User input |
| 4 | DAST_Testing_Tools | Dynamic testing and scanning | User input |
| 5 | IDE_Plugins_Linters | Developer-facing tools | User input |
| 6 | Tool_Effectiveness | Metrics and KPIs | User input |
| 7 | Tool_Inventory | Comprehensive tool list | User input |
| 8 | Summary_Dashboard | Executive overview | Auto-calculated |
| 9 | Evidence_Register | Supporting documentation | User input |
| 10 | Gap_Analysis | Non-compliant items remediation | Auto-populated + user input |
| 11 | Approval_Sign_Off | Formal approval workflow | User input |
...
### Sheet 2: Coding_Standards (18 requirements)
...
### Sheet 4: DAST_Testing_Tools (18 requirements)
...
### Sheet 6: Tool_Effectiveness (15 requirements)
...
## Sheet 7: Tool_Inventory

### Purpose
Comprehensive list of all security tools deployed or planned.

### Column Structure

| Column | Header | Width | Purpose | Format |
|--------|--------|-------|---------|--------|
| A | Tool ID | 10 | Auto-generated | `="TOOL-"&TEXT(ROW()-3,"00")` |
| B | Tool Category | 20 | SAST, SCA, DAST, IDE Plugin, etc. | Dropdown, yellow |
| C | Tool Name | 30 | Product name | Text, yellow |
| D | Vendor | 20 | Vendor name | Text, yellow |
| E | Version | 15 | Version number | Text, yellow |
| F | License Type | 20 | Commercial, Open Source | Dropdown, yellow |
| G | License Expiration | 15 | Expiration date | Date picker, yellow |
| H | Status | 15 | Active, Pilot, Deprecated, Planned | Dropdown, yellow |
| I | Deployment Date | 15 | When deployed | Date picker, yellow |
| J | Primary Languages | 30 | Languages supported | Text, yellow |
| K | Evidence ID | 15 | Link to Evidence Register | Text, yellow |
| L | Notes | 40 | Additional info | Wrapped text, yellow |
...
- Planned (procurement in progress)

**Row Count**: 50 rows pre-formatted
...
| Compliant Items | `=COUNTIF(Coding_Standards!$D$4:$D$21,"✅ Compliant") + ...` | Number, green |
| Partial Items | `=COUNTIF(Coding_Standards!$D$4:$D$21,"⚠️ Partial") + ...` | Number, yellow |
| Non-Compliant Items | `=COUNTIF(Coding_Standards!$D$4:$D$21,"❌ Non-Compliant") + ...` | Number, red |
| Planned Items | `=COUNTIF(Coding_Standards!$D$4:$D$21,"🔄 Planned") + ...` | Number, blue |
| N/A Items | `=COUNTIF(Coding_Standards!$D$4:$D$21,"N/A") + ...` | Number, gray |
...
|--------|-------|-----------|---------|---------------|--------------|
| Coding Standards | 18 | [Formula] | [Formula] | [Formula] | [Formula] |
| SAST & SCA Tools | 18 | [Formula] | [Formula] | [Formula] | [Formula] |
| DAST & Testing Tools | 18 | [Formula] | [Formula] | [Formula] | [Formula] |
| IDE Plugins & Linters | 12 | [Formula] | [Formula] | [Formula] | [Formula] |
| Tool Effectiveness | 15 | [Formula] | [Formula] | [Formula] | [Formula] |

**Tool Summary** (Rows 23-28):

| Tool Category | Count Deployed | Count Active | License Expiring Soon (<90d) |
|---------------|----------------|--------------|------------------------------|
| SAST | [Formula from Tool_Inventory] | [Formula] | [Formula] |
| SCA | [Formula] | [Formula] | [Formula] |
| DAST | [Formula] | [Formula] | [Formula] |
| Container/IaC | [Formula] | [Formula] | [Formula] |
| IDE/Linters | [Formula] | [Formula] | [Formula] |
...
**create_tool_inventory_sheet(wb)**:
- Create Tool_Inventory sheet
- 50 pre-formatted rows
- Tool categories dropdown

**create_summary_dashboard(wb)**:
- Auto-calculate compliance metrics
- Domain breakdown
- Tool summary from Tool_Inventory
- Top gaps list
