...
### 1.1 ISO/IEC 27001:2022 Control A.8.32
...
### 1.5 What This Policy Does NOT Do
...
### 2.1 Change Process Requirements
...
#### 2.1.1 Change Request Submission
...
#### 2.1.2 Planning & Impact Assessment
...
**Approval authorities SHALL be documented** considering [Organization]'s organizational structure, risk appetite, and operational model.
...
**Assessment Criteria**: ISMS-IMP-A.8.32.1 documents approval authorities. Evidence shows approvals obtained before implementation.
...
#### 2.1.5 Implementation Execution
...
#### 2.1.6 Record Keeping & Audit Trail
...
#### 2.1.8 Post-Implementation Review
...
### 2.2 Change Classification Requirements
...
#### 2.2.1 Standard Change Requirements
...
**Assessment Criteria**: ISMS-IMP-A.8.32.2 (Change Types & Categories Assessment) documents Standard Change Catalog. Evidence shows catalog actively used and maintained.
...
#### 2.2.2 Normal Change Requirements
...
#### 2.2.3 Change Calendar & Scheduling
...
### 2.3 Testing & Validation Requirements
...
#### 2.3.1 Environment Separation Requirements
...
**Assessment Criteria**: ISMS-IMP-A.8.32.4 (Testing & Validation Assessment) documents testing procedures. Change requests show testing performed and results documented.
...
### 2.4 Emergency Change Requirements
...
#### 2.4.1 Emergency Change Criteria
...
#### 2.4.2 Emergency Change Approval
...
#### 2.4.3 Emergency Change Testing
...
#### 4.3.1 When Exceptions Are Appropriate
...
#### 4.3.2 Exception Request Process
...
### 5.1 Integration with Related Controls
