...
### 1.1 ISO/IEC 27001:2022 Control A.8.12
...
## 2. DLP Requirements Framework

### 2.1 Data Classification & Identification Requirements
...
### 2.2 Channel Protection Requirements
...
### 2.3 Monitoring & Detection Requirements
...
### 2.4 Incident Response & Remediation Requirements
...
- Tracked in exception register (user, justification, approval, expiry date)
- Reviewed based on risk level (monthly for high-risk, quarterly for medium-risk)
...
☐ **Legal review**: DPO and Legal/Compliance approve DLP monitoring approach  
☐ **Legitimate interest assessment** (GDPR Art. 6(1)(f) balancing test): Security need vs. employee privacy  
☐ **Proportionality assessment**: Monitoring scope limited to security objectives  
☐ **Employee notification**: Updated employment contracts, privacy notices, acceptable use policy  
☐ **Works council consultation** (where required): Documented agreement or compromise  
☐ **DPO approval**: Explicit sign-off from Data Protection Officer  
☐ **Training materials**: DLP awareness training developed and delivered  
☐ **Access controls**: Limit DLP log access to authorized personnel (Security Team, CISO, DPO, Legal)  
☐ **Retention limits**: Configure automated log deletion per retention policy  
☐ **Audit documentation**: All approvals, notifications, and legal assessments documented  
