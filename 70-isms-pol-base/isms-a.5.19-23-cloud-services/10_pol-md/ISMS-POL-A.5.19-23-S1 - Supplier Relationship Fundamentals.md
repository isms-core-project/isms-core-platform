...
## 8. Shadow IT Prevention

### 8.1 Shadow IT Definition
...
| **ISMS-IMP-A.5.23-1** | Cloud service inventory assessment workbook |
| **ISMS-IMP-A.5.23-2** | Supplier due diligence assessment workbook |
