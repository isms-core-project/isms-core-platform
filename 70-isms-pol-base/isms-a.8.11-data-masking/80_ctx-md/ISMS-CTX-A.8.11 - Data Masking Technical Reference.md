...
## 2. Masking Technique Specifications

### 2.1 Static Data Masking (SDM) Techniques
...
#### 2.1.1 Substitution (Replacement) Techniques
...
#### 2.1.2 Shuffling (Permutation) Techniques
...
#### 2.1.3 Variance/Noise Addition (Numeric Data)
...
#### 2.1.4 Nulling/Deletion Techniques
...
### 2.2 Dynamic Data Masking (DDM) Techniques
...
#### 2.3.1 Format-Preserving Tokenization
...
#### 2.3.2 Non-Format-Preserving Tokenization
...
### 2.4 Pseudonymization Techniques (GDPR Compliance)
...
#### 2.4.1 Cryptographic Pseudonymization
...
#### 2.4.2 Pseudonym Mapping Tables
...
#### 2.4.3 k-Anonymity and l-Diversity
...
### 2.5 Anonymization Techniques (Irreversible)
...
#### 2.5.1 Aggregation and Statistical Disclosure Control
...
## 3. Data Discovery Methodologies

### 3.1 Automated Pattern Recognition
...
### 3.2 Database Metadata Analysis
...
### 3.3 Data Profiling and Statistical Analysis
...
### 3.4 Data Discovery Tools (Vendor-Agnostic Categories)
...
## 4. Masking Tool Landscape (Vendor-Agnostic)

### 4.1 Tool Capability Matrix
...
### 5.1 Technique Selection Decision Tree
