...
### 1.1 ISO/IEC 27001:2022 Control A.8.4
...
- **Define platform-specific configuration procedures** (see ISMS-IMP-A.8.4-S1 and S2 for GitHub, GitLab, Bitbucket, Azure DevOps procedures)
- **Provide assessment methodologies or evidence collection procedures** (see ISMS-IMP-A.8.4-S3 Assessment Procedures)
...
- **ISMS-IMP-A.8.4-S1**: Repository access control implementation procedures (HOW)
- **ISMS-IMP-A.8.4-S2**: Branch protection configuration guidance (HOW)
- **ISMS-IMP-A.8.4-S3**: Source code access assessment procedures (HOW)
...
#### 1.5.3 Tier 3: Informational Reference
...
### 1.6 Related Controls Integration
...
### 2.1 Repository Access Management
...
**Implementation Note**: Access request workflows, provisioning procedures, and deprovisioning automation are documented in ISMS-IMP-A.8.4-S1 (Repository Access Control Implementation).
...
### 2.2 Repository Classification and Controls
...
**Implementation Note**: Repository classification assignment procedures and classification review processes are documented in ISMS-IMP-A.8.4-S1 (Repository Access Control Implementation).
...
**Implementation Note**: Role assignment procedures, permission matrices, and access justification templates are documented in ISMS-IMP-A.8.4-S1 (Repository Access Control Implementation).
...
### 2.4 Branch Protection and Code Review
...
**Implementation Note**: Branch protection configuration procedures, pull request workflows, and code review standards are documented in ISMS-IMP-A.8.4-S2 (Branch Protection Configuration).
...
**Implementation Note**: Secret scanning tool configuration, remediation procedures, and developer training materials are documented in ISMS-IMP-A.8.4-S1 (Repository Access Control Implementation) and ISMS-IMP-A.8.4-S2 (Branch Protection Configuration).
...
### 2.6 Authentication and Multi-Factor Authentication
...
**Implementation Note**: Authentication configuration, MFA enrollment procedures, and SSH key management are documented in ISMS-IMP-A.8.4-S1 (Repository Access Control Implementation).
...
**Implementation Note**: Logging configuration, monitoring rules, and alerting procedures are documented in ISMS-IMP-A.8.4-S3 (Source Code Access Assessment).
...
**Implementation Note**: Backup configuration procedures, recovery testing methodology, and RTO targets are documented in ISMS-IMP-A.8.4-S1 (Repository Access Control Implementation).
...
### 2.9 Third-Party Access Management
...
**Implementation Note**: Third-party access procedures, monitoring requirements, and code review standards are documented in ISMS-IMP-A.8.4-S1 (Repository Access Control Implementation) and ISMS-IMP-A.8.4-S2 (Branch Protection Configuration).
...
**Implementation Note**: Exception request procedures, approval workflows, and compensating control assessment methodology are documented in ISMS-IMP-A.8.4-S3 (Source Code Access Assessment).
...
## 4. Assessment and Evidence Framework
...
**Implementation Note**: Detailed assessment methodology, evidence collection procedures, and compliance scoring framework are documented in ISMS-IMP-A.8.4-S3 (Source Code Access Assessment).
...
### 5.4 Grandfathering and Exceptions
...
**Implementation Guidance**: For detailed implementation procedures, refer to:
- ISMS-IMP-A.8.4-S1: Repository Access Control Implementation
- ISMS-IMP-A.8.4-S2: Branch Protection Configuration
- ISMS-IMP-A.8.4-S3: Source Code Access Assessment