...
### 1.1 ISO/IEC 27001:2022 Control Alignment
...
## 2. Endpoint Security Requirements Framework

### 2.1 Endpoint Device Security (A.8.1)

**Objective**: Protect information stored on, processed by, or accessible via user endpoint devices.

#### 2.1.1 Endpoint Inventory (Mandatory)
...
#### 2.1.2 Endpoint Classification (Mandatory)
...
#### 2.1.3 Security Baselines (Mandatory)
...
**Exceptions**: Desktop computers in secure facilities MAY be exempted with CISO approval and compensating controls.
...
#### 2.1.5 Endpoint Management (Mandatory)
...
#### 2.1.6 Lost/Stolen Device Response (Mandatory)
...
#### 2.1.7 Secure Disposal (Mandatory)
...
#### 2.1.8 BYOD Program (Conditional)
...
#### 2.2.2 Protection Coverage (Mandatory)
...
#### 2.2.3 Real-Time Protection and Scanning (Mandatory)
...
#### 2.2.4 Signature Updates (Mandatory)
...
#### 2.2.5 Quarantine and Remediation (Mandatory)
...
#### 2.2.6 Malware Incident Response (Mandatory)
...
#### 2.2.7 User Awareness (Mandatory)
...
#### 2.3.2 Access Control (Mandatory)
...
#### 2.3.3 Approval Workflows (Mandatory)
...
#### 2.3.4 Usage Monitoring and Logging (Mandatory)
...
#### 2.3.5 Security Bypass Tool Management (Mandatory)
...
### 2.4 Software Installation Controls (A.8.19)
...
#### 2.4.1 Approved Software List (Mandatory)
...
#### 2.4.2 Software Approval Process (Mandatory)
...
#### 2.4.3 Change Control Integration (Mandatory)
...
#### 2.4.4 Unauthorized Software Detection (Mandatory)
...
#### 2.4.5 Application Control Technology (Mandatory)
...
#### 2.4.6 Software Vulnerability Management (Mandatory)
...
#### 2.4.7 BYOD Software Control (Conditional)
...
### 3.1 Accountability Matrix (RACI)
...
### 4.1 Integration with Other ISMS Controls
