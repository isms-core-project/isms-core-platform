...
# =============================================================================
"""
ISMS-A.8.13-14-5.30 Business Continuity/DR - Dashboard Consolidation Utility
...
SOURCE_WORKBOOKS = [
    ('A.8.13.1', 'Backup_Inventory', 'Backup Inventory'),
    ('A.8.13.2', 'Redundancy_Analysis', 'Redundancy Analysis'),
    ('A.8.13.3', 'RPO_RTO', 'RPO/RTO Compliance'),
    ('A.8.13.4', 'Testing_Results', 'Testing Results'),
]

DASHBOARD_PATTERNS = ['A.8.13.5', 'Compliance_Dashboard', 'BC_DR_Dashboard']
...
def consolidate_dashboard():
    print("=" * 80)
    print("ISMS-A.8.13-14-5.30 Business Continuity/DR - Dashboard Consolidation")
    print("=" * 80)
