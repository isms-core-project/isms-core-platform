...
Examples:
  ...
  python3 normalize_assessment_files_a523.py --source ./assessments
  
  # Specify both directories
  python3 normalize_assessment_files_a523.py --source ./assessments --output ./dashboard
  
  # Automated mode (no prompts)
  python3 normalize_assessment_files_a523.py --source ./assessments --auto-confirm
        """
    )
