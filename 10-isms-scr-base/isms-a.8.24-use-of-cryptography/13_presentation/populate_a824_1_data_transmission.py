...
def populate_assessment_sheets(wb):
    ...
    sheet_data = {
        "1.1 External HTTPS-TLS": [
            ...
            ["mail.company.com", "TLS 1.2", "GoDaddy SSL", "Expires 2026-02-28", "Partial", "Renewal scheduled Q1", "Upgrade to TLS 1.3", "Yes"],
            ...
            ["vpn.company.com", "TLS 1.2", "Internal CA", "Valid until 2025-12-31", "Partial", "Internal PKI", "Plan TLS 1.3 upgrade", "Yes"],
            ["test.company.com", "TLS 1.2", "Self-signed", "Valid until 2026-03-01", "Partial", "Test environment", "Use valid certificate", "Yes"],
        ...
        "1.2 Internal HTTPS-TLS": [
            ...
            ["confluence.internal", "TLS 1.2", "Internal CA", "Valid until 2025-12-31", "Partial", "Confluence config", "Upgrade to TLS 1.3", "Yes"],
            ["jira.internal", "TLS 1.2", "Internal CA", "Valid until 2025-12-31", "Partial", "Jira SSL config", "Upgrade to TLS 1.3", "Yes"],
        ...
        "2.1 Email Encryption": [
            ["Microsoft 365", "TLS 1.3 + S/MIME", "DigiCert", "85% user adoption", "Partial", "M365 Admin Center", "Increase S/MIME adoption to 95%", "Yes"],
            ["Gmail Business", "TLS 1.3", "Google Trust Services", "100% enforced", "Compliant", "Google Workspace Admin", "", "No"],
            ["Internal Mail Server", "TLS 1.2 + PGP", "Internal CA", "45% PGP adoption", "Partial", "Postfix logs", "Promote PGP key usage", "Yes"],
        ...
        "2.2 Digital Signatures": [
            ...
            ["Internal Approvals", "RSA-2048 + SHA-256", "Internal PKI", "80% adoption", "Partial", "Approval workflow logs", "Increase to 95%", "Yes"],
            ["PDF Documents", "RSA-4096 + SHA-256", "Adobe Acrobat", "All sensitive docs", "Compliant", "Document management", "", "No"],
            ["Email Signatures", "RSA-2048 + SHA-256", "S/MIME", "Executive only", "Partial", "Certificate logs", "Expand to all users", "Yes"],
        ...
        "4.1 VPN": [
            ...
            ["Site-to-Site VPN (IPSec)", "IKEv2", "AES-256-CBC + DH Group 14", "Pre-shared key", "Partial", "Firewall logs", "Add certificate auth + DH 20", "Yes"],
        ...
        "4.2 SSH": [
            ...
            ["Network Devices", "SSH-2 (RSA-2048)", "Password + TACACS+", "Cisco devices", "Partial", "TACACS+ logs", "Migrate to key-based", "Yes"],
        ...
        "4.3 RDP": [
            ...
            ["Windows Workstations", "RDP with NLA + TLS 1.2", "AES-128", "Password only", "Partial", "Workstation RDP logs", "Enforce MFA + TLS 1.3", "Yes"],
        ...
        "5.1 API Security": [
            ...
            ["Legacy SOAP API", "TLS 1.2", "AES-128-CBC", "WS-Security (username)", "Partial", "SOAP logs", "Upgrade TLS 1.3 + OAuth", "Yes"],
        ...
        "6.1 Database Connections": [
            ...
            ["Oracle Database", "TLS 1.2 + Oracle Native", "AES-192", "Password only", "Partial", "Oracle audit", "Upgrade TLS 1.3 + AES-256", "Yes"],
        ...
        "6.2 Wireless Networks": [
            ...
            ["IoT WiFi", "WPA2-Enterprise", "AES-256 + 802.1X", "Device certificates", "Partial", "IoT VLAN logs", "Migrate to WPA3", "Yes"],
