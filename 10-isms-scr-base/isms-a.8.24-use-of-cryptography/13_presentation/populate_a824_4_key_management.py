...
def populate_approval_signoff(wb):
    ...
    print(f"    ✓ Approval Sign-Off: Complete")
    return 1

def main():
    if len(sys.argv) < 2:
        print("Usage: python3 populate_a824_4_key_management.py <workbook.xlsx>")
        sys.exit(1)
    filepath = sys.argv[1]
    print("=" * 80)
    print("ISMS-IMP-A.8.24.4 - Key Management Assessment")
    ...
    try:
        ...
        print("[1/3] Populating 5 Assessment Sheets...")
        ...
        print(f"  • Total Data Points: {assessment_count + evidence_count}")
        print("\n🎯 CISO-Ready: Professional key management assessment")
        print("=" * 80 + "\n")
