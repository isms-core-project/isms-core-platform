...
def populate_assessment_sheets(wb):
    ...
    sheet_data = {
        ...
        "2. Key Storage": [
            ...
            ["SSH Private Keys", "User authentication", "Ed25519", "256 bits", "User ~/.ssh/", "Internal", "Filesystem + passphrase", "Partial", "Endpoint scan results", "Enforce passphrase policy", "Yes"],
        ...
        "3. Key Rotation": [
            ...
            ["Database Encryption Keys", "DB master keys", "AES", "256 bits", "Manual rotation process", "Restricted", "365 days", "Partial", "KMS rotation schedule", "Automate rotation", "Yes"],
            ...
            ["SSH Host Keys", "Server host keys", "Ed25519", "256 bits", "Manual", "Internal", "No rotation policy", "Partial", "SSH key inventory", "Implement rotation policy", "Yes"],
        ...
        "4. Key Backup & Recovery": [
            ...
            ["Personal SSH Keys", "User SSH keys", "Various", "Varies", "No backup", "Internal", "User responsibility", "Partial", "User key management policy", "Centralized key management", "Yes"],
        ],
        ...
        "5. Certificate Management": [
            ...
            ["S/MIME Certificates", "Email encryption", "RSA", "2048 bits", "Public CA + Internal", "Internal", "Active", "Partial", "S/MIME deployment report", "Increase adoption to 100%", "Yes"],
...
def populate_evidence_register(wb):
    ...
    evidence_data = [
        ["EVD-824.4-001", "Key Generation Standard v2.0", "Standard Document", "1. Key Generation", "SharePoint/Standards/Keys", "2025-09-01", "Security Team", "5 years", "Current"],
        ["EVD-824.4-002", "AWS KMS Key Policy Documentation", "Policy Document", "1. Key Generation", "AWS/KMS/Policies", "2026-01-10", "Cloud Team", "3 years", "Current"],
        ["EVD-824.4-003", "HashiCorp Vault Key Audit Report", "Audit Report", "1. Key Generation", "Vault/Audit/Q4-2025", "2025-12-20", "Security Team", "3 years", "Current"],
        ["EVD-824.4-004", "Code Signing Key Ceremony Documentation", "Ceremony Doc", "1. Key Generation", "SharePoint/Ceremonies/Code-Signing", "2025-08-15", "DevOps Team", "7 years", "Current"],
        ["EVD-824.4-005", "YubiKey HSM Deployment Guide", "Technical Guide", "1. Key Generation", "SharePoint/Guides/HSM", "2025-10-01", "Security Team", "3 years", "Current"],
        ["EVD-824.4-006", "AWS ACM Configuration Screenshot", "Screenshot", "2. Key Storage", "SharePoint/Evidence/ACM", "2026-01-10", "Cloud Team", "2 years", "Current"],
        ["EVD-824.4-007", "Azure Key Vault Access Policies", "Config Export", "2. Key Storage", "Azure/KeyVault/Policies", "2026-01-10", "Cloud Team", "3 years", "Current"],
        ["EVD-824.4-008", "Vault Access Control Policies", "Policy Document", "2. Key Storage", "Vault/Policies", "2025-11-15", "Security Team", "3 years", "Current"],
        ["EVD-824.4-009", "Kubernetes etcd Encryption Configuration", "Config File", "2. Key Storage", "Git/k8s/etcd-encryption", "2025-11-20", "Platform Team", "2 years", "Current"],
        ["EVD-824.4-010", "SSH Key Passphrase Enforcement Policy", "Policy", "2. Key Storage", "SharePoint/Policies/SSH", "2025-09-01", "Security Team", "5 years", "Current"],
        ["EVD-824.4-011", "TLS Certificate Auto-Renewal Logs", "Log File", "3. Key Rotation", "CertBot/Logs/2025", "2026-01-10", "DevOps", "1 year", "Current"],
        ["EVD-824.4-012", "Key Rotation Schedule Q1 2026", "Schedule Document", "3. Key Rotation", "SharePoint/Schedules/Keys", "2026-01-08", "Security Team", "2 years", "Current"],
        ["EVD-824.4-013", "Vault Key Rotation Configuration", "Config File", "3. Key Rotation", "Vault/Config/Rotation", "2025-12-01", "Security Team", "2 years", "Current"],
        ["EVD-824.4-014", "Azure Storage Key Rotation Remediation Plan", "Remediation Plan", "3. Key Rotation", "SharePoint/Projects/Azure-Keys", "2026-01-05", "Cloud Team", "3 years", "Current"],
        ["EVD-824.4-015", "HSM Master Key Ceremony Procedure", "Procedure Document", "4. Key Backup & Recovery", "SharePoint/Procedures/HSM", "2025-07-01", "Security Team", "7 years", "Current"],
        ["EVD-824.4-016", "BitLocker Recovery Key Escrow Audit", "Audit Report", "4. Key Backup & Recovery", "AD/BitLocker/Audit", "2025-12-15", "Windows Team", "3 years", "Current"],
        ["EVD-824.4-017", "Jamf Pro FileVault Key Escrow Config", "Config Screenshot", "4. Key Backup & Recovery", "Jamf/FileVault/Config", "2026-01-09", "Mac Team", "2 years", "Current"],
        ["EVD-824.4-018", "Root CA Key Ceremony Documentation", "Ceremony Doc", "4. Key Backup & Recovery", "PKI/Root-CA/Ceremony", "2024-06-15", "Security Team", "10 years", "Current"],
        ["EVD-824.4-019", "Certificate Inventory System Export", "Inventory Export", "5. Certificate Management", "CertManager/Inventory", "2026-01-10", "Security Team", "2 years", "Current"],
        ["EVD-824.4-020", "Internal PKI Architecture Documentation", "Architecture Doc", "5. Certificate Management", "SharePoint/Architecture/PKI", "2025-09-20", "Security Architect", "5 years", "Current"],
        ["EVD-824.4-021", "Certificate Expiry Monitoring Dashboard", "Dashboard Screenshot", "5. Certificate Management", "SharePoint/Evidence/Cert-Monitor", "2026-01-09", "Security Team", "1 year", "Current"],
        ["EVD-824.4-022", "S/MIME Deployment Status Report", "Status Report", "5. Certificate Management", "SharePoint/Reports/SMIME", "2026-01-08", "Email Team", "2 years", "Current"],
    ]
