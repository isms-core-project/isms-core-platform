...
def main():
    if len(sys.argv) < 2:
        print("Usage: python3 populate_a824_2_data_storage.py <workbook.xlsx>")
        sys.exit(1)
    ...
    try:
        ...
        print("[1/3] Populating 7 Assessment Sheets...")
        ...
        print("\n🎯 CISO-Ready: Professional storage encryption assessment")
        print("=" * 80 + "\n")
