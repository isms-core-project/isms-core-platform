...
"""
================================================================================
ISMS-IMP-A.7.4.4 - Physical Physical Infrastructure Dashboard Assessment Excel Generator
================================================================================

ISO/IEC 27001:2022 Control A.7.4: Physical Security Monitoring
Assessment Domain 4 of 4: Executive Compliance Dashboard
...
Usage:
    python3 generate_a74_1_physical_infrastructure_dashboard.py

Output:
    ISMS-IMP-A.7.4.4_Physical_Infrastructure_Dashboard_YYYYMMDD.xlsx
...
def create_instructions_sheet(ws, styles):
    ...
    ws["A1"] = (
        "ISMS-IMP-A.7.4.4 - Physical Physical Infrastructure Dashboard Assessment\n"
        "ISO/IEC 27001:2022 - Control A.7.4: Physical Security Monitoring"
    )
    ...
    doc_info = [
        ("Document ID", "ISMS-IMP-A.7.4.4"),
        ("Assessment Area", "Physical Physical Infrastructure Dashboard Controls"),
...
def create_metrics_sheet(ws, styles):
...
def create_trends_sheet(ws, styles):
...
def create_summary_dashboard(ws, styles):
    ...
    areas = [
        ("A.7.4.1 - Access Monitoring", "Executive Dashboard", 4),
        ("A.7.4.2 - Environmental", "Metrics", 4),
        ("A.7.4.3 - Utility Resilience", "Trends", 4),
    ]
...
def create_approval_signoff(ws, styles):
    ...
    summary_fields = [
        ("Assessment Document", "ISMS-IMP-A.7.4.4 - Physical Infrastructure Dashboard Assessment"),
        ("Assessment Period", ""),
...
def create_workbook():
    ...
    create_executive_dashboard_sheet(ws, styles)
    
    ws = wb.create_sheet("Metrics")
    create_metrics_sheet(ws, styles)
    
    ws = wb.create_sheet("Trends")
    create_trends_sheet(ws, styles)
    
    ws = wb.create_sheet("Risks")
    # create_risks_sheet(ws, styles) # Simplified
...
if __name__ == "__main__":
    print(f"\n{'='*70}")
    print("ISMS Physical Physical Infrastructure Dashboard Assessment (A.7.4.4)")
    print(f"{'='*70}\n")
    
    try:
        wb = create_workbook()
        filename = f"ISMS-IMP-A.7.4.4_Physical_Infrastructure_Dashboard_{datetime.now().strftime('%Y%m%d')}.xlsx"
        wb.save(filename)
        
        print(f"{CHECK} SUCCESS: {filename}")
        print(f"  {BULLET} 5 executive dashboard sheets created")
        print(f"  {BULLET} A.8.24 styling applied (navy headers, yellow inputs)")
        print(f"  {BULLET} Cross-domain metrics aggregation")
