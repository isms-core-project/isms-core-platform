...
def populate_coverage_matrix(wb):
    ...
    data = [
        ...
        ["Azure VNet - Production", "Partial", "-", "Active", "-", "-", "85%"],
...
def populate_device_inventory(wb):
    ...
    data = [
        ...
        ["iOS Devices (BYOD)", "800", "Remote", "Zscaler Client Connector", "Partial", "Partial - MAM", "App-level protection only"],
        ["Android Devices (BYOD)", "300", "Remote", "Zscaler Client Connector", "Partial", "Partial - MAM", "App-level protection only"],
        ...
        ["Guest Devices (Variable)", "~200/day", "Guest WiFi", "Cisco Umbrella (DNS)", "Partial", "No", "Captive portal planned"],
        ["Contractor Laptops", "200", "Corporate/Remote", "Mixed", "Partial", "Partial", "Enforcement in progress"],
        ...
        ["Azure VMs", "400", "Azure VNet", "Prisma Access / Cloud Connector", "Partial", "N/A", "Migration in progress"],
