...
# =============================================================================
"""
A.5.5-6 Workbook Normalizer - Normalizes all A.5.5-6 External Communications
workbooks for consistent formatting.

Usage: python3 normalize_a55_6.py
"""
...
def main() -> int:
    ...
    workbooks = list(WORKBOOK_DIR.glob("ISMS-IMP-A.5.5-6*.xlsx"))
    if not workbooks:
        logger.info("No A.5.5-6 workbooks found")
        return 0
