...
def get_domain3_requirements():
    ...
    return [
        ...
        {
            "id": "3.15",
            "requirement": "Deployment logs are sent to centralized logging/SIEM",
...
def get_domain5_requirements():
    ...
    return [
        ...
        {
            "id": "5.6",
            "requirement": "Security patches are prioritized and tracked with defined SLAs",
...
def create_summary_dashboard(ws, styles):
    ...
    ws["C7"] = """=(COUNTIF(Security_Requirements_Design!C:C,"Implemented")+
COUNTIF(Development_Environment!C:C,"Implemented")+
COUNTIF(Build_Deployment_Pipeline!C:C,"Implemented")+
COUNTIF(Security_Testing_Integration!C:C,"Implemented")+
COUNTIF(Release_Change_Management!C:C,"Implemented"))/
(COUNTA(Security_Requirements_Design!C:C)+
COUNTA(Development_Environment!C:C)+
COUNTA(Build_Deployment_Pipeline!C:C)+
COUNTA(Security_Testing_Integration!C:C)+
COUNTA(Release_Change_Management!C:C)-5-
COUNTIF(Security_Requirements_Design!C:C,"N/A")-
COUNTIF(Development_Environment!C:C,"N/A")-
COUNTIF(Build_Deployment_Pipeline!C:C,"N/A")-
COUNTIF(Security_Testing_Integration!C:C,"N/A")-
COUNTIF(Release_Change_Management!C:C,"N/A"))"""
    ...
    # Domain data
    domains = [
        ("Security_Requirements_Design", "1. Security Requirements & Design"),
        ("Development_Environment", "2. Development Environment & Tooling"),
        ("Build_Deployment_Pipeline", "3. Build & Deployment Pipeline"),
        ("Security_Testing_Integration", "4. Security Testing Integration"),
        ("Release_Change_Management", "5. Release & Change Management"),
    ]
    ...
    ws["A18"].fill = PatternFill(start_color="70AD47", end_color="70AD47", fill_type="solid")
    ws.merge_cells("A18:E18")
    ws["A18"].alignment = Alignment(horizontal="center")

    stats = [
        ("Total Requirements Assessed:", "=COUNTA(Security_Requirements_Design!C:C)+COUNTA(Development_Environment!C:C)+COUNTA(Build_Deployment_Pipeline!C:C)+COUNTA(Security_Testing_Integration!C:C)+COUNTA(Release_Change_Management!C:C)-5"),
        ("Implemented:", '=COUNTIF(Security_Requirements_Design!C:C,"Implemented")+COUNTIF(Development_Environment!C:C,"Implemented")+COUNTIF(Build_Deployment_Pipeline!C:C,"Implemented")+COUNTIF(Security_Testing_Integration!C:C,"Implemented")+COUNTIF(Release_Change_Management!C:C,"Implemented")'),
        ("Partially Implemented:", '=COUNTIF(Security_Requirements_Design!C:C,"Partially Implemented")+COUNTIF(Development_Environment!C:C,"Partially Implemented")+COUNTIF(Build_Deployment_Pipeline!C:C,"Partially Implemented")+COUNTIF(Security_Testing_Integration!C:C,"Partially Implemented")+COUNTIF(Release_Change_Management!C:C,"Partially Implemented")'),
        ("Not Implemented:", '=COUNTIF(Security_Requirements_Design!C:C,"Not Implemented")+COUNTIF(Development_Environment!C:C,"Not Implemented")+COUNTIF(Build_Deployment_Pipeline!C:C,"Not Implemented")+COUNTIF(Security_Testing_Integration!C:C,"Not Implemented")+COUNTIF(Release_Change_Management!C:C,"Not Implemented")'),
        ("Not Applicable (N/A):", '=COUNTIF(Security_Requirements_Design!C:C,"N/A")+COUNTIF(Development_Environment!C:C,"N/A")+COUNTIF(Build_Deployment_Pipeline!C:C,"N/A")+COUNTIF(Security_Testing_Integration!C:C,"N/A")+COUNTIF(Release_Change_Management!C:C,"N/A")'),
    ]
...
def create_approval_sheet(ws, styles):
    ...
    ws["B15"] = "=Summary_Dashboard!B19"
    ws["B15"].font = Font(bold=True)
    
    ws["A16"] = "Implemented:"
    ws["B16"] = "=Summary_Dashboard!B20"
    ...
    ws["B19"] = "=Summary_Dashboard!B23"
    ws["B19"].fill = PatternFill(start_color="E7E6E6", end_color="E7E6E6", fill_type="solid")
    ...
    ws["A29"].fill = PatternFill(start_color="70AD47", end_color="70AD47", fill_type="solid")
