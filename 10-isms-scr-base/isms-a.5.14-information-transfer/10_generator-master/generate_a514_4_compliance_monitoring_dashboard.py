...
def create_transfer_incidents_sheet(wb: Workbook):
    ...
    incidents = [
        ...
        ("INC-TRF-002", "", "Cloud Storage", "Unauthorized Sharing", "", "", "", "", "", "", "", ""),
    ...
    add_data_validation(ws, f"D4:D{row-1}", '"Data Leakage,Unauthorized Sharing,Lost Device,Interception,Policy Violation,Malware,Unauthorized Access,Other"')
