...
"""
================================================================================
A.5.14 Workbook Normalizer
================================================================================

Normalizes all A.5.14 Information Transfer workbooks to ensure consistent
formatting, styling, and structure across all generated Excel files.

Usage:
    python3 normalize_a514.py
================================================================================
"""
...
def main() -> int:
    ...
    workbooks = list(WORKBOOK_DIR.glob("ISMS-IMP-A.5.14*.xlsx"))

    if not workbooks:
        logger.info("No A.5.14 workbooks found to normalize")
        return 0
