...
"""
================================================================================
A.5.37 Sanity Check Script
================================================================================

Validates all A.5.37 generated workbooks for:
...
EXPECTED_WORKBOOKS = {
    "A.5.37.1": {
        "pattern": "ISMS-IMP-A.5.37.1_Procedure_Inventory*.xlsx",
        "required_sheets": [
            "Instructions",
            "Procedure_Inventory",
            "Required_Procedures",
    ...
    "A.5.37.2": {
        "pattern": "ISMS-IMP-A.5.37.2_Procedure_Quality*.xlsx",
        "required_sheets": [
            "Instructions",
            "Quality_Assessment",
            "Quality_Checklist",
    ...
    "A.5.37.3": {
        "pattern": "ISMS-IMP-A.5.37.3_Procedure_Review*.xlsx",
        "required_sheets": [
            "Instructions",
            "Review_Schedule",
            "Change_Requests",
    ...
    "A.5.37.4": {
        "pattern": "ISMS-IMP-A.5.37.4_Compliance_Dashboard*.xlsx",
        "required_sheets": [
            "Executive_Dashboard",
            "Category_Analysis",
            "Review_Status",
