...
**Document ID**: ISMS-IMP-A.5.31-S5  
...
### 2.1 Step 1: Evidence Identification

#### 2.1.1 Review Control Mappings
...
#### 2.1.2 Determine Evidence Types
...
### 2.2 Step 2: Evidence Collection

#### 2.2.1 Assign Collection Responsibilities
...
#### 2.2.2 Collection Methods by Evidence Type
...
#### 2.2.3 Evidence Collection Checklist
...
#### 2.3.2 Completeness Verification
...
### 2.4 Step 4: Evidence Organization

#### 2.4.1 Evidence Repository Structure
...
#### 2.4.4 Evidence Register Population
...
#### 2.5.3 Change Management Integration
...
### 2.6 Step 6: Audit Preparation

#### 2.6.1 Evidence Gap Analysis
...
### 2.7 Step 7: Evidence Presentation

#### 2.7.1 Auditor Evidence Request
...
#### 2.7.2 Handling Evidence Gaps During Audit
...
#### 2.7.3 Evidence Presentation Best Practices
...
## 3. Evidence Types: Detailed Guidance
...
### 4.1 Evidence for Third-Party Controls
...
### 4.2 Evidence for Compensating Controls
...
### 5.1 Evidence Register (Workbook 5)
...
### 7.1 Evidence Management Metrics
