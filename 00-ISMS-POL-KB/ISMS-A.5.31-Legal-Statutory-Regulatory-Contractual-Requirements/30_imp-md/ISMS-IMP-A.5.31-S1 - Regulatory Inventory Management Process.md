...
**Document ID**: ISMS-IMP-A.5.31-S1  
**Title**: Regulatory Inventory Management Process  
**Version**: 1.0  
**Related Policy**: ISMS-POL-A.5.31-S2 (Regulatory Applicability Methodology)  
**Purpose**: Operational guide for creating, maintaining, and managing the master regulatory inventory
...
- Integration with applicability assessments (IMP-S2)

**What This Guide Is Not**:
- How to assess applicability (that's IMP-S2)
- How to extract requirements (that's IMP-S3)
- Legal interpretation guidance (consult legal counsel)

### 1.2 The Regulatory Inventory Explained
...
- Perform IMP-S2 assessment, determine Tier
         ↓
...
## 6. Integration with ISMS-POL-00
