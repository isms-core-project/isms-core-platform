#!/usr/bin/env python3
"""
ISMS-IMP-A.8.23.4 - Monitoring & Response Assessment Generator
ISO/IEC 27001:2022 Control A.8.23: Web Filtering

Generates Excel workbook for assessing web filtering monitoring,
logging, alerting, and incident response capabilities.
...
def create_sheet_instructions(wb, styles):
    ...
    instructions = [
        ...
        "2. Use dropdown menus for standardized entries (Status, Severity, Priority, etc.)",
        "3. Fill in yellow-highlighted cells with your organization-specific information",
...
def create_sheet_incident_response(wb, styles):
    ...
    incident_cats = [
        ...
        ("Unauthorized bypass attempt", "High", 30, 8),
...
def create_sheet_approval(wb, styles):
    ...
    summary_items = [
        ...
        ("Organization:", "=Instructions_Legend!B11"),
