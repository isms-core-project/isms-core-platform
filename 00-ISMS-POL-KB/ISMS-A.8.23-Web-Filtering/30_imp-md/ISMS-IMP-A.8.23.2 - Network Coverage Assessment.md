...
| **Related Policy** | ISMS-POL-A.8.23-S2.1 (Threat Protection Requirements) |
...
- ISO/IEC 27001:2022 Control A.8.23: Web Filtering
- ISMS-POL-A.8.23-S2.1: Threat Protection Requirements (Section 2.1.1: "SHALL apply web filtering across all network segments")
...
- **Policy reference:** ISMS-POL-A.8.23-S2.1 Section 2.1.1
