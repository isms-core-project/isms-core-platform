...
| **Related Policy** | ISMS-POL-A.8.24-S3 (Key Management Requirements) |
...
|---------|------|---------|--------|
| 1.0 | [Original Date] | Initial technical specification for Key Management assessment workbook | ISMS Implementation Team |
...
This assessment implements **ISMS-POL-A.8.24-S3 (Key Management Requirements)** which defines mandatory controls for:
