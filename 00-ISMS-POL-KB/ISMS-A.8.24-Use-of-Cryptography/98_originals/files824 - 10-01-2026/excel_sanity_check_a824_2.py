#!/usr/bin/env python3
"""
Excel Workbook Sanity Checker - ISMS-IMP-A.8.24.2 Data Storage Assessment
Diagnoses issues that trigger Excel's "file level validation and repair"

SPECIALIZED VERSION for Data Storage Assessment workbooks

Usage:
    python3 excel_sanity_check_a824_2.py ISMS-IMP-A.8.24.2_Data_Storage_20251231.xlsx
