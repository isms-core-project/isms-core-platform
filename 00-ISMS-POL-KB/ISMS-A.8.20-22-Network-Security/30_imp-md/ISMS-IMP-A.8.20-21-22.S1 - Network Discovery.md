...
## Practical Implementation Guidance for Network Asset Discovery
### ISO/IEC 27001:2022 Controls A.8.20-21-22: Network Security Framework
...
**Title:** Network Discovery Process  
**Version:** 1.0  
**Date:** [Date]  
**Classification:** Internal  
**Owner:** [Organization] Network Security Team  
**Status:** Active  
**Review Cycle:** Annually  
**Parent Document:** ISMS-POL-A.8.20-21-22-S5 (Assessment Framework)  
**Related Documents:**
...
### 4.1 Phase 1: Planning & Scoping

#### 4.1.1 Define Discovery Scope
...
#### 4.1.2 Identify Discovery Constraints
...
#### 4.1.3 Obtain Scanning Authorization
...
### 4.2 Phase 2: Automated Discovery

#### 4.2.1 Network Scanning with nmap
...
#### 4.2.3 Cloud Infrastructure Discovery
...
#### 4.2.4 NetFlow/sFlow Traffic Analysis
...
### 4.3 Phase 3: Manual Discovery

#### 4.3.1 Documentation Review
...
#### 4.3.2 Network Administrator Interviews
...
#### 4.3.3 Physical Site Survey (if applicable)
...
### 4.4 Phase 4: Data Consolidation & Validation

#### 4.4.1 Consolidate Discovery Results
...
#### 4.4.3 Identify and Investigate Gaps
...
### 5.1 Scheduled Automated Discovery
...
### 5.2 Integration with Configuration Management
...
### 5.3 Continuous Discovery with Monitoring Tools
...
### 6.1 Integration with A.8.20 (Network Security)
...
### 6.2 Integration with A.8.21 (Network Services)
...
### 6.3 Integration with A.8.22 (Network Segregation)
...
### 6.4 Integration with Other ISMS Controls
...
### 8.1 Pitfall: Incomplete Scanning Due to Firewall Blocks
...
### 8.2 Pitfall: SNMP Access Denied
...
### 8.3 Pitfall: Cloud Discovery Misses Resources
...
### 8.4 Pitfall: Duplicate Devices in Consolidated Inventory
...
### 8.5 Pitfall: Discovery Disrupts Production
...
### 11.3 Cloud CLI Command Reference
...
### 11.4 Sample Discovery Timeline
