...
| **Compliance Assessment Suite** | 18 compliance frameworks with assessment, scoring, gap tracking, and export. See [COMPLIANCE.md](COMPLIANCE.md) for full coverage notes. |
