...
<div class="te-page">
  ...
  @if (exposureQuery.isError()) {
    <div class="isms-alert isms-alert--error">
      ...
      <div class="mitre-table-box">
        <div class="table-header">
          <div class="table-header__left">
            ...
            <span class="table-header__title">Technique → Control Mapping</span>
          </div>
  ...
  `,
  styles: [`
    .te-page { display: flex; flex-direction: column; gap: 16px; }
    ...
    .table-header {
      padding: 8px 14px; border-bottom: 1px solid var(--mat-sys-outline-variant);
      display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 4px;
    }
    .table-header__left  { display: flex; align-items: center; gap: 6px; }
    .table-header__title { font-size: 0.85rem; font-weight: 700; }
    ...
    .src-chip {
      display: inline-block; font-size: 0.6rem; padding: 1px 5px; border-radius: 8px;
    ...
    .ctrl-chip {
      ...
      border-radius: 8px; font-family: monospace; cursor: default;
    }
    .gap-chip {
