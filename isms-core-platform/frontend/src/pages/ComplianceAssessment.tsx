...
const FRAMEWORK_META: Record<string, { name: string; subtitle: string; color: string; description: string; scoreLabels?: Record<number, string> }> = {
  ...
  UK_OPERATIONAL_RESILIENCE: {
    ...
    subtitle: 'FCA PS21/3 + PRA SS1/21',
    color: '#1565C0',
    description: 'UK Financial Sector Operational Resilience — FCA PS21/3 / PRA SS1/21 (important business services, impact tolerances, scenario testing). Includes FCA PS26/2 / PRA PS7/26 incident and third-party reporting (in force March 2027) and PRA SS2/21 outsourcing. UK functional equivalent of DORA for FCA/PRA-regulated entities.',
  },
  CYFUN_BE: {
    name: 'CyberFundamentals (CCN/CCB)',
    subtitle: 'v2025-10-01',
    color: '#1A237E',
    description: 'Belgian CyberFundamentals Framework 2025 — mandatory cybersecurity baseline for operators of essential services (OES) under the NIS2 transposition (Loi 2024). Structured on NIST CSF 2.0 functions (Govern, Identify, Protect, Detect, Respond, Recover). Four assurance levels: Small, Basic, Important, Essential.',
  },
  BAFIN_BAIT: {
    name: 'BaFin BAIT',
    subtitle: 'Rundschreiben 10/2021',
    color: '#B71C1C',
    description: 'BaFin BAIT — Bankaufsichtliche Anforderungen an die IT (Circular 10/2021). Binding IT governance and cybersecurity requirements for German credit institutions under §25a KWG. Covers IT strategy, IT governance, information risk management, information security, operational ICT continuity, IAM, and outsourcing of IT services.',
  },
  CSSF_LU: {
    name: 'CSSF Circulaire 20-750',
    subtitle: 'ICT Risk — Luxembourg',
    color: '#004494',
    description: 'CSSF Circular 20-750 — ICT and security risk management requirements for Luxembourg financial sector entities supervised by the CSSF. Covers governance, risk management, ICT operations, ICT projects, and business continuity. Updated by Circular 24-847 for DORA alignment.',
  },
  ACN_IT: {
    name: 'ACN Cyber Risk Management',
    subtitle: 'Linee Guida 2024',
    color: '#006630',
    description: 'ACN Linee Guida per la definizione dei processi di cyber risk management e security by design — Italian National Cybersecurity Agency guidelines. Applies to NIS2 subjects (operatori di servizi essenziali and fornitori di servizi digitali) under D.Lgs. 138/2024. Covers risk management lifecycle and security-by-design principles.',
  },
  EU_CLOUD_SOV: {
