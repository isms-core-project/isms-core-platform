...
patterns established by the following open-source projects:

- **Filigran — OpenCTI** — [https://github.com/OpenCTI-Platform/docker](https://github.com/OpenCTI-Platform/docker)
