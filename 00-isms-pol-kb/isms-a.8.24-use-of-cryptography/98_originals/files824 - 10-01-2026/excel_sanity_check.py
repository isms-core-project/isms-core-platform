#!/usr/bin/env python3
"""
Excel Workbook Sanity Checker for ISMS Assessment Workbooks
Diagnoses issues that trigger Excel's "file level validation and repair"

GENERIC VERSION - Works for all A.8.24 assessment workbooks (A.8.24.1 through A.8.24.5)

Usage:
    python3 excel_sanity_check.py ISMS-IMP-A.8.24.1_Data_Transmission_20251231.xlsx
    python3 excel_sanity_check.py ISMS-IMP-A.8.24.5_Compliance_Summary_Dashboard_20251231.xlsx
