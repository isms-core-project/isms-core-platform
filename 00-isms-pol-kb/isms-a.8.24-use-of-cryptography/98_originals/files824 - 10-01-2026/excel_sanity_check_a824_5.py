#!/usr/bin/env python3
"""
Excel Workbook Sanity Checker - ISMS-IMP-A.8.24.5 Compliance Summary Dashboard
Diagnoses issues that trigger Excel's "file level validation and repair"

SPECIALIZED VERSION for Compliance Summary Dashboard workbooks

Usage:
    python3 excel_sanity_check_a824_5.py ISMS-IMP-A.8.24.5_Compliance_Summary_Dashboard_20251231.xlsx
