#!/usr/bin/env python3
"""
Excel Workbook Sanity Checker - ISMS-IMP-A.8.24.4 Key Management Assessment
Diagnoses issues that trigger Excel's "file level validation and repair"

SPECIALIZED VERSION for Key Management Assessment workbooks

Usage:
    python3 excel_sanity_check_a824_4.py ISMS-IMP-A.8.24.4_Key_Management_20251231.xlsx
...
def check_workbook_health(filename):
    ...
    # ========================================================================
    print("\n" + "=" * 80)
    print("CHECK 0: A.8.24.4 STRUCTURE VALIDATION")
    print("=" * 80)
    ...
    if "Summary Dashboard" in wb.sheetnames:
        ...
        if missing_sections:
            ...
            print(f"  ✓ Summary Dashboard: All 11 analysis sections found")
    
    if structure_issues == 0:
        print("  ✓ Workbook structure matches A.8.24.4 specification")
    ...
    if not issues_found and not warnings_found:
        print("\n✅ NO ISSUES DETECTED")
        print("\nThe workbook appears structurally sound and matches A.8.24.4 specification.")
    ...
    print("\n" + "=" * 80)
    print("A.8.24.4 SPECIFIC NOTES:")
    print("=" * 80)
    print("\nExpected structure:")
    print("  • 9 sheets total")
    print("  • 5 key management assessment sheets:")
    print("    - Key Generation (17 base + 5 extended = 22 columns, 14 checklist items)")
    print("    - Key Storage (17 base + 6 extended = 23 columns, 17 checklist items)")
    print("    - Key Rotation (17 base + 6 extended = 23 columns, 16 checklist items)")
    print("    - Key Backup & Recovery (17 base + 7 extended = 24 columns, 18 checklist items)")
    print("    - Certificate Management (17 base + 7 extended = 24 columns, 20 checklist items)")
    print("  • Each assessment sheet: 13 data rows, compliance checklist, 1-2 reference tables")
    print("  • Summary Dashboard with 11 comprehensive analysis sections:")
    print("    1. Compliance summary by key management area")
    print("    2. Key management maturity by area")
    print("    3. Algorithm distribution analysis")
    print("    4. Storage method distribution with security ratings")
    print("    5. Key rotation coverage")
    print("    6. Certificate management health")
    print("    7. FIPS 140-2 validation status")
    print("    8. Critical gaps requiring attention (8 rows)")
    print("    9. Risk summary by data classification")
    print("    10. Key backup coverage metrics")
    print("    11. Overall assessment summary with maturity rating")
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python3 excel_sanity_check_a824_4.py <filename.xlsx>")
        print("\nExample:")
        print("  python3 excel_sanity_check_a824_4.py ISMS-IMP-A.8.24.4_Key_Management_20251231.xlsx")
        sys.exit(1)
