...
Updated: 13.01.2026 - CA/Browser Forum Ballot SC-081v3 Integration
- Certificate validity reflects phased timeline (398→200→100→47 days)
- Automation requirement emphasized (mandatory for public CAs by Mar 2026)
- Infrastructure readiness assessment for 47-day lifecycle (by Mar 2029)
...
def create_summary_dashboard(ws, styles):
    ...
    for label, sheet, status_col in areas:
        ...
        status_range = f"'{sheet}'!{status_col_letter}8:{status_col_letter}100"
