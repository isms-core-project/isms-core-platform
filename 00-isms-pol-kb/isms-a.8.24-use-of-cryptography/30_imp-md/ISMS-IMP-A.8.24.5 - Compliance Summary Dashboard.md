...
**Title:** Cryptography Compliance Summary Dashboard - User Completion Guide  
**Version:** 1.0 
**Date:** [Date]  
**Classification:** Internal  
**Related Policy:** ISMS-POL-A.8.24 (Use of Cryptography)  
**Related Assessments:** ISMS-IMP-A.8.24.1 (Transmission), A.8.24.2 (Storage), A.8.24.3 (Authentication), A.8.24.4 (Key Management)
...
|---------|------|--------|---------|
| 1.0 | [Original Date] | CISO / Security Manager | Initial dashboard specification |

**Review Cycle:** Quarterly (dashboard refresh cycle)  
**Next Review Date:** [Approval Date + 90 days]
...
### 1.3 Dashboard Structure (9 Sheets)
...
| 7 | **Action Items** | Follow-up tasks and ownership | Security Team, IT |
| 8 | **Audit Log** | Compliance review history | Auditors, Compliance |
| 9 | **Meeting & Review** | Governance meeting records | CISO, Management |
...
### 1.4 Connection to Policy Framework
...
### 2.1 Completed Source Assessments (MANDATORY)
...
### 3.1 Step-by-Step Generation Process
...
### 3.2 First-Time Setup (One-Time Activities)
...
- **Quarterly Security Review Meeting** (2 hours, CISO + Security Team)
  ...
  - Update Sheet 9 (Meeting & Review Log)
...
## 4. Understanding Dashboard Sections

### 4.1 Sheet 1: Executive Dashboard (THE CRITICAL SHEET)
...
### 4.2 Sheet 2: Gap Analysis (THE DETAIL SHEET)
...
### 4.3 Sheet 3: Risk Register (THE RISK SHEET)
...
### 4.4 Sheet 4: Remediation Roadmap (THE ACTION SHEET)
...
### 4.5 Sheet 5: KPIs & Metrics (THE MEASUREMENT SHEET)
...
### 4.6 Sheets 6-9: Supporting Documentation
...
**Sheet 9: Meeting & Review Log**
- **Purpose:** Document governance meetings where dashboard was reviewed
- **Use Case:** Prove CISO oversight and management engagement to auditors
- **Maintenance:** Update after each quarterly security review meeting

---

## 5. Interpreting Results

### 5.1 Compliance Percentage Ranges
...
### 5.2 Gap Severity Interpretation
...
### 5.3 Risk Scoring Decision Framework
...
### 7.1 Quarterly Update Procedure
...
5. **Update Sheet 8 (Audit Log)** with quarterly review date
...
4. **Document meeting** in Sheet 9 (Meeting & Review Log)
5. **Assign action items** in Sheet 7 (Action Items)
...
- **Focus:**
  ...
  - Evidence sufficient
- **Deliverable:** Technical approval in Sheet 9 (Meeting & Review Log)
...
2. **Update Action Items** weekly (security team standup)
...
| 7 | Action Items | Variable | Follow-up tasks and ownership |
| 8 | Audit Log | Variable | Compliance review history |
| 9 | Meeting & Review | Variable | Governance meeting records |
...
### Purpose
Document governance meetings where dashboard was reviewed and decisions made.

### Layout Specification

**Header (Rows 1-2):**
- **Title (Row 1):** "MEETING & REVIEW LOG"
- **Subtitle (Row 2):** "Governance meetings and management review records"

**Column Headers (Row 4):**

| Column | Header | Width | Type |
|--------|--------|-------|------|
| A | Meeting ID | 12 | Text (MTG-A824-001) |
| B | Meeting Date | 12 | Date |
| C | Meeting Type | 25 | Dropdown |
| D | Attendees | 35 | Text |
| E | Key Discussion Points | 40 | Text |
| F | Decisions Made | 40 | Text |
| G | Action Items Created | 25 | Text (link to Sheet 7) |
| H | Next Meeting Date | 12 | Date |
| I | Minutes Location | 30 | Text |
...
- Ad-Hoc Review (incident response)

**Example Meeting Entry:**
- **Date:** 10.01.2025
- **Type:** Quarterly Security Review
- **Attendees:** CISO, Security Manager, IT Manager, Database Admin Lead
- **Discussion:** "Reviewed Q4 2024 dashboard. Overall compliance 87.3%, 3 critical gaps. Discussed budget approval for HSM procurement."
- **Decisions:** "Approved CHF 45K for HSM. Prioritized database re-encryption over VPN upgrade due to Restricted data risk."
- **Actions:** "AI-A824-015 (Prepare HSM RFP), AI-A824-016 (Schedule DB migration kickoff)"
- **Next Meeting:** 10.04.2025 (Q1 2025 Review)
- **Minutes:** /ISMS/Meetings/2025-01-10_Quarterly_Security_Review.docx
