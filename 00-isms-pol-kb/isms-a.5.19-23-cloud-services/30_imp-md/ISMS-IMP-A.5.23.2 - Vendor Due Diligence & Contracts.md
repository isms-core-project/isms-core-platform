...
#### Header Section
- **Title:** "ISMS-IMP-A.5.23.2 – Vendor Due Diligence & Contracts"
...
- ISMS-IMP-A.5.23.1: Cloud Service Inventory (pulls service list)
...
- ISMS-IMP-A.5.23.1 (Inventory) - imports service names and criticality
- ISMS-IMP-A.5.23.5 (Compliance Dashboard) - exports vendor compliance metrics
