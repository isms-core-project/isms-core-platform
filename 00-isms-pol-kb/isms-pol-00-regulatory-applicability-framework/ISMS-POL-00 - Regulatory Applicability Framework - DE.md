...
**Titel**: Regulatory Applicability Framework  
**Version**: 1.0  
**Datum**: [Datum]  
...
|---------|------|--------|---------|
| 1.0 | [Datum] | CISO / Legal/Compliance / DPO | Initial Framework mit Abgrenzungen |
...
Diese Policy adressiert die folgenden ISO 27001:2022-Anforderungen:

| Clause | Anforderung | Wie adressiert |
|--------|-------------|----------------|
| 4.1 | Verstehen der Organisation und ihres Kontextes | Regulatory Landscape Analysis, Identifikation externer Issues (rechtliches, regulatorisches Umfeld), die Information Security Objectives beeinflussen |
| 4.2 | Verstehen der Erfordernisse und Erwartungen interessierter Parteien | Identifikation von Regulatory Bodies, Kunden und Vertragsparteien mit ihren anwendbaren Anforderungen |
| 6.1.3 | Risk Treatment - Bestimmung von Controls | Regulatory Requirements informieren Control Selection und Statement of Applicability Justifications |
| A.5.31 | Gesetzliche, statutory, regulatorische und vertragliche Anforderungen | Primäre Policy zur Etablierung der Methodik für die Identifikation anwendbarer Anforderungen |

### Interessierte Parteien und ihre Anforderungen

| Interessierte Partei | Relevante Anforderungen | Quelle |
|----------------------|------------------------|--------|
| Eidgenössischer Datenschutz- und Öffentlichkeitsbeauftragter (EDÖB) | FADP Compliance | Tier 1 - Mandatory |
| EU-Datenschutzbehörden | GDPR Compliance | Tier 1 - Mandatory |
| Zertifizierungsstelle | ISO 27001:2022 Conformity | Tier 1 - Mandatory |
| Kunden (EU) | Data Protection, vertragliche Security-Anforderungen | Tier 1/2 - Variiert |
| Mitarbeiter | Privacy, faire Verarbeitung von Mitarbeiterdaten | Tier 1 - FADP/GDPR |
| Lieferanten | Vertragliche Security-Verpflichtungen | Tier 2 - Conditional |
| Finanzregulatoren (falls applicable) | FINMA, DORA Requirements | Tier 2 - Conditional |

---

### Alignment mit ISMS Scope

Dieses Regulatory Applicability Framework gilt für alle Aktivitäten, Systeme und Daten innerhalb des definierten ISMS Scope, wie im ISMS Scope Document dokumentiert.

Regulations, die für Aktivitäten ausserhalb des ISMS Scope gelten, werden durch separate Governance-Prozesse verwaltet.
...
- Artikel 8: Bearbeitung durch Auftragsbearbeiter
...
**Verordnung**: Verordnung (EU) 2024/1689 zur Festlegung harmonisierter Vorschriften für künstliche Intelligenz  
**Inkrafttreten**: 1. August 2024 (stufenweise Umsetzung bis August 2027)

**Anwendbarkeitskriterien**:

- Organisation ist **Anbieter** (entwickelt oder beauftragt KI-Systeme, die auf dem EU-Markt bereitgestellt werden)
- Organisation ist **Betreiber** (nutzt KI-Systeme in eigener Verantwortung in der EU)
- Organisation ist **Einführer oder Händler** von KI-Systemen in der EU
- KI-System-Ergebnisse betreffen Personen in der EU (unabhängig vom Standort des Anbieters)

**Risikoklassifizierung** (bestimmt den Umfang der Pflichten):

| Risikostufe | Beispiele | Wesentliche Pflichten |
|-------------|-----------|----------------------|
| **Unannehmbares Risiko** | Social Scoring, biometrische Echtzeit-Identifizierung (mit Ausnahmen), Manipulationstechniken | **Verboten** |
| **Hohes Risiko** | Beschäftigungsentscheidungen, Kreditwürdigkeitsprüfung, Zugang zu wesentlichen Dienstleistungen, biometrische Kategorisierung, kritische Infrastruktur | Konformitätsbewertung, Risikomanagement, Daten-Governance, Transparenz, menschliche Aufsicht, Dokumentation |
| **Begrenztes Risiko** | Chatbots, Emotionserkennung, Deepfake-Generierung | Transparenzpflichten (Offenlegung der KI-Interaktion) |
| **Minimales Risiko** | Spam-Filter, KI-gestützte Entwicklungswerkzeuge, interne Analysen | Keine spezifischen Pflichten (freiwillige Verhaltenskodizes) |
...
- Artikel 10: Daten-Governance (Trainings-, Validierungs-, Testdatensätze)
- Artikel 11: Technische Dokumentation
- Artikel 12: Aufzeichnungspflichten und Protokollierung
...
- Artikel 4: KI-Kompetenz für Personal, das KI-Systeme bedient
...
- Inventar der KI-Systeme und Risikoklassifizierung (A.5.9)
- Risikomanagement für KI-Systeme (Abschnitt 6, A.5.7)
- Daten-Governance und Qualitätskontrollen (A.5.12-14)
- Protokollierung und Überwachung von KI-Ergebnissen (A.8.15-16)
- Verfahren zur menschlichen Aufsicht (A.5.37)
- Schulung des Personals zur KI-Kompetenz (A.6.3)
- Lieferantenmanagement für KI-Komponenten (A.5.19-23)
- Dokumentation und Transparenz (A.5.37)

**Sanktionen**: Bis zu 35 Mio. EUR oder 7% des weltweiten Jahresumsatzes (verbotene Praktiken), 15 Mio. EUR oder 3% (sonstige Verstösse)

**Bewertung**: Falls Organisation KI-Systeme entwickelt, betreibt oder vertreibt, die Personen in der EU betreffen → Risikoklassifizierung und anwendbare Pflichten prüfen
...
|-----------|---------------------|--------------|
| **EU AI Act** | Entwicklung/Betrieb von KI-Systemen mit Auswirkung auf EU-Personen | Europäische Union |
...
Die folgenden Regulations werden auf potenzielle zukünftige Anwendbarkeit überwacht, erfordern aber derzeit kein Compliance Assessment:

| Regulation | Jurisdiktion | Trigger für Full Assessment | Status |
|------------|--------------|----------------------------|--------|
| UK GDPR | Vereinigtes Königreich | UK Customer Data Processing, Post-Brexit-Divergenz von EU GDPR | Monitoring |
| India DPDP Act | Indien | Verarbeitung von Personal Data von India Residents | Monitoring — stufenweise Implementation 2024-2025 |
| China PIPL | China | Verarbeitung von Personal Data von China Residents, APAC Expansion | Monitoring |
| SEC Cybersecurity Rules | Vereinigte Staaten | US Publicly Traded Customers, Material Incident Reporting | Monitoring |
| Brazil LGPD | Brasilien | Verarbeitung von Personal Data von Brazil Residents | Monitoring |

**Review Trigger**: Jede Business Development-Aktivität, die diese Jurisdiktionen oder Kundensegmente betrifft, löst ein Full Applicability Assessment und potenzielle Hochstufung zu Tier 2 (Conditional) aus.

**Owner**: Legal/Compliance (Monitoring), CISO (Eskalation zu Full Assessment)
...
| EU AI Act | 2 - Conditional | Assessment Pending | AI system development/deployment affecting EU | CISO | [Datum] |
| NIST SP 800-53 | 3 - Informational | Reference Only | Technical Guidance | CISO | [Datum] |

**Assessment Status EU AI Act**: KI-System-Inventar und Risikoklassifizierung in Bearbeitung. Development Teams liefern KI-System-Katalog bis [Zieldatum]. Applicability Determination folgt gemäss EU AI Act-Risikoklassifizierungskriterien.
...
Die folgenden Quellen werden überwacht, um Regulatory Changes zu identifizieren, die ein Assessment erfordern:

| Jurisdiktion/Domain | Monitoring-Quelle | Frequenz | Owner |
|---------------------|-------------------|----------|-------|
| Schweiz | EDÖB-Mitteilungen, Bundesblatt | Monatlich | DPO |
| EU/GDPR | EDPB Guidelines, EUR-Lex | Monatlich | DPO |
| ISO/IEC | ISO Publication Updates | Vierteljährlich | CISO |
| Financial (falls applicable) | FINMA-Rundschreiben, ESA Publications | Monatlich | Compliance |
| Branchenspezifisch | Industry Association Bulletins | Vierteljährlich | CISO |
| Allgemein | Legal Counsel Regulatory Alerts | Laufend | Legal |
...
**Version Classification Decision**: CISO bestimmt die Versionsklassifizierung in Abstimmung mit Legal/Compliance. Major Versions erfordern Executive Management Approval; Minor Versions erfordern CISO Approval.
