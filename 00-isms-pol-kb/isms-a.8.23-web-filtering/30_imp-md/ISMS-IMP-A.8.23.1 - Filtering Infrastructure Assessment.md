...
| **Related Policy** | ISMS-POL-A.8.23-S2.1 (Threat Protection Requirements), ISMS-POL-A.8.23-S2.2 (Category Filtering Requirements) |
...
3. Review policy requirements (ISMS-POL-A.8.23-S2.1, S2.2, S2.3, S2.4)
...
**Steps:**
1. Review policy requirements (ISMS-POL-A.8.23-S2.1, S2.2, S2.3, S2.4)
...
**Policy Requirements:**
- ISMS-POL-A.8.23-S2.3 requires ≥90 days retention
...
| 3 | Bob Wilson | CISO | 22.01.2026 | Approved | Approved gap priorities and Q1 remediation plan |
