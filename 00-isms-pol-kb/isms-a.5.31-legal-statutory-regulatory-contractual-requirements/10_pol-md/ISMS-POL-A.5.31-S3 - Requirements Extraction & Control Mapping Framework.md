...
## 1. Introduction & Relationship to S1/S2
...
**ISMS-POL-A.5.31-S1** established the overall framework architecture, governance model, and integration with ISMS-POL-00 (Regulatory Applicability Framework). It defined the "why" and the structural foundation.

**ISMS-POL-A.5.31-S2** defined the systematic methodology for determining WHICH regulations apply to [Organization] based on geographic, operational, and contractual criteria. It answers the question: "What laws govern us?"

**ISMS-POL-A.5.31-S3** (this document) defines the systematic methodology for determining WHAT those applicable regulations require and HOW [Organization] complies through ISO 27001 controls. It answers the questions:
...
**ISMS-POL-A.5.31-S4** (subsequent) will define how [Organization] monitors regulatory changes, manages framework updates, and maintains audit-ready evidence.
...
- Specify which regulations apply to [Organization] (covered in S2)
- Define operational procedures for extraction and mapping (covered in IMP-S2 and IMP-S3)
- Define evidence management processes (covered in S4)

---

## 2. Requirements Extraction Process
...
- New regulation identified as applicable (from S2 process)
- Existing regulation amended (from S4 regulatory monitoring)
...
#### 3.2.1 Primary (P): Direct, Substantial Satisfaction
...
#### 3.2.2 Secondary (S): Partial or Supporting Satisfaction
...
#### 3.2.3 Supporting (Su): Indirect Contribution
...
#### 3.2.4 Not Applicable (N/A): No Relationship
...
### 3.3 Control Mapping Matrix Structure
...
#### 3.4.1 One Requirement → Multiple Controls (One-to-Many)
...
#### 3.4.2 Multiple Requirements → One Control (Many-to-One)
...
### 3.5 Beyond Annex A: Organization-Specific Controls

#### 3.5.1 When No Annex A Control Fits
...
#### 3.5.3 Governance of Organization-Specific Controls
...
#### 4.1.2 Gap Identification Process
...
#### 5.1.1 The Forward Traceability Chain
...
#### 5.2.1 The Reverse Traceability Chain
...
#### 5.3.1 Types of Changes Requiring Traceability
...
#### 5.3.2 Change Impact Analysis Using Traceability
...
6. Communicate changes to stakeholders (per Section S4 - covered in Change Management policy)
...
2. Trigger applicability re-assessment (per S2 methodology)
...
#### 5.3.3 Tools for Change Traceability
...
#### 6.1.1 Common Overlap Scenarios
...
#### 6.1.2 Overlap Detection Methods
...
#### 6.2.1 Why Implement to Most Stringent Standard?
...
#### 6.2.2 Stringency Comparison Framework
...
#### 6.2.3 Documentation of Most Stringent Determination
...
#### 6.3.1 Mapping Matrix Shows Multi-Regulation Satisfaction
...
#### 6.3.2 Evidence Serves Multiple Requirements
...
#### 6.3.3 Compliance Reporting Per Regulation
...
#### 6.4.1 Tagging Evidence with Multiple Requirements
...
#### 6.4.2 Avoiding Evidence Duplication
...
#### 6.4.3 Evidence Collection Strategy for Overlapping Requirements
...
## 7. Document Control & Related Documents
...
- **ISMS-POL-A.5.31-S4**: Change Management & Evidence Framework (subsequent)
...
- **ISMS-IMP-A.5.31-S5**: Evidence Management Process (subsequent)
