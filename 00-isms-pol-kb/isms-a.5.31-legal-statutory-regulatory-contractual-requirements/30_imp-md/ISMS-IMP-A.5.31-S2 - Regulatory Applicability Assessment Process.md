...
**Document ID**: ISMS-IMP-A.5.31-S2
**Title**: Regulatory Applicability Assessment Process  
**Version**: 1.0  
**Related Policy**: ISMS-POL-A.5.31-S2 (Regulatory Applicability Methodology)  
...
This implementation guide operationalizes the regulatory applicability methodology defined in ISMS-POL-A.5.31-S2. It provides step-by-step instructions for compliance personnel to systematically identify regulations that may apply to [Organization] and assess whether they are legally binding, conditionally applicable, or informational references.
...
- Requirements extraction methodology (that's IMP-S2)

### 1.2 When to Use This Process

**Trigger Events** (from POL-S2 Section 2.1):
...
- Apply decision framework from POL-S2
...
- Communicate to stakeholders
         ↓
[Complete - Proceed to Requirements Extraction (IMP-S2)]
```
...
## 2. Step 1 - Regulatory Identification
...
### 2.2 Where to Look for Regulations
...
## 4. Step 3 - Detailed Applicability Assessment
...
## 6. Step 5 - Documentation & Approval

### 6.1 Complete Applicability Assessment Form
...
### 6.2 Attach Supporting Evidence
...
### 7.1 Create Entry in ISMS-POL-00
...
### 7.2 Update ISMS-POL-00 Version
...
### 7.3 File Assessment Documentation
...
### 7.4 Communicate to Stakeholders
...
### 9.3 Decision Tree for Tier Assignment
...
### 9.4 Stakeholder Communication Template
