...
**Document ID**: ISMS-IMP-A.5.31-S4  
**Title**: Control Mapping Process  
**Version**: 1.0  
**Related Policy**: ISMS-POL-A.5.31-S3 (Requirements Extraction & Control Mapping Framework)  
...
This implementation guide operationalizes the control mapping framework defined in ISMS-POL-A.5.31-S3. It provides step-by-step instructions for compliance and security personnel to systematically map regulatory requirements to ISO 27001:2022 Annex A controls, identify gaps, and develop remediation plans.
...
- Requirements extraction methodology (that's IMP-S3)
- Evidence collection process (that's IMP-S5)

### 1.2 When to Use This Process

**Trigger Events**:

1. **New Requirements Extracted**: Requirements extracted from newly applicable regulation (via IMP-S3)
...
```
[Input: Requirements Register from IMP-S3]
         ↓
[STEP 1: Preparation]
...
- Communicate to stakeholders
         ↓
[Complete - Proceed to Evidence Management (IMP-S5)]
```
...
✅ Requirements extracted and documented in Requirements Register (IMP-S3 complete)  
...
#### 2.1.1 Review Requirements Register

**Actions**:
1. **Access Requirements Register** (Workbook 3 from IMP-S3)
...
#### 2.1.2 Prepare Control Mapping Matrix
...
#### 2.1.3 Review ISO 27001 Controls Inventory
...
### 2.2 Step 2: Requirement-by-Requirement Analysis

For each requirement in the Requirements Register, perform this analysis:

#### 2.2.1 Understand Requirement Objective

**Question**: What security outcome does this requirement mandate?

**Actions**:
1. **Read Interpreted Requirement** (actionable version from IMP-S3)
...
#### 2.2.2 Identify Candidate Controls
...
#### 2.2.3 Assess Control-to-Requirement Fit
...
### 2.3 Step 3: Mapping Assignment

#### 2.3.1 Populate Control Mapping Matrix
...
#### 2.3.2 Document Mapping Rationale
...
#### 2.3.3 Handle Multi-Control Requirements
...
#### 2.3.4 Handle One-to-Many Control Mappings
...
### 2.4 Step 4: Gap Identification

#### 2.4.1 Automated Gap Detection
...
#### 2.4.3 Document Gaps in Gap Register
...
### 2.5 Step 5: Gap Analysis & Prioritization

#### 2.5.1 Gap Prioritization Framework
...
### 2.6 Step 6: Remediation Planning

For each identified gap, develop remediation plan.

#### 2.6.1 Remediation Approaches
...
#### 2.6.2 Develop Remediation Plan
...
### 2.7 Step 7: Documentation & Approval

#### 2.7.1 Finalize Control Mapping Matrix
...
#### 2.7.3 Prepare Approval Package
...
### 2.8 Step 8: Integration & Communication

#### 2.8.1 Update Requirements Register
...
#### 2.8.2 Update Control Documentation
...
#### 2.8.3 Communicate to Stakeholders
...
### 3.1 Control Mapping Matrix (Workbook 4)
...
### 3.3 Mapping Rationale Document (Optional)
...
### 4.2 Common Mapping Errors to Avoid
...
### 5.1 Prerequisites (Input from Other Processes)

**From IMP-S2 (Requirements Extraction)**:
...
### 5.2 Outputs (Feed into Other Processes)

**To IMP-S5 (Evidence Management)**:
...
### 6.1 Mapping Maintenance

**When to Update Mappings**:

1. **Regulatory Changes**: Regulation amended, new requirements added → Re-extract (IMP-S3), re-map
...
### 9.1 ISO 27001:2022 Annex A Controls
...
### 9.2 Related Policy Documents

- **ISMS-POL-A.5.31-S1**: Executive Summary & Control Alignment
- **ISMS-POL-A.5.31-S2**: Regulatory Applicability Methodology (tier framework)
...
### 9.3 Related Implementation Guides
