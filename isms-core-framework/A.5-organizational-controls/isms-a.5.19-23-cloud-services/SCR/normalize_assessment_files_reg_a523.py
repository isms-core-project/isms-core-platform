...
"""
================================================================================
ISMS Assessment File Normalisation Utility
================================================================================
...
This script:
1. Scans directory for completed assessment files (S1-S5)
2. Validates document IDs in Instructions & Legend sheet
3. Copies files to normalised filenames (no dates/versions)
...
--------------------------------------------------------------------------------
    ...
    python3 normalize_assessment_files_reg_a523.py --source ./assessments

    # Automated mode (no prompts)
    python3 normalize_assessment_files_reg_a523.py --source ./assessments --auto-confirm
...
try:
    ...
    sys.stderr.write("Error: openpyxl not installed. Install with: pip install openpyxl\n")
    sys.exit(1)
...
EXPECTED_DOCS = {
    "ISMS-IMP-A.5.23.S1": {
        "title": "Cloud Service Inventory & Classification",
        "normalized": "ISMS-IMP-A.5.23.S1.xlsx"
    },
    "ISMS-IMP-A.5.23.S2": {
        "title": "Vendor Due Diligence & Contracts",
        "normalized": "ISMS-IMP-A.5.23.S2.xlsx"
    },
    "ISMS-IMP-A.5.23.S3": {
        "title": "Secure Configuration & Deployment",
        "normalized": "ISMS-IMP-A.5.23.S3.xlsx"
    },
    "ISMS-IMP-A.5.23.S4": {
        "title": "Ongoing Cloud Service Governance & Risk Management",
        "normalized": "ISMS-IMP-A.5.23.S4.xlsx"
    },
    "ISMS-IMP-A.5.23.S5": {
        "title": "Compliance Monitoring & Exit Planning",
        "normalized": "ISMS-IMP-A.5.23.S5.xlsx"
    },
}
...
def create_manifest(output_dir, mapping, source_dir):
    ...
    with open(manifest_path, 'w', encoding='utf-8') as f:
        ...
        f.write("ISO/IEC 27001:2022 - Control A.5.23: Information Security for Cloud Services\n")
        f.write("=" * 80 + "\n\n")
        ...
        f.write("This control requires 5 assessment workbooks:\n\n")
        ...
        f.write(f"  - Cloud Service Inventory & Classification:    {'✅' if 'ISMS-IMP-A.5.23.S1' in mapping else '❌'}\n")
        f.write(f"  - Vendor Due Diligence & Contracts:            {'✅' if 'ISMS-IMP-A.5.23.S2' in mapping else '❌'}\n")
        f.write(f"  - Secure Configuration & Deployment:           {'✅' if 'ISMS-IMP-A.5.23.S3' in mapping else '❌'}\n")
        f.write(f"  - Ongoing Cloud Governance & Risk Management:  {'✅' if 'ISMS-IMP-A.5.23.S4' in mapping else '❌'}\n")
        f.write(f"  - Compliance Monitoring & Exit Planning:       {'✅' if 'ISMS-IMP-A.5.23.S5' in mapping else '❌'}\n\n")
        ...
        f.write("The Cloud Services Dashboard uses external workbook links to\n")
        ...
        f.write("     python3 generate_reg_a523_5_compliance_dashboard.py\n\n")
...
def normalize_files(source_dir=None, output_dir=None, auto_confirm=False):
    ...
    print("ISO/IEC 27001:2022 - Control A.5.23: Information Security for Cloud Services")
    print("=" * 80)
    ...
    print("     python3 generate_reg_a523_5_compliance_dashboard.py\n")
...
Examples:
  ...
  python3 normalize_assessment_files_reg_a523.py --source ./assessments --output ./dashboard
