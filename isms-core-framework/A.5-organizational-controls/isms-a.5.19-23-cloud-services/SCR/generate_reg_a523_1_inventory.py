...
def create_instructions_sheet(ws, styles):
    ...
    legend = [
        ...
        ("N/A", "Not Applicable", "Requirement does not apply to this service", None),
    ]
...
def create_evidence_register(ws, styles):
    ...
    ws["A2"] = "Track all cloud service contracts, certifications, and compliance documentation"
    apply_style(ws["A2"], styles["subheader"], "subheader")

    headers = [
        ("Evidence ID", 15), ("Cloud Service", 30), ("Evidence Type", 25),
        ("Description", 40), ("File Location", 40), ("Collection Date", 16),
        ("Collected By", 20), ("Retention", 16), ("Status", 15),
    ]
