...
"""
================================================================================
A.5.32-33 Workbook Normalizer
================================================================================

Normalizes all A.5.32-33 Information Protection workbooks to ensure
consistent formatting, styling, and structure across all generated Excel files.

Usage:
    python3 normalize_a532_33.py
================================================================================
"""
...
def main() -> int:
    ...
    workbooks = list(WORKBOOK_DIR.glob("ISMS-IMP-A.5.32-33*.xlsx"))

    if not workbooks:
        logger.info("No A.5.32-33 workbooks found to normalize")
        return 0
...
# QA_STATUS: PASSED
# QA_TOOL: Claude Code
# CHANGES: Initial creation for A.5.32-33 Information Protection control
# =============================================================================
