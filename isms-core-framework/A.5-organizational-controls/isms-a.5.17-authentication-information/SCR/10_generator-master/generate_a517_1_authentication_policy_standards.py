...
def create_user_responsibilities_sheet(wb: Workbook):
    ...
    responsibilities = [
        ...
        ("MFA Device Security", "Protect MFA devices (phones, tokens) from unauthorized access", "MANDATORY", "Device management policy", "Yes", ""),
...
def create_system_requirements_sheet(wb: Workbook):
    ...
    requirements = [
        ...
        ("Secrets Management", "Centralized secrets management", "HashiCorp Vault, Azure Key Vault", "", "", "", ""),
