...
def populate_instructions_sheet(wb):
    ...
    instructions = [
        "",
        "PURPOSE:",
        "Master list of all regulations, frameworks, and standards relevant to [Organisation]'s",
        ...
        "   • Applicable: Regulation currently applies to [Organisation]",
        "   • Conditional: Applies only under specific conditions (document in Rationale)",
        "   • Not Applicable: Does not apply to [Organisation] (document why)",
        "   • Under Review: Assessment in progress, determination pending",
        "",
...
def main():
    ...
    logger.info("   3. Customise for [Organisation]'s regulatory landscape")
