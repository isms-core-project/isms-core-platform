...
"""
================================================================================
Excel Workbook Sanity Checker - ISMS A.5.30/14/5.30 Assessment Workbooks
================================================================================

Diagnostic utility for troubleshooting Excel's "file level validation and repair"
warnings when opening A.5.30/14/5.30 BC/DR assessment workbooks.
...
**Usage:**
    python3 excel_sanity_check_a530.py ISMS_Assessment_Backup_Inventory.xlsx
    
    Works with any A.5.30/14/5.30 assessment workbook (domains 1-5)
...
**Related Scripts:**
- excel_sanity_check_a530_1.py through _5.py (domain-specific checkers)
- generate_a530_1_backup_inventory.py through generate_a530_5_compliance_dashboard.py
...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        print("Controls: A.5.30 (Backup), A.8.14 (Redundancy), A.5.30 (ICT BC)")
        print("=" * 70)
