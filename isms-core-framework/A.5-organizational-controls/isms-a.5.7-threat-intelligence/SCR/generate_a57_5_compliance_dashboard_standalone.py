...
- Cost Avoidance: "Early threat detection prevented 3 potential incidents (CHF XXM)"
...
def create_instructions_sheet(wb):
    ...
    contact_data = [
        ...
        ("ISMS Support:", "isms@[organisation].com"),
        ("", ""),
...
def create_monthly_data_entry_sheet(wb):
    ...
    doc_fields = [
        ...
        ("Entered_By", "", "Your email", "jane.ciso@example.ch"),
    ...
    source_fields = [
        ...
        ("Annual_Source_Cost_CHF", "", "Total subscription costs (approx.)", "450000"),
    ]
    ...
    prevention_fields = [
        ...
        ("Cost_Avoidance_CHF", "", "Estimated savings (approx.)", "275000"),
...
def create_roi_summary_sheet(wb):
    ...
    row += 1
    cost_categories = [
        ("Commercial TI Sources", 450000, 420000, "=B{}-C{}", "=(B{}-C{})/C{}*100", "Sample (approx.)"),
        ("Staffing (FTE cost)", 600000, 580000, "=B{}-C{}", "=(B{}-C{})/C{}*100", "Sample (approx.)"),
        ("Tools & Infrastructure", 150000, 140000, "=B{}-C{}", "=(B{}-C{})/C{}*100", "Sample (approx.)"),
        ("Training & Certifications", 25000, 20000, "=B{}-C{}", "=(B{}-C{})/C{}*100", "Sample (approx.)"),
        ("Travel & Conferences", 15000, 12000, "=B{}-C{}", "=(B{}-C{})/C{}*100", "Sample (approx.)"),
    ]
    ...
    row += 1
    value_categories = [
        ("Incidents Prevented (Cost Avoidance)", 3300000, 2800000, "=B{}-C{}", "=(B{}-C{})/C{}*100", "Sample (approx.); from Trend_History"),
        ("Faster Incident Response (Time Savings)", 450000, 380000, "=B{}-C{}", "=(B{}-C{})/C{}*100", "Sample: 120 hrs downtime × CHF 3'750/hr impact"),
        ("Risk Assessment Improvements", 180000, 150000, "=B{}-C{}", "=(B{}-C{})/C{}*100", "Sample: 12 updates × CHF 15K"),
        ("Compliance & Audit Efficiency", 90000, 75000, "=B{}-C{}", "=(B{}-C{})/C{}*100", "Sample: 60 audit-hrs × CHF 1'500/hr team rate"),
    ]
    ...
    row += 1
    cvss_data = [
        ("Critical (9.0-10.0)", 8, 150000, "=B{}*C{}", "=D{}/D{}", "Sample (approx.)"),
        ("High (7.0-8.9)", 18, 75000, "=B{}*C{}", "=D{}/D{}", "Sample (approx.)"),
        ("Medium (4.0-6.9)", 14, 25000, "=B{}*C{}", "=D{}/D{}", "Sample (approx.)"),
        ("Low (0.1-3.9)", 4, 5000, "=B{}*C{}", "=D{}/D{}", "Sample (approx.)"),
    ]
