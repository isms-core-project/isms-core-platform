<!-- ISMS-CORE:IMP:ISMS-IMP-A.7.1-2-3-S2-UG:framework:UG:a.7.1-2-3-s2 -->
**ISMS-IMP-A.7.1-2-3-S2-UG - Entry Control Assessment**
...
**Assessment Name:** ISMS-IMP-A.7.1-2-3-S2 - Entry Control Assessment
...
| Assessment            | Focus                  | Relationship to A.7.1-2-3-S2      |
|-----------------------|------------------------|------------------------------------|
...
- ISMS-POL-A.7.1-2-3, Section 2.2 (Physical Entry Controls)
...
- ISMS-IMP-A.7.1-2-3-S1 (Perimeter Security) - Use zone definitions from S1
...
- Review ISMS-POL-A.7.1-2-3 entry control requirements
