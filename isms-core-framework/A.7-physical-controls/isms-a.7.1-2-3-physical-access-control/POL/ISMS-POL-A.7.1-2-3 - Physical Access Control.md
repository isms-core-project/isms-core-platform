...
- **Provide access control system technical specifications** (see ISMS-IMP-A.7.1-2-3)
...
A.7.1-2-3 (Physical Access Control) stacks with related controls:

| Stacked Control | Integration Point | A.7.1-2-3 Contribution |
|-----------------|-------------------|------------------------|
| **A.7.4-5-11** (Infrastructure Security) | Monitoring and environment | A.7.1-2-3 defines access; A.7.4-5-11 monitors and protects |
| **A.5.15-16-18** (IAM) | Logical-physical integration | A.7.1-2-3 physical access; IAM logical access |
| **A.5.24-28** (Incident Management) | Physical incidents | A.7.1-2-3 prevents; A.5.24-28 responds to physical security incidents |

Assessment of A.7.1-2-3 should reference stacked control assessments for complete coverage.

## Implementation Resources

**Implementation Guidance** (ISMS-IMP-A.7.1-2-3 Suite):
