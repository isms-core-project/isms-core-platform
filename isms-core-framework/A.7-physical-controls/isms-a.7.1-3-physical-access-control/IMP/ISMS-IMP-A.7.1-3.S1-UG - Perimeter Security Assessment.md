...
**ISMS-IMP-A.7.1-3.S1-UG - Perimeter Security Assessment**
...
| **Document ID** | ISMS-IMP-A.7.1-3.S1-UG |
...
This is the **User Completion Guide**. The companion Technical Specification is documented in ISMS-IMP-A.7.1-3.S1-TG.
...
**Assessment Name:** ISMS-IMP-A.7.1-3-S1 - Perimeter Security Assessment
...
This assessment is **facility-agnostic**. You document YOUR specific security zones and perimeters (whatever your building type - office, datacenter, warehouse, mixed-use), and verify construction and monitoring against policy requirements from ISMS-POL-A.7.1-3.
...
| Assessment            | Focus                  | Relationship to A.7.1-3-S1      |
|-----------------------|------------------------|------------------------------------|
| **ISMS-IMP-A.7.1-3-S1** | **Perimeter Security** | **WHERE are the security boundaries?** |
| ISMS-IMP-A.7.1-3-S2 | Entry Control          | HOW do people enter secure areas? |
| ISMS-IMP-A.7.1-3-S3 | Secure Areas           | WHAT happens inside secure areas? |

This assessment (A.7.1-3-S1) establishes the foundation by defining WHERE security zones are and their perimeters. Entry Control (S2) builds on this by documenting HOW access is controlled at these perimeters.
...
- ISMS-POL-A.7.1-3, Section 2.1 (Physical Security Perimeters)
...
- ISMS-IMP-A.7.1-3-S2 (Entry Control Assessment) - Uses zone definitions
...
- Review ISMS-POL-A.7.1-3 perimeter requirements
...
- Use classification from ISMS-POL-A.7.1-3
