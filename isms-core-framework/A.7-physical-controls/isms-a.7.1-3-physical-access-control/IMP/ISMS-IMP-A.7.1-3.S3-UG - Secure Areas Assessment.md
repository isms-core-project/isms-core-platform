...
**ISMS-IMP-A.7.1-3.S3-UG - Secure Areas Assessment**
...
| **Document ID** | ISMS-IMP-A.7.1-3.S3-UG |
...
This is the **User Completion Guide**. The companion Technical Specification is documented in ISMS-IMP-A.7.1-3.S3-TG.
...
**Assessment Name:** ISMS-IMP-A.7.1-3-S3 - Secure Areas Assessment
...
| Assessment            | Focus                  | Relationship to A.7.1-3-S3      |
|-----------------------|------------------------|------------------------------------|
...
| **ISMS-IMP-A.7.1-3-S3** | **Secure Areas**   | **WHAT controls inside areas?**    |
...
- ISMS-POL-A.7.1-3, Section 2.3 (Securing Offices, Rooms and Facilities)
...
- ISMS-IMP-A.7.1-3-S1 (Perimeter Security) - Zone inventory
- ISMS-IMP-A.7.1-3-S2 (Entry Control) - Access control configuration
...
- Review ISMS-POL-A.7.1-3 secure areas requirements
