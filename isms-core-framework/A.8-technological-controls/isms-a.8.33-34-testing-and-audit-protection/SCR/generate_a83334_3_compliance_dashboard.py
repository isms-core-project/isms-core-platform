...
def create_executive_dashboard_sheet(ws):
    ...
    title_cell = ws.cell(row=1, column=1, value="TESTING AND AUDIT PROTECTION - COMPLIANCE DASHBOARD")
    ...
    controls = [
        ...
        ("A.8.33", "Production data copied only when authorised", "IMP-A.8.33-34.1", "[%]", "[Status]", "[Link]"),
        ...
        ("A.8.34", "Audit tools authorised", "IMP-A.8.33-34.2", "[%]", "[Status]", "[Link]"),
    ...
    findings = [
        ("Test Data", "Unauthorised data in test", "Critical", "[#]", "[Name]", "[Date]", "[Status]"),
        ("Test Data", "Unmasked PII", "Critical", "[#]", "[Name]", "[Date]", "[Status]"),
        ("Audit", "Unauthorised audit activity", "Critical", "[#]", "[Name]", "[Date]", "[Status]"),
        ("Audit", "Unauthorised tools", "Critical", "[#]", "[Name]", "[Date]", "[Status]"),
...
def create_test_data_compliance_sheet(ws):
    ...
    inventory_metrics = [
        ("Total Data Sets", "-", "[#]", "-", ""),
        ("Authorised Data Sets", "100%", "[%]", "[Status]", ""),
        ("Pending Authorization", "0", "[#]", "[Status]", ""),
        ("Unauthorised Data Sets", "0", "[#]", "[Status]", "Critical if >0"),
        ("Data Sets with PII", "-", "[#]", "-", ""),
    ...
    refresh_metrics = [
        ...
        ("Authorised Refreshes", "100%", "[%]", "[Status]", ""),
...
def create_audit_activity_compliance_sheet(ws):
    ...
    ws.title = "Audit Activity Compliance"
    ...
    tool_metrics = [
        ("Total Tools", "-", "[#]", "-", ""),
        ("Authorised Tools", "100%", "[%]", "[Status]", ""),
        ("Pending Authorization", "0", "[#]", "[Status]", ""),
        ("Unauthorised Tools", "0", "[#]", "[Status]", "Critical"),
...
def create_ciso_certification_sheet(ws):
    ...
    attestation_items = [
        ...
        "",
        "5. Audit Readiness",
        "   [ ] The organisation is/is not ready for ISO 27001 audit of Controls A.8.33-34",
...
# CHANGES: Common sheets standardised (Evidence Register, Approval Sign-Off),
#          tab names (underscores→spaces), headers (white-on-blue), Unicode symbols,
#          Related Policy fixed, British English
# =============================================================================
