...
def create_instructions_sheet(ws, styles):
    ...
    instructions = [
        ...
        "2. Use dropdown menus for standardised entries (Status, Encryption Type, Algorithm, etc.)",
...
def create_1_mobile_devices(ws, styles):
    ...
    create_assessment_sheet(
        ...
        question="Does your organisation issue or allow mobile devices (smartphones, tablets) that store organizational data?",
        sheet_type="mobile",
...
def create_2_laptops_workstations(ws, styles):
    ...
    create_assessment_sheet(
        ...
        question="Does your organisation have laptops or workstations that store organizational data locally?",
        sheet_type="laptop",
        tech_notes_section=False,
    )
...
def create_3_servers(ws, styles):
    ...
    create_assessment_sheet(
        ...
        question="Does your organisation operate servers (physical or virtual) that store sensitive organizational data?",
        sheet_type="server",
        tech_notes_section=False,
    )
