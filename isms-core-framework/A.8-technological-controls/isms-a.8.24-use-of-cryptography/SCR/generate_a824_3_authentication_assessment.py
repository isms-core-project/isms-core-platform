...
your organization's specific authentication infrastructure, cryptographic
...
def create_instructions_sheet(ws, styles):
    ...
    instructions = [
        ...
        "2. Use dropdown menus for standardised entries (Status, Auth Method, Algorithm, etc.)",
