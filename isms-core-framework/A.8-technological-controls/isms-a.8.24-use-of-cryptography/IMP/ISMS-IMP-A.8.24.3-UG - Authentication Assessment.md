<!-- ISMS-CORE:IMP:ISMS-IMP-A.8.24.3-UG:framework:UG:a.8.24.3 -->
...
| 2 | 1. Password Security | Assess cryptographic controls for password security |
| 3 | 2. Multi-Factor Authentication | Assess MFA cryptographic implementation |
| 4 | 3. Certificate-Based Auth | Assess certificate-based authentication implementation |
| 5 | 4. Service Accounts | Assess cryptographic controls for service accounts |
| 6 | 5. SSO & Federation | Assess SSO and federated identity cryptography |
...
This assessment evaluates [Organisation]'s implementation of **cryptographic controls for authentication mechanisms** to ensure compliance with ISO/IEC 27001:2022 Control A.8.24 and applicable regulatory requirements.
...
- **PCI DSS v4.0.1 (Req. 8):** Requires strong authentication for systems processing cardholder data
...
- [Organisation]'s identity provider(s) (Active Directory, Entra ID, Okta, etc.)
...
- [Organisation]'s identity architecture (AD, Entra ID, hybrid, multi-IdP)
...
**Assessment Question:**  
*"Does your organisation use password-based authentication for any systems or applications?"*

**How to Answer:**

- **"Yes":** If ANY users authenticate with passwords (this is 99.9% of organisations)
- **"No":** Only if [Organisation] is 100% certificate-based or biometric (extremely rare - even Entra ID passwordless still has fallback passwords)
...
**Assessment Question:**  
*"Does your organisation require multi-factor authentication (MFA) for any user accounts or systems?"*
...
- **"Not Applicable":** Not appropriate (all organisations should evaluate MFA)
...
**N/A:** Not applicable (unusual - most organisations should have MFA)
...
**Problem:** IdP signing certificate expires, SSO breaks organisation-wide  
...
**Impact:** Organisation-wide authentication outage
