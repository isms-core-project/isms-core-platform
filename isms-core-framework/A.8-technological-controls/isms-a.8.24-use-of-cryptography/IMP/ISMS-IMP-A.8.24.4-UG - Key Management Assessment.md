<!-- ISMS-CORE:IMP:ISMS-IMP-A.8.24.4-UG:framework:UG:a.8.24.4 -->
...
| 2 | 1. Key Generation | Assess cryptographic key generation procedures |
| 3 | 2. Key Storage | Assess cryptographic key storage controls |
| 4 | 3. Key Rotation | Assess key rotation procedures and compliance |
| 5 | 4. Key Backup & Recovery | Assess key backup and recovery capabilities |
| 6 | 5. Certificate Management | Assess certificate lifecycle management |
| 7 | 6. Key Destruction | Assess secure key destruction procedures |
...
This assessment evaluates [Organisation]'s implementation of **cryptographic key lifecycle management controls** to ensure compliance with ISO/IEC 27001:2022 Control A.8.24 and applicable regulatory requirements.
...
- **PCI DSS v4.0.1 (Req. 3):** Extensive key management requirements for cardholder data
...
- **Certificate Expiration:** Expired certificates break services organisation-wide
...
- [Organisation]'s key management infrastructure (HSM, KMS, software keystores)
...
- [Organisation]'s key management architecture (HSM, KMS, software)
...
**Assessment Question:**  
*"Does your organisation generate cryptographic keys for any purpose (encryption, signing, authentication, TLS certificates)?"*

**How to Answer:**

- **"Yes":** If ANY cryptographic keys are generated (this is 99.9% of organisations)
- **"No":** Only if [Organisation] uses exclusively pre-shared keys from vendors (extremely rare)
...
**N/A:** Keys not generated by organisation (all keys provided by external vendors)
...
**Assessment Question:**  
*"Where does your organisation store cryptographic keys (HSM, KMS, software keystores, config files)?"*

**How to Answer:**

- **"Yes":** If ANY cryptographic keys are stored (this is 100% of organisations using crypto)
- **"No":** Not possible if organisation generates or uses keys
...
**Why Wrong:** Certificate expiration causes service outages, often organisation-wide  
