<!-- ISMS-CORE:IMP:ISMS-IMP-A.8.24.2-UG:framework:UG:a.8.24.2 -->
**ISMS-IMP-A.8.24.2-UG - Data Storage Assessment**
...
| **Document ID** | ISMS-IMP-A.8.24.2-UG |
...
| 2 | 1. Mobile Devices | Assess encryption of mobile device storage |
| 3 | 2. Laptops & Workstations | Assess encryption of laptop and workstation storage |
| 4 | 3. Servers | Assess encryption of server storage |
| 5 | 4. Databases | Assess database encryption implementation |
| 6 | 5. Cloud Storage | Assess cloud storage encryption implementation |
| 7 | 6. Backups | Assess backup encryption implementation |
| 8 | 7. Removable Media | Assess removable media encryption controls |
...
This assessment evaluates [Organisation]'s implementation of **cryptographic controls for data at rest** to ensure compliance with ISO/IEC 27001:2022 Control A.8.24 and applicable regulatory requirements.
...
- **PCI DSS v4.0.1 (Req. 3):** Requires encryption of cardholder data at rest (if applicable)
...
- [Organisation]'s endpoint management systems (MDM, SCCM, Intune)
...
- **Very Complex:** Large organisation with diverse storage types and legacy systems - consider splitting assessment across multiple team members
...
- **Business-owned devices:** Recovery keys MUST be escrowed to organisational system
...
- [Organisation]'s data classification scheme
...
- If [Organisation] has no mobile devices: Mark Sheet 1 as N/A with note "Desktops only environment"
...
**Assessment Question:**  
*"Does your organisation issue or allow mobile devices (smartphones, tablets) that store organisational data?"*

**How to Answer:**

- **"Yes":** If ANY employees have smartphones or tablets with access to email, files, or organisational apps (this is >95% of organisations)
- **"No":** Only if [Organisation] has zero mobile devices with organisational data (extremely rare - even executives usually have phones)
- **"Not Applicable":** Generally not appropriate (almost all organisations have mobile devices)
...
**N/A:** Organisation has no mobile devices with organisational data
...
- [ ] **Recovery keys escrowed to organisational MDM system**  
...
**Assessment Question:**  
*"Does your organisation have laptops or workstations that store organisational data?"*

**How to Answer:**

- **"Yes":** If ANY employees have laptops or workstations (this is 99.9% of organisations)
- **"No":** Only if [Organisation] is entirely thin-client/VDI with zero local data storage (extremely rare)
...
# Verify recovery key escrowed to Jamf/organisational system
```
...
- [ ] **FileVault enabled (macOS)**  
  ...
  *Recovery key:* Verify escrowed to Jamf or organisational system  
...
- [ ] **Recovery keys escrowed to Active Directory, Entra ID, or organisational KMS**  
...
- [ ] Data classifications verified against organisational scheme
- [ ] Key management methods accurate (TPM, KMS, HSM, etc.)

## Policy Alignment Checks

- [ ] All Confidential/Restricted data storage encrypted
- [ ] Mobile devices with organisational data encrypted
...
- [ ] Evidence organised logically and consistently named
