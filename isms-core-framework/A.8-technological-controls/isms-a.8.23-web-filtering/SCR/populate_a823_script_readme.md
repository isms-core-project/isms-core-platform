...
python3 populate_a823_1_filtering_infrastructure.py ../WKBK/ISMS-IMP-A.8.23.1_Filtering_Infrastructure_YYYYMMDD.xlsx

# Network Coverage (7 assessment categories)
python3 populate_a823_2_network_coverage.py ../WKBK/ISMS-IMP-A.8.23.2_Network_Coverage_YYYYMMDD.xlsx

# Policy Configuration (8 assessment categories)
python3 populate_a823_3_policy_configuration.py ../WKBK/ISMS-IMP-A.8.23.3_Policy_Configuration_YYYYMMDD.xlsx

# Monitoring & Response (8 assessment categories)
python3 populate_a823_4_monitoring_response.py ../WKBK/ISMS-IMP-A.8.23.4_Monitoring_Response_YYYYMMDD.xlsx
```
