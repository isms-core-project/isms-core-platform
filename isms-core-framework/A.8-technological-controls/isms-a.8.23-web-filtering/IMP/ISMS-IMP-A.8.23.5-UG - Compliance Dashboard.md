<!-- ISMS-CORE:IMP:ISMS-IMP-A.8.23.5-UG:framework:UG:a.8.23.5 -->
**ISMS-IMP-A.8.23.5-UG - Compliance Dashboard**
...
| Attribute | Value |
|-----------|-------|
| **Document ID** | ISMS-IMP-A.8.23.5-UG |
| **Version** | 1.0 |
...
This is the **User Completion Guide**. The companion Technical Specification is documented in ISMS-IMP-A.8.23.5-TG.
...
**Technical specifications are documented in the companion TG (Technical Guide) document.**
