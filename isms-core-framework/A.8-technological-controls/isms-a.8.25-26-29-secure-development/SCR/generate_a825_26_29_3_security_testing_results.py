...
OUTPUT_FILENAME = f"{DOCUMENT_ID}_Security_Testing_Results_Assessment_{GENERATED_TIMESTAMP}.xlsx"
...
def build_evidence_register_sheet(wb, styles, validations):
    ...
    cell = ws['A2']
    cell.value = "Centralised register of all security testing evidence"
    apply_style(cell, styles['subheader'])
