...
def build_security_tools_deployment_sheet(wb, styles, validations):
    ...
    ws.merge_cells('A2:H2')
    cell = ws['A2']
    cell.value = "Track security tool deployment across organization"
    apply_style(cell, styles['subheader'])
...
def build_developer_training_sheet(wb, styles, validations):
    ...
    example_data = [
        ["Alice Johnson", "2024-03-15", "2025-01-10", "Java Secure Coding (2024-06-20)", "N/A", 92],
        ["Bob Williams", "2023-05-10", "2024-01-15", "N/A", "Champion Training (2024-08-12)", 88],
        ["Carol Davis", "2024-08-22", "N/A", "Python Security (2024-10-05)", "N/A", 85],
...
def build_evidence_register_sheet(wb, styles, validations):
    ...
    cell = ws['A2']
    cell.value = "Centralized register of all SDLC security evidence"
    apply_style(cell, styles['subheader'])
