...
def create_base_validations(ws):
    ...
    validations = {
        ...
        'baseline_type': DataValidation(
            type="list",
            formula1='"User Activity,System Activity,Network Traffic,Application Behavior,Security Events,Resource Usage,Other"',
            allow_blank=False
        ),
        ...
        'tactic': DataValidation(
            type="list",
            formula1='"Reconnaissance,Resource Development,Initial Access,Execution,Persistence,Privilege Escalation,Defense Evasion,Credential Access,Discovery,Lateral Movement,Collection,Command and Control,Exfiltration,Impact"',
            allow_blank=False
        ),
...
def create_instructions_sheet(ws, styles):
    ...
    definitions = [
        ("Baseline", "Normal behavior pattern established through observation and statistical analysis"),
        ("Anomaly Detection", "Identification of deviations from established baseline behavior"),
...
def create_baseline_inventory_sheet(ws, styles):
    ...
    ws["A2"] = "Policy Reference: ISMS-POL-A.8.16-S2.2.1 - Establish and maintain behavioral baselines"
    apply_style(ws["A2"], styles["subheader"])
    ...
    checklist_items = [
        ...
        "Baselines established for application behavior",
    ...
    ref_data = [
        ...
        ("System Activity", "CPU, memory, disk I/O, process behavior", "14-30 days", "Weekly"),
        ("Network Traffic", "Bandwidth, protocols, connection patterns", "30 days", "Monthly"),
        ("Application Behavior", "Transaction rates, API calls, errors", "30-90 days", "Monthly"),
...
def create_detection_rules_sheet(ws, styles):
    ...
    checklist_items = [
        ...
        "Critical/High severity rules prioritized",
...
def create_mitre_coverage_sheet(ws, styles):
    ...
    checklist_items = [
        ...
        "Coverage gaps prioritized for remediation",
