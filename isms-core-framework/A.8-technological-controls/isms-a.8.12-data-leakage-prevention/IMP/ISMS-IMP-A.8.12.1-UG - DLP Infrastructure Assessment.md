<!-- ISMS-CORE:IMP:ISMS-IMP-A.8.12.1-UG:framework:UG:a.8.12.1 -->
...
| 2 | DLP Technology Inventory | Inventory of deployed DLP technologies |
| 3 | Network DLP | Network DLP deployment coverage and capability |
| 4 | Endpoint DLP | Endpoint DLP deployment coverage and capability |
| 5 | Email DLP | Email DLP deployment coverage and capability |
| 6 | Cloud CASB DLP | Cloud and CASB DLP deployment coverage and capability |
| 7 | Web DLP | Web DLP deployment coverage and capability |
| 8 | Database DAM | Database Activity Monitoring coverage and capability |
| 9 | Gap Analysis | Identify DLP infrastructure coverage gaps |
...
This assessment evaluates [Organisation]'s **DLP technology infrastructure** to ensure compliance with ISO/IEC 27001:2022 Control A.8.12 and applicable regulatory requirements.
...
- **Swiss nDSG (Art. 26):** Requires appropriate technical measures to prevent unauthorised data disclosure
- **EU GDPR (Art. 32):** Mandates technical measures to ensure security of personal data processing
- **Industry Standards:** PCI DSS v4.0.1 (Req. 3, 4), HIPAA Security Rule, SOC 2 all require data exfiltration protection
...
- [Organisation]'s DLP technology stack (vendors, versions, deployment models)
...
**Pro Tip:** For organisations with complex multi-vendor DLP environments (>5 different DLP products), consider splitting assessment across multiple team members:
...
- [Organisation]'s DLP technology stack (what vendors/products are deployed where)
- Network topology and egress points (where data can leave the organisation)
...
- **Network traffic analyser:** For verifying SSL/TLS inspection functionality
...
3. Complete **Organisation Metadata** section (yellow cells):
...
**Assessment Question:** *"What DLP technologies are currently deployed in your organisation?"*
...
**Assessment Question:** *"Does your organisation deploy network-based DLP appliances for traffic inspection?"*
...
| **Cloud Gateway** | Cloud-based DLP service (tunnel traffic to cloud) | No on-premise hardware, automatic updates | Latency, dependency on cloud | Distributed organisations, remote workforce |
...
- [Organisation] made risk-based decision not to deploy network DLP (e.g., small organisation, all endpoint-based DLP)
...
**Assessment Question:** *"Does your organisation deploy endpoint DLP agents on workstations and mobile devices?"*

**How to Answer:**

- **"Yes":** If endpoint DLP agents deployed on organisational devices (Windows, macOS, Linux, mobile)
...
| **Total Endpoints** | Organisation endpoint count | "1500", "5000", "250" | Asset inventory, endpoint management console |
...
- Endpoint DLP agents deployed on ≥95% of organisational endpoints
...
- [Organisation] has no endpoints requiring DLP (unlikely - would need risk acceptance)
...
- [ ] Organisation metadata completed (Assessment Date, Completed By, Organisation Name)
