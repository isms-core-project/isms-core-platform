<!-- ISMS-CORE:IMP:ISMS-IMP-A.8.1-7-18-19-S3-UG:framework:UG:a.8.1-7-18-19-s3 -->
**ISMS-IMP-A.8.1-7-18-19-S3-UG - Software Control Process**
...
| **Document ID** | ISMS-IMP-A.8.1-7-18-19-S3-UG |
...
This is the **User Completion Guide**. The companion Technical Specification is documented in ISMS-IMP-A.8.1-7-18-19-S3-TG.
...
| 2 | Approved Software | Maintain the approved software catalogue |
| 3 | Software Inventory | Record installed software across all endpoints |
| 4 | Unauthorised Software | Track and manage unauthorised software findings |
| 5 | Application Control | Assess application whitelisting and blacklisting controls |
| 6 | Change Control | Document software change requests and approvals |
| 7 | Vulnerability Management | Track software vulnerabilities and patch status |
| 8 | Licensing Compliance | Assess software licensing compliance |
| 9 | Capability Requirements | Define required software control capabilities |
| 10 | Gap Analysis | Identify gaps in software control implementation |
...
**Assessment Name:** ISMS-IMP-A.8.1-7-18-19-S3 - Software Control Process Assessment

#### What This Assessment Covers

This assessment evaluates [Organisation]'s software installation controls and application whitelisting effectiveness. This answers:
...
- What unauthorised software has been detected?
...
- ❌ Detective: "We scan for unauthorised software and remove it"
- ✅ Preventive: "Application controls prevent unauthorised installation, scanning validates"
...
- Unauthorised software detections
...
| S3 - Malware Protection | Protection | Malware often arrives via unauthorised software |
...
- **Monthly updates:** 3-4 hours (unauthorised software scanning)
...
3. ✅ Unauthorised software detections
...
2. Categorise (mandatory, role-specific, optional, prohibited)
...
#### Phase 4: Unauthorised Software Detection (2-3 hours)

**Objective:** Complete Sheet 3 - Unauthorised Software

**Steps:**
1. Compare installed software (Sheet 2) against approved list (Sheet 1)
2. Flag software not on approved list
3. Assess risk for each unauthorised software
4. Identify removal or approval path
5. Document exceptions

**Deliverable:** Complete Sheet 3 with unauthorised software list
...
4. Test effectiveness (can users install unauthorised software?)
...
**Steps:**
1. Document gaps in the Gap Analysis sheet
...
- Hacking/penetration tools (without authorised use)
...
- Unique software list (deduplicated)
...
**Why it matters:** Centrally deployed = controlled, user self-installed = may be unauthorised
...
For each unauthorised software:
...
**Step 5: Document Per Unauthorised Software**
...
```
Total Unauthorised Software: Count of unique software
Total Affected Endpoints: Count of endpoints with ≥1 unauthorised
Unauthorised Software by Risk: Critical, High, Medium, Low
Unauthorised Software by Category: Shadow IT, EOL, etc.
```

#### Common Mistakes to Avoid

❌ **Blanket removal** - Removing without assessing business impact  
❌ **No risk assessment** - Treating all unauthorised equally  
...
❌ **Ignoring licensing** - Unauthorised ≠ unlicensed (separate issue)  

#### Quality Checklist

- [ ] All unauthorised software identified
...
2. Attempt to install unauthorised software
...
- 7-Zip
- VLC Media Player
- Unauthorised browser extensions
...
#### Purpose
Document all gaps in software controls with prioritised remediation plans.

#### Gap Categories

1. No Approved Software List
2. Unauthorised Software Installed
...
**Step 1: Document Gaps from Assessment Sheets**

- From Sheet 1: Missing approved list, outdated list
- From Sheet 3: Unauthorised software
...
|-------|---------|
| Gap ID | GAP-A819-001 |
| Gap Category | Unauthorised/No Controls/Patch Failure/etc. |
...
- High-risk unauthorised software (malware, remote access)
...
- Unauthorised software (low risk)
...
❌ **Approving all unauthorised software**  

#### Quality Checklist

- [ ] All gaps documented in Gap Analysis sheet
...
Unauthorised Software Count: [X]
Unauthorised Software Risk: [X] Critical, [X] High
...
- Unauthorised software ≤5% of total
...
- Unauthorised installation blocking (required/desired)
...
- Unauthorised installation: [Block/Alert/Monitor]
...
3. **Unauthorised Software** - Detection reports, risk assessments
...
**Mistake:** Every unauthorised software gets retroactively approved
...
**Mistake:** Remove unauthorised software, users reinstall, repeat
...
- [ ] Gaps documented in Gap Analysis sheet
- [ ] Evidence registered
...
- [ ] Unauthorised software comparison accurate
...
- [ ] Unauthorised software not hidden
...
- [ ] Unauthorised software accurately identified
- [ ] Application control status verified
- [ ] Patch data current
