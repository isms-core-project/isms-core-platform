<!-- ISMS-CORE:IMP:ISMS-IMP-A.8.6.3-UG:framework:UG:a.8.6.3 -->
**ISMS-IMP-A.8.6.3-UG - Capacity Management Compliance Dashboard**
...
| Attribute | Value |
|-----------|-------|
| **Document ID** | ISMS-IMP-A.8.6.3-UG |
| **Version** | 1.0 |
...
This is the **User Completion Guide**. The companion Technical Specification is documented in ISMS-IMP-A.8.6.3-TG.
