...
| 2 | Authentication Inventory | Catalogue all authentication mechanisms across systems |
| 3 | Protocol Analysis | Assess authentication protocols in use |
| 4 | SSO Integration Status | Track single sign-on integration coverage |
| 5 | Password Policy | Review and assess password policy compliance |
| 6 | MFA Availability | Document MFA availability across all services |
| 7 | Legacy Authentication | Identify and track legacy authentication risks |
| 8 | Gap Analysis | Identify gaps in authentication controls |
...
- Inventories ALL authentication mechanisms across the organisation
