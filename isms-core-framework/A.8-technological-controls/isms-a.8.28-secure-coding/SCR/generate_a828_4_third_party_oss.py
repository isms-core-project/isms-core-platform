...
def get_oss_management_requirements():
    ...
    requirements = [
        ...
        (
            "O-14",
            "OSS contribution guidelines exist if organisation contributes to OSS projects",
...
def create_instructions_sheet(wb, styles):
    ...
    overview_text = """This assessment evaluates your organisation's management of third-party dependencies, open source software (OSS), vendor-provided components, and external code integrations.
...
DOMAIN 1: VENDOR SECURITY ASSESSMENT (Sheet: Vendor Security Assessment)
- Focus: Vendor due diligence, contracts, access controls, risk management
...
DOMAIN 2: OPEN SOURCE SOFTWARE MANAGEMENT (Sheet: OSS Management)
- Focus: OSS approval, inventory (SBOM), license tracking, abandoned dependencies
...
DOMAIN 3: DEPENDENCY VULNERABILITY MANAGEMENT (Sheet: Dependency Vulnerability Mgmt)
- Focus: SCA tools, vulnerability detection, remediation SLAs, lockfiles
...
DOMAIN 4: THIRD-PARTY CODE REVIEW & INTEGRATION (Sheet: Third Party Code Review)
- Focus: Integration security, API assessment, package integrity, supply chain attacks
...
DOMAIN 5: LICENSE COMPLIANCE & LEGAL RISK (Sheet: License Compliance)
- Focus: License identification, GPL/copyleft management, legal compliance
...
- Navigate to each domain sheet (Vendor Security Assessment, OSS Management, etc.)
...
Contracts: "Vendor contract with Beispiel AG, executed 12.11.2024, security clauses Section 8.1-8.5, contract ID: VC-2024-045"
...
def create_domain_assessment_sheet(wb, sheet_name, domain_title, requirements, styles, validations, column_widths):
    ...
    Args:
        wb: Workbook object
        sheet_name: Name of the sheet (e.g., "Vendor Security Assessment")
...
def create_summary_dashboard(wb, styles):
    ...
    # Domain rows
    domains = [
        ("Vendor Security Assessment", "Vendor Security Assessment", 18),
        ("OSS Management", "OSS Management", 18),
        ("Dependency Vulnerability Mgmt", "Dependency Vulnerability Mgmt", 18),
        ("Third-Party Code Review", "Third Party Code Review", 18),
        ("License Compliance", "License Compliance", 18),
    ]
    ...
    stats = [
        ...
        ("Evidence Completeness:", "=COUNTA('Evidence Register'!D2:D200)/COUNTA('Evidence Register'!A2:A200)"),
    ]
...
def create_approval_signoff(wb, styles, validations):
    ...
    summary_items = [
        ...
        ("Total Requirements:", "='Summary Dashboard'!B11"),
        ("Critical Gaps:", "='Summary Dashboard'!E11"),
    ]
...
def main():
    ...
    logger.info("  5. Third Party Code Review - 18 requirements")
    logger.info("  6. License Compliance - 18 requirements")
