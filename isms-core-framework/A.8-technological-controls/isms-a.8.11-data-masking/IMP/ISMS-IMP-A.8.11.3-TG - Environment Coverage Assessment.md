...
> Auto-generated from `generate_a811_3_environment_coverage.py`
...
| **Output Filename** | `ISMS-IMP-A.8.11.3_Environment_Coverage_Assessment_YYYYMMDD.xlsx` |
| **Workbook Title** | Environment Coverage Assessment |
...
| C | Classification | 18 |
| D | Hosting Location | 18 |
| E | Data Sensitivity | 18 |
| F | Masking Required? | 18 |
| G | Masking Deployed? | 18 |
| H | Masking Technique | 20 |
| I | Masking Tool/Solution | 22 |
| J | Coverage % | 12 |
| K | Last Verified Date | 15 |
| L | Environment Owner | 20 |
| M | Data Owner | 20 |
| N | Exception Approved? | 15 |
...
**Purpose:** Generic function to create assessment sheets.

**Frozen Panes:** A7

---

## Sheet 15: Validations
