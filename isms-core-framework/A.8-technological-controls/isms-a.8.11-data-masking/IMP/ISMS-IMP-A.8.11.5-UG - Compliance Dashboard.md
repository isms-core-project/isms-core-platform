<!-- ISMS-CORE:IMP:ISMS-IMP-A.8.11.5-UG:framework:UG:a.8.11.5 -->
**ISMS-IMP-A.8.11.5-UG - Compliance Dashboard**
...
| Attribute | Value |
|-----------|-------|
| **Document ID** | ISMS-IMP-A.8.11.5-UG |
| **Version** | 1.0 |
...
**Audience:** CISO, DPO, Security Managers, Compliance Officers
