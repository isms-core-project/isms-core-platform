...
def main():
    ...
    # Auto-find dashboard
    dashboard_file = find_workbook(workbooks_dir, 'A.8.11.5') or find_workbook(workbooks_dir, 'A.8.11_5')

    if not dashboard_file:
        print("❌ Dashboard not found (looking for A.8.11.5)")
        print("   Generate it first with: python3 generate_a811_5_compliance_dashboard.py")
        sys.exit(1)
