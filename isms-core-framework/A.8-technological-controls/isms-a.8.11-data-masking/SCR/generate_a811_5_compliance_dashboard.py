...
def create_comprehensive_instructions(ws, styles):
    ...
    workflow_steps = [
        ...
        ("", ""),
        ("Step 2: Normalize Files", "Run normalization script to create standardised filenames:"),
    ...
    usage_instructions = [
        ...
        "8. Evidence Index: Access centralised evidence trail for audit purposes",
    ...
    sheet_structure = [
        ...
        ("Sheet 9", "Remediation_Roadmap", "Prioritised action plan (50 items)"),
        ("Sheet 10", "Evidence_Master_Index", "Centralised evidence trail (100 entries)"),
...
def create_comprehensive_risk_register(ws, styles):
    ...
    predefined_risks = [
        ...
        ("R-811-006", "Key Management", "Loss, compromise, or unauthorised access to masking keys or algorithms", "Domain 2", 2, 5, "Implement HSM/KMS for key storage, rotate keys regularly, enforce access controls"),
...
def create_comprehensive_remediation_roadmap(ws, styles):
    ...
    # SUBTITLE
    ws.merge_cells('A2:N2')
    ws['A2'] = "Prioritised action plan for closing gaps and mitigating risks (50 action items)"
    apply_style(ws['A2'], styles["subheader"])
    ws.row_dimensions[2].height = 25
...
def create_comprehensive_evidence_index(ws, styles):
    ...
    ws['A2'] = "Centralised audit trail for all compliance evidence across all domains (100 entries)"
    apply_style(ws['A2'], styles["subheader"])
    ws.row_dimensions[2].height = 25
...
def main():
    ...
    logger.info("    3. This creates Dashboard_Sources/ with standardised filenames:")
    ...
    logger.info("   (Creates Dashboard_Sources/ with standardised filenames)")
    logger.info("")
