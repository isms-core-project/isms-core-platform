...
> Auto-generated from `generate_a89_3_monitoring.py` — DO NOT EDIT MANUALLY.
...
|---|-----------|
| 1 | Lookup Tables |
| 2 | Monitoring Coverage Register |
| 3 | Drift Detection Log |
| 4 | Monitoring Tool Inventory |
| 5 | Drift Remediation Tracking |
| 6 | False Positive Register |
| 7 | Monitor Effectiveness Metrics |
| 8 | Coverage Gap Analysis |
| 9 | Drift Trend Analysis |
| 10 | Summary Dashboard |
| 11 | Evidence Register |
| 12 | Approval Sign-Off |
| 13 | Instructions & Legend |
...
**Extracted:** 13 sheets, 14 columns, 21 validation values, 15 colors
