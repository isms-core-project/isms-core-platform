...
CONFIG = {
    'organization_name': '[Organisation]',  # Replace with your organization
...
def create_instructions_sheet(wb: Workbook) -> None:
    ...
    instructions = [
        ("PURPOSE", [
            "This workbook assesses [Organisation]'s compliance with security hardening standards "
        ...
        ("HARDENING STANDARD SELECTION", [
            ...
            "\u2022 Custom Standards: Organisation-specific requirements",
            "",
            "Standards should be:",
        ...
        ("COMPLIANCE SCORING", [
            ...
            f"\u2022 Overall Organisation: {COMPLIANCE_TARGETS['Overall']}%",
        ]),
