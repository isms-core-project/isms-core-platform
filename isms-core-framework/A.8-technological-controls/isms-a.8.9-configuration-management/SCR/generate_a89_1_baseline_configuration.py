...
def create_instructions_sheet(wb, styles):
    ...
    instructions = [
        ...
        "baselines across [Organisation]'s information assets. This assessment provides evidence of compliance "
        ...
        "8.  Deviation_Register - Authorised deviations from baselines (50 rows)",
        ...
        "\u2022 Use dropdowns for standardised entries - do not type free text where dropdown exists",
...
def create_approval_signoff_sheet(wb, styles):
    ...
    reviewer_fields = [
        ...
        ("Gaps Identified", ""),
        ("Review Attestation", 
         "I have reviewed this assessment and verify that it accurately represents [Organisation]'s baseline configuration status. Identified gaps have been documented for remediation."),
    ]
...
def main():
    ...
    logger.info("  8.  Deviation_Register - 50 rows for authorised deviations")
