...
def create_instructions_sheet(ws, styles):
    ...
    sheet_info = [
        ...
        ("Gap_Consolidation", "All gaps from WB1-5 prioritised"),
        ("Action_Items", "Prioritised remediation roadmap"),
...
def create_action_items_sheet(ws, styles):
    """Create Action Items sheet - prioritised remediation roadmap."""
    ...
    ws.merge_cells("A1:F1")
    cell = ws["A1"]
    cell.value = "Action Items - Prioritised Remediation Roadmap"
    apply_style(cell, styles["title"])
    ws.row_dimensions[1].height = 25
    
    # Instructions
    ws.merge_cells("A2:F2")
    ws["A2"] = "📋 Prioritised action items for remediation. Update status as gaps are resolved."
    apply_style(ws["A2"], styles["info_box"])
    ws.row_dimensions[2].height = 30
...
def main():
    ...
    logger.info("  4. Review Gap_Consolidation for prioritised gaps")
