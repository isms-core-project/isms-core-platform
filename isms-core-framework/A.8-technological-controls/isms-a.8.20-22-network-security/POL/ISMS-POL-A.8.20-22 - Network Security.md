<!-- ISMS-CORE:POLICY:ISMS-POL-A.8.20-22:framework:POL:a.8.20-22 -->
...
| **Document ID** | ISMS-POL-A.8.20-22 |
...
- ISMS-IMP-A.8.20-22.S1-UG/TG (Network Discovery)
- ISMS-IMP-A.8.20-22.S2-UG/TG (Architecture Documentation)
- ISMS-IMP-A.8.20-22.S3-UG/TG (Device Hardening)
- ISMS-IMP-A.8.20-22.S4-UG/TG (Services Security)
- ISMS-IMP-A.8.20-22.S5-UG/TG (Segmentation Implementation)
- ISMS-IMP-A.8.20-22.S6-UG/TG (Security Testing)
...
- **Specify technical implementation details** (see ISMS-IMP-A.8.20-22 Implementation Guides)
- **Define network topology or architecture** (see ISMS-IMP-A.8.20-22-S2 Architecture Documentation)
- **Provide device-specific configuration procedures** (see ISMS-IMP-A.8.20-22-S3 Device Hardening)
- **Define firewall rules or ACLs** (see ISMS-IMP-A.8.20-22-S5 Segmentation Implementation)
...
|---------------------|-------------------|-------------------------|
| **Network Topology Documentation** | Maintain current network diagrams (physical, logical, security views); Update documentation based on organisational change management | ISMS-IMP-A.8.20-22-S2 |
| **Network Device Inventory** | Comprehensive inventory of all network devices with ownership, criticality, compliance status; Updated from automated discovery | ISMS-IMP-A.8.20-22-S1 |
...
**Implementation Note**: Specific technical standards (cipher suites, protocol versions, configuration parameters) are defined in ISMS-IMP-A.8.20-22 implementation guides and may be updated without policy revision.

**Cloud Applicability**: Cloud network security (AWS VPC, Azure VNet, GCP VPC) **MUST** implement equivalent controls using cloud-native capabilities (security groups, network ACLs, virtual firewalls, cloud monitoring). See ISMS-IMP-A.8.20-22-S3 for cloud-specific guidance.
...
| **All Network Services** | Services catalog maintained; Service-specific monitoring; Availability SLA defined; Hardening per vendor guidelines; Regular patching | ISMS-IMP-A.8.20-22-S1, S4 |
...
| Requirement Category | Mandatory Controls | Implementation Reference |
|---------------------|-------------------|-------------------------|
| **Security Zones** | Define and document security zones; Assign trust levels (Untrusted, Semi-Trusted, Trusted); Document zone purpose, networks, VLANs, allowed traffic flows | ISMS-IMP-A.8.20-22-S5 |
| **Segmentation Architecture** | Minimum zones: DMZ, Internal, Management, Guest; Additional zones based on data classification and regulatory requirements (Server, Development, OT/ICS, Cloud) | ISMS-IMP-A.8.20-22-S5 |
| **VLAN Segregation** | VLANs for logical segmentation; VLAN security mechanisms; VLAN-to-zone mapping documented | ISMS-IMP-A.8.20-22-S5 |
...
- **New rules**: Firewall rule change request (template in ISMS-IMP-A.8.20-22-S5) completed and approved before implementation
...
**Implementation Note**: Specific VLAN assignments, subnet designs, and firewall rule templates are documented in ISMS-IMP-A.8.20-22-S5 and may be updated based on architecture changes without policy revision.

**Cloud Applicability**: Cloud network segmentation (VPCs, VNets, subnets, security groups, network ACLs) **MUST** implement equivalent controls. Public cloud flat networks (single VPC with no internal segmentation) **MUST** be remediated per risk assessment. See ISMS-IMP-A.8.20-22-S5 for cloud-specific guidance.
...
**Metric Governance**: Detailed metric definitions, collection methods, and trending analysis documented in ISMS-IMP-A.8.20-22-S6. Targets reviewed annually and adjusted based on organisational risk tolerance and operational maturity.
...
**Reference**: Detailed exception procedures in ISMS-IMP-A.8.20-22-S6.
...
**Reference**: Detailed incident response procedures in organisational incident response plan and ISMS-IMP-A.8.20-22-S6.
...
- **Scope**: ISMS-IMP-A.8.20-22 implementation guides (technical standards, procedures, configurations)
...
|---------|--------|---------------|----------------|
| **A.8.20 - Networks Security** | ☑ Applicable | [Organisation] operates network infrastructure requiring security controls | Section 2.1, ISMS-IMP-A.8.20-22-UG/TG |
| **A.8.21 - Security of Network Services** | ☑ Applicable | [Organisation] operates critical network services requiring security controls | Section 2.2, ISMS-IMP-A.8.20-22-UG/TG |
| **A.8.22 - Segregation of Networks** | ☑ Applicable | [Organisation] requires network segmentation to limit risk and meet regulatory requirements | Section 2.3, ISMS-IMP-A.8.20-22-UG/TG |
...
**Implementation Guidance** (ISMS-IMP-A.8.20-22):

| Document | Purpose | Scope |
|----------|---------|-------|
| **ISMS-IMP-A.8.20-22-S1** | Network Discovery Process | Automated and manual network discovery procedures; Tools and methodologies; Discovery validation |
| **ISMS-IMP-A.8.20-22-S2** | Network Architecture Documentation | Topology diagram requirements; Documentation standards; Update procedures |
| **ISMS-IMP-A.8.20-22-S3** | Device Hardening Process | Device-specific hardening procedures; CIS benchmark application; Configuration templates; Wireless and VPN security |
| **ISMS-IMP-A.8.20-22-S4** | Network Services Security Process | Service-by-service security implementation (DNS, DHCP, NTP, proxy, load balancers); Monitoring and availability |
| **ISMS-IMP-A.8.20-22-S5** | Segmentation Implementation | Zone design process; VLAN configuration; Firewall rule development; ACL implementation; Cloud segmentation |
| **ISMS-IMP-A.8.20-22-S6** | Network Security Testing | Segmentation effectiveness testing; Penetration testing; VLAN hopping tests; Service security testing |
