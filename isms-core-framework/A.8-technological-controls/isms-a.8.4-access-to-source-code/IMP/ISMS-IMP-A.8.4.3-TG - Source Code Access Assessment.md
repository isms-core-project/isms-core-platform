<!-- ISMS-CORE:IMP:ISMS-IMP-A.8.4.3-TG:framework:TG:a.8.4.3 -->
...
> Auto-generated from `generate_a84_3_compliance_dashboard.py`
...
| **Output Filename** | `ISMS-IMP-A.8.4.3_Source_Code_Security_Compliance_Dashboard_YYYYMMDD.xlsx` |
| **Workbook Title** | Source Code Security Compliance Dashboard |
