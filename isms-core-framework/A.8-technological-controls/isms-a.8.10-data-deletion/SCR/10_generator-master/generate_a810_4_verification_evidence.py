...
def populate_instructions_sheet(ws, styles):
    ...
    ws['A8'] = ("This workbook assesses an organization's deletion verification and evidence management "
    ...
    instructions_data = [
        ["Sheet", "Purpose"],
        ["Deletion Logging Assessment", "Evaluate centralized logging infrastructure and completeness"],
    ...
    reference_tables = {
        "Table 1: Required Log Fields (NIST SP 800-88 R1 Alignment)": [
            ...
            },
            {
                ...
                "Required?": "Mandatory",
                "Example Value": "jdoe@company.com",
...
def populate_sheet3_testing(ws, styles):
    ...
    checklist_items = [
        ...
        "Failure trends are analyzed to identify systemic issues",
...
def populate_sheet4_repository(ws, styles):
    ...
    checklist_items = [
        ...
        "Repository access controls restrict evidence to authorized personnel",
...
def populate_sheet5_certificates(ws, styles):
    ...
    checklist_items = [
        ...
        "Certificate issuer authority is validated (authorized vendor personnel)",
        ...
        "Table 1: Certificate Quality Scoring Rubric (0-100 Points)": [
            {
                ...
                "Points": "20",
                "Criteria for Full Points": "Valid signature from authorized vendor representative"
            },
            {
    ...
    reference_tables = {
        ...
        "Table 2: Reconstruction Test Procedure": [
            ...
            },
            {
                ...
                "Procedure": "Confirm authorized personnel at each stage",
                "Expected Result": "All actors authorized",
                "Fail Criteria": "Unauthorized actor found"
            },
            {
