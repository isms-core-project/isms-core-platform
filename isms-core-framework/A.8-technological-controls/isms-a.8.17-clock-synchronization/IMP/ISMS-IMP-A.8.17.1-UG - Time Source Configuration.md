...
This is the **User Completion Guide**. The companion Technical Specification is documented in ISMS-IMP-A.8.17.1-TG.
...
| 2 | Time Sources | Document authoritative external time sources |
| 3 | Internal NTP Servers | Document internal NTP server infrastructure |
| 4 | Hierarchy | Document the NTP hierarchy and time distribution |
| 5 | Summary Dashboard | Compliance status and key metrics overview |
...
**Assessment Name:** ISMS-IMP-A.8.17.1 - Time Source Inventory Assessment

**What This Assessment Covers:**

This assessment documents the time source infrastructure that provides authoritative time for all organisational systems. Think of this as mapping the "root of truth" for time across your entire IT environment. This assessment answers critical questions:
...
Think of this as documenting the "master clocks" for your organisation - just like a radio station needs atomic clocks for precise broadcast timing, your organisation needs documented, authoritative time sources for logging, authentication, and forensics.
...
2. **Internal_NTP_Servers** - Organisation's internal NTP infrastructure (Stratum 2)
...
- **Network Infrastructure Knowledge** - Know organisation's NTP server deployments and configurations
...
When an auditor asks: *"How does your organisation ensure accurate time across all systems?"*
...
- Document public sources (NIST, Cloudflare, NTP Pool) vs. private (GPS, organisation-owned)
...
| | | | **GPS**: Organisation-owned GPS receiver | Physical hardware on premise |
...
| | | | **Atomic Clock**: Organisation-owned atomic clock | |
...
| F | **Provider** | Optional | Organisation or entity providing the time service | Well-known for public services |
...
| | | | **Organisation-owned:** Internal SLA or `N/A` | |
...
- If it's inside your organisation and YOU manage it → Internal_NTP_Servers
