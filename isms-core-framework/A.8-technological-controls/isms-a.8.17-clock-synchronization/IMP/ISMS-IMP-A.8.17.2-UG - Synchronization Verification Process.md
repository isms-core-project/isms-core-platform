...
This is the **User Completion Guide**. The companion Technical Specification is documented in ISMS-IMP-A.8.17.2-TG.
...
| 2 | System Inventory | Inventory of systems and their synchronisation status |
| 3 | Drift Analysis | Measure and analyse time drift across systems |
| 4 | Gap Analysis | Identify synchronisation failures and coverage gaps |
...
- [ ] **List of internal NTP servers** from ISMS-IMP-A.8.17.1 (you should have completed this FIRST)
...
**PREREQUISITE:** Complete ISMS-IMP-A.8.17.1 (Time Source Assessment) FIRST!
...
- **Typical:** 100-1000+ systems depending on organisation size
