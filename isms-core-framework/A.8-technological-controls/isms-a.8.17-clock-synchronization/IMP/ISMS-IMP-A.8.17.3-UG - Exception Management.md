...
This is the **User Completion Guide**. The companion Technical Specification is documented in ISMS-IMP-A.8.17.3-TG.
...
| 2 | Exception Requests | Log new requests for synchronisation exceptions |
| 3 | Active Exceptions | Track currently approved synchronisation exceptions |
| 4 | Expired Exceptions | Record expired exceptions and renewal requirements |
...
**Assessment Name:** ISMS-IMP-A.8.17.3 - Exception Management Assessment
...
- Organisation's risk assessment methodology
...
| D | **Business Owner [*]** | REQUIRED | Person accountable for the system | CMDB, organisational chart |
...
- Typical organisations: 1-10 pending requests
