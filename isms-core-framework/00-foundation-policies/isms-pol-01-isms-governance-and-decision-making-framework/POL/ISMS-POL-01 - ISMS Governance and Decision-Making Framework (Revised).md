...
| I need to... | Go to |
|---|---|
| Understand who decides what | Section 2.1 (Authority Boundaries) |
| Check competence requirements for a role | Section 2.3 (Competence Requirements) |
| Determine regulatory applicability | Section 3.1 (Regulatory Applicability) → POL-00 |
| Determine control applicability | Section 3.2 (Control Applicability) → SoA |
| Handle a disagreement with an auditor | Section 3.3 (Applicability Challenge Protocol) |
| Process a control exception | Section 4.2 (Exception Process — 5-step) |
| Track exception volume and health | Section 4.4 (Exception Volume Monitoring) |
| Manage a compliance criteria change | Section 5.2 (Change Process — 6-step) |
| Track reassessment after a change | Section 5.4 (Reassessment Tracking) |
| Prepare for the annual governance review | Section 6.1 (Annual Governance Review) |
| Record a lesson learned | Section 6.2 (Lessons Learned Register) |
| Prepare documentation for an audit | Section 9.1 (Documents Provided to Auditors) |
...
The following roles exercise decision-making authority for ISMS governance. Each role operates within a defined **authority domain** — these are functional responsibilities, not a hierarchy of seniority:

| Authority Domain | Role | Decision Scope | Competence Requirement |
|-----------------|------|----------------|----------------------|
| **Technical Security** | Chief Information Security Officer (CISO) | Technical control design, operational feasibility, evidence sufficiency, day-to-day implementation decisions | Information security expertise (CISSP/CISM or equivalent, 5+ years experience), technical background, ISO 27001 knowledge |
| **Regulatory & Legal** | Legal/Compliance Officer | Regulatory requirements interpretation, contractual obligations, legal risk assessment, POL-00 Tier determinations | Legal training or compliance certification, regulatory monitoring capability, access to external legal counsel where needed |
| **Data Protection** | Data Protection Officer (DPO) | Privacy-specific controls (A.5.34, GDPR/nDSG compliance), data subject rights, privacy impact assessments. The DPO exercises independent authority within this domain per GDPR Article 38.3 and cannot receive instructions regarding the exercise of these tasks. | GDPR/nDSG expertise, data protection certification (CIPP/E or equivalent), independence per GDPR Article 38 |
| **Strategic & Risk** | Executive Management (CEO/Board) | Strategic risk decisions, resource allocation, risk acceptance (Clause 6.1.3d), ISMS scope changes, major architecture decisions | Fiduciary responsibility for organisational risk, ultimate accountability for ISO 27001 certification, budget authority |
...
- **For Alternative Control**:
  - Control objective mapping (ISO 27001 Annex A objective → alternative implementation)
...
| Version | Date | Author | Changes |
|---------|------|--------|---------|
| 1.0 | [Date] | CISO | Initial approved release |
| 1.1 | [Date] | CISO | Clarified evidence retention period (Section 7), no requirement change |
| 2.0 | [Date] | CISO | Updated encryption minimum to AES-256 per GDPR guidance (Section 4.2), major requirement change |
```
...
| Field | Description | Example |
|-------|-------------|---------|
| Change ID | Unique identifier | CHG-[YEAR]-[SEQ] |
| Change Date | Date change implemented | [Date] |
...
| Verification Status | Is change verified effective? (Step 6) | Verified - Internal audit confirmed AES-256 deployment |
...
| Field | Description | Example |
|-------|-------------|---------|
| Gap ID | Linked to Change ID | GAP-[YEAR]-[SEQ] (linked to CHG-[YEAR]-[SEQ]) |
...
| Target Closure | Remediation deadline | [Date + 90 days from change identification] |
...
*The following entries are illustrative examples showing the expected format and level of detail. Replace with actual entries during ISMS operation.*

| Date | Event | Lesson Learned | Action Taken | Status | Verified |
|------|-------|----------------|--------------|--------|----------|
| *Q1 [Year]* | *Auditor challenged A.8.15 interpretation (Section 3.3 invoked)* | *Provide more explicit rationale in SoA justifications — auditor needed specific ISO 27001 control objective mapping* | *Enhanced SoA template: added mandatory "ISO 27001 Objective Mapping" field for all "Not Applicable" controls* | *Implemented* | *Internal Audit Q2 [Year] confirmed SoA updates* |
| *Q2 [Year]* | *Exception approval delayed 30 days (Executive Management unavailable during approval cycle)* | *Establish backup approval authority for urgent exceptions to prevent delays* | *Updated Section 4.2: CFO can approve risk acceptances in CEO absence, documented in exception register* | *Implemented* | *Policy updated, approval workflow tested Q3 [Year]* |
| *Q3 [Year]* | *Change reassessment missed 90-day target (gap register tracking manual, reminder missed)* | *Improve gap register tracking with automated reminders* | *Integrated gap register with GRC platform, configured weekly email reminders for items approaching 90-day deadline* | *In Progress* | *GRC platform deployment 80% complete, target Q4 [Year]* |
| *Q4 [Year]* | *Quarterly POL-00 monitoring skipped Q3 (Legal/Compliance resource constraint)* | *Build monitoring redundancy — CISO can conduct interim monitoring if Legal unavailable* | *Updated POL-00 Section 4.3: CISO authorised to conduct monitoring with Legal/Compliance review when available, documented in monitoring log* | *Planned* | *POL-00 update drafted, pending Legal approval* |
...
- This policy document (ISMS-POL-01)
- Approval signatures from CISO, Legal/Compliance, Executive Management (Document Control section)
- Governance structure documented (Section 2.1 Authority Boundaries table)
- Competence requirements defined (Section 2.3)
- Exception handling process documented (Section 4.2 5-step process)
- Change management process documented (Section 5.2 6-step process)
- Annual review process defined (Section 6.1)
...
**Note**: Stage 2 evidence accumulates over time through normal ISMS operation. The categories below define what evidence the organisation will produce and where it is maintained. Evidence collection is tracked separately in the Governance Compliance Assessment Workbook (Section 8.3).
