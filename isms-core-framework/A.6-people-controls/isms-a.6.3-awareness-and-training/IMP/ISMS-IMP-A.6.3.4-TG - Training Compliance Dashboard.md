<!-- ISMS-CORE:IMP:ISMS-IMP-A.6.3.4-TG:framework:TG:a.6.3.4 -->
...
> Auto-generated from `generate_a63_4_training_compliance_dashboard.py`
...
| **Output Filename** | `ISMS-IMP-A.6.3.4_Training_Compliance_Dashboard_YYYYMMDD.xlsx` |
| **Workbook Title** | Training Compliance Dashboard |
...
| B | KPI_Name | 30 |
| C | Definition | 50 |
| D | Calculation_Method | 35 |
| E | Target_Value | 15 |
| F | Measurement_Frequency | 20 |

---

## Sheet 15: Approval_Signoff
