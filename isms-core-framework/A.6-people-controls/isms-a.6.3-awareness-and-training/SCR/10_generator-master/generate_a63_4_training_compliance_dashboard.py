...
EFFECTIVENESS_METRICS = [
    ("Behavior", "Phishing Click Rate", "≤5%", "IMP-A.6.3.3 Simulation_Results"),
    ("Behavior", "Phishing Report Rate", "≥70%", "IMP-A.6.3.3 Simulation_Results"),
    ("Behavior", "Credential Submission Rate", "≤1%", "IMP-A.6.3.3 Simulation_Results"),
...
def create_effectiveness_metrics_sheet(ws, styles):
    ...
    ws["A1"] = "EFFECTIVENESS METRICS\nMeasure training impact on security behavior"
    ws["A1"].font = styles["header"]["font"]
    ws["A1"].fill = styles["header"]["fill"]
    ws["A1"].alignment = styles["header"]["alignment"]
    ws.row_dimensions[1].height = 40
