...
EVENT_CATEGORIES = [
    ...
    ("Malware/System Compromise", "Unexpected behavior, pop-ups, ransomware indicators"),
    ("Unauthorized Access", "Unknown login attempts, unexpected account changes"),
    ("Data Breach/Leakage", "Misdirected emails, unauthorized data exposure"),
