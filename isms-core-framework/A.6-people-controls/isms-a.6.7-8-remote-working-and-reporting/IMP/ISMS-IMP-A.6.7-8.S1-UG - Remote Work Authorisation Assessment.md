<!-- ISMS-CORE:IMP:ISMS-IMP-A.6.7-8.S1-UG:framework:UG:a.6.7-8 -->
**ISMS-IMP-A.6.7-8.S1-UG - Remote Work Authorisation Assessment**
...
| 2 | Eligibility Criteria | Define criteria for remote work eligibility |
| 3 | Authorisation Register | Track remote work authorisations per employee |
| 4 | Risk Assessment | Document risk assessments for remote work arrangements |
| 5 | Physical Security | Assess remote work location physical security |
| 6 | Acknowledgments | Track employee acknowledgement of remote work terms |
| 7 | Gap Analysis | Identify gaps against remote work policy requirements |
...
This assessment workbook evaluates [Organisation]'s remote work authorisation framework, ensuring that:
- Formal authorisation processes exist for remote work arrangements
- Authorisation criteria are defined and consistently applied
- Risk assessments are performed for high-risk remote work scenarios
- Documentation requirements are met
- Periodic reviews maintain authorisation currency

#### 1.2 Scope

This assessment covers:
- Remote work policy framework and governance
- Authorisation request and approval workflows
- Risk assessment procedures for remote work
- Documentation and record-keeping
- Periodic review and re-authorisation processes
...
| Triggered Review | After significant policy changes, security incidents, or organisational restructuring |
...
└─────────────────────────────────────────────────────────────────┘
                              ↓
┌─────────────────────────────────────────────────────────────────┐
│  PHASE 2: Authorisation Process Assessment                      │
...
│  - Select sample of remote work authorisations                  │
...
#### 4.3 Authorisation_Process Sheet

**Purpose**: Document and assess the remote work authorisation workflow.

**Column Definitions**:

| Column | Description | Input Type |
|--------|-------------|------------|
| Process Step | Step in the authorisation workflow | Pre-populated |
...
#### 4.4 Authorisation_Criteria Sheet

**Purpose**: Verify that authorisation criteria are defined and appropriate.

**Column Definitions**:

| Column | Description | Input Type |
|--------|-------------|------------|
| Criterion Category | Type of authorisation criterion | Pre-populated |
...
**Purpose**: Test a sample of actual remote work authorisations for compliance.

**Sample Selection**:
- Minimum 10% of remote workers or 20 personnel (whichever is greater)
- Include mix of: new authorisations, long-standing, different departments
...
**Purpose**: Assess whether remote work authorisations are periodically reviewed.
...
**Purpose**: Track all gaps identified across assessment areas in the Summary Dashboard.
...
- Authorisation process maturity
...
|-------------------|----------|
| Policy Documentation | Remote work policy, authorisation procedure |
| Process Documentation | Workflow diagrams, approval forms |
| Authorisation Records | Approved remote work requests |
...
**The Problem:** Reviewing remote work policy documents but not checking whether the authorisation process actually works as documented.
...
**The Fix:**
- Always include sample testing of actual authorisations
...
**Why It Matters:** Informal remote workers may lack security controls. They represent shadow IT risk. Organisation may be unaware of full remote workforce scope.
...
**Why It Matters:** Third parties often have same or greater access than employees. Contractor remote access may have weaker controls. Third-party incidents can impact organisation.
...
**The Problem:** Assessing current authorisations without verifying that departed employees had access promptly revoked.
...
**The Problem:** Treating all remote work authorisations equally, not checking enhanced scrutiny for sensitive roles.
...
**The Problem:** Assessing standard authorisations but not reviewing approved exceptions to policy.
...
**Sample Testing:**
- [ ] Sample size meets minimum (≥10 authorisations or 10% of population)
...
| Unauthorised remote workers found | Initiate immediate security review |
...
1. **Store Assessment:**
   ...
   - Filename: `ISMS-IMP-A.6.7-8.S1_Authorisation_[DATE]_APPROVED.xlsx`
