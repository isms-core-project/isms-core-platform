...
"""
================================================================================
A.6.4-5 Workbook Normalizer
================================================================================

Normalizes all A.6.4-5 workbooks to ensure consistent formatting, styling,
and structure across all generated Excel files.

Usage:
    python3 normalize_a645.py
================================================================================
"""
...
def normalize_workbook(filepath: Path) -> bool:
    ...
    try:
        ...
        for ws in wb.worksheets:
            ...
            # Ensure all column headers (row 3) have consistent styling
            if ws.max_column > 1:
        ...
        wb.save(filepath)
        logger.info(f"  OK Normalized successfully")
        return True
...
def main() -> int:
    ...
    workbooks = list(WORKBOOK_DIR.glob("ISMS-IMP-A.6.4-5*.xlsx"))

    if not workbooks:
        logger.info("No A.6.4-5 workbooks found to normalize")
        return 0
