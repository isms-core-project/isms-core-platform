...
def create_policy_assessment_sheet(ws, styles):
    ...
    requirements = [
        ...
        ("REQ-003", "Policy explicitly prohibits unauthorised activities", "Prohibited Use", "Unauthorised software, data exfiltration"),
        ...
        ("REQ-012", "Cloud service usage rules", "Cloud Services", "Approved vs unauthorised"),
