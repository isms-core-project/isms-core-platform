...
def create_instructions_sheet(ws, styles):
    ...
    instructions = [
        "",
        "PURPOSE",
        "This workbook establishes the organisation's information classification scheme as required by",
        ...
        "1. Review and customise classification levels in Classification_Levels sheet",
