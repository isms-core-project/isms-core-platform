<!-- ISMS-CORE:IMP:ISMS-IMP-A.5.12-13.S5-UG:framework:UG:a.5.12-13 -->
**ISMS-IMP-A.5.12-13.S5-UG - Consolidation Dashboard**
...
| Field | Value |
|-------|-------|
| **Document ID** | ISMS-IMP-A.5.12-13.S5-UG |
| **Version** | 1.0 |
...
This is the **User Completion Guide**. The companion Technical Specification is documented in ISMS-IMP-A.5.12-13.S5-TG.
...
- [ ] ISMS-IMP-A.5.12-13.S4 - Compliance Dashboard (completed)
...
|   |-- 2026/
|   |   |-- Q1/
|   |   |   |-- ISMS-IMP-A.5.12-13.S5_Consolidation_Dashboard_20260331.xlsx
|   |   |-- Q2/
|   |   |-- Q3/
|   |   |-- Q4/
|   |   |-- Annual/
