<!-- ISMS-CORE:IMP:ISMS-IMP-A.5.34.4-UG:framework:UG:a.5.34.4 -->
**ISMS-IMP-A.5.34.4-UG - Technical and Organisational Measures (TOMs) Assessment**
...
| Attribute | Value |
|-------|-------|
| **Document Title** | Technical and Organisational Measures (TOMs) Assessment |
...
- **PART 2: TECHNICAL SPECIFICATION (Sheets 1-4)** (Second file)
  ...
  - Sheet 4: Organisational Measures Deep-Dive (O1-O10 detailed layout)
...
| **2. TOM Control Inventory** | Inventory of all 20 GDPR Article 32 technical and organisational measures |
| **3. Technical Measures Detail** | Deep-dive assessment of T1–T10 technical measures (encryption, pseudonymisation, etc.) |
| **4. Organisational Measures Det.** | Deep-dive assessment of O1–O10 organisational measures (policies, training, etc.) |
| **5. Evidence Repository** | Evidence collected to support TOMs compliance |
| **6. Gap Analysis & Risk** | Gap identification and risk scoring for non-compliant or partial TOMs |
| **7. Remediation Action Plan** | Tracked remediation actions with owners, deadlines, and SLA status |
...
This assessment evaluates **Technical and Organisational Measures (TOMs)** protecting PII processing to ensure compliance with:
...
**Organisational Measures (O1-O10):**
...
- Detailed technical/organisational descriptions
...
- Data breaches cost organisations an average of $4.45M (IBM 2023)
...
### Organisational Security Documentation
...
5. **Compliance Officer** - Organisational measure documentation (O1-O10), policy verification, audit readiness
...
- **Initial assessment:** 40-60 hours total across all stakeholders
  ...
  - Compliance Officer: 12-16 hours (organisational measures O1-O10)
...
- Gather organisational evidence (policies, training, audits)
...
- **Sheet 4 (Organisational Measures):** For each O1-O10:
...
2. Review the 20 TOM categories (T1-T10 Technical, O1-O10 Organisational)
...
- **Rows 12-21:** O1-O10 (Organisational Measures) - pre-filled in Columns A-B
- **Columns A-B:** TOM ID and TOM Category (locked - do not edit)

**For EACH TOM (Rows 2-21), Complete Columns C-N:**

### Column C - TOM Type
**Pre-filled:** Technical or Organisational (locked)
...
- Topics: Data minimisation, pseudonymization, DSR handling, breach response
...
- **Organisational controls (O1-O10):** Annually or after major changes
...
3. **50 contractor laptops** (managed by contractor employer, not by [Organisation])
...
- Applications: Salesforce Event Monitoring (user login, data export, API calls), SAP Security Audit Log (transaction logs, authorisation changes), GitHub Audit Log (code commits, access changes)
...
**Purpose:** Detailed organisational documentation of O1-O10 implementation

**Structure:** One section per TOM (O1-O10), each section contains 5 fields

**For EACH Organisational Measure (O1-O10), Document:**
...
- Module: "GDPR & Swiss FADP Compliance for [Organisation] Employees"  
- Duration: 60 minutes (self-paced online)
- Content: PII definition, lawful basis for processing, data minimisation, purpose limitation, data subject rights, consent requirements, breach notification, international transfers, employee responsibilities
...
- Content: Data minimisation techniques, pseudonymization, anonymization, encryption, access control, secure data transfer, data retention, secure disposal, DSR handling, consent management, breach response, vendor management, DPIA requirements
...
- **Accountability:** Data Owners accountable for: Lawfulness of processing, Data quality, Data minimisation, Retention compliance, Vendor management (processors), DPIA approval, DSR handling, Breach reporting
...
- **DSR compliance monitoring (quarterly):**
  ...
  → Sample 20 DSR requests per quarter, verify: (1) SLA compliance (30-day response), (2) Completeness of response, (3) Evidence of verification, (4) Proper redaction/minimisation, (5) Documentation in DSR log
...
- **Knowledge sharing:** DPO shares learnings with organisation:
...
- **Organisational measures (O1-O10):** Compliance/Legal teams (DPO, Compliance Officer, Legal Counsel)
...
### Section 2: Technical vs. Organisational (Rows 14-21)
...
- **Organisational Measures Implemented:** `=COUNTIFS('2. TOM Control Inventory'!C2:C21,"Organisational",'2. TOM Control Inventory'!D2:D21,"Implemented")`
- **Organisational Measures Total:** 10
- **Organisational Implementation Rate:** `=Organisational Implemented / 10`
- **Analysis:** Technical measures typically easier to implement (buy tools/deploy technology), organisational measures require culture change and sustained effort
...
**For Organisational Measures (O1-O10), Gather:**
...
**Gap:** Many organisations deploy controls but never test them. Result: False sense of security.

**Remediation:** 

- Establish testing program for all implemented controls (quarterly technical controls, annually organisational controls)
...
**Gap:** Organisations round up coverage percentages. Result: Gaps hidden, auditor finds discrepancies.
...
## Pitfall 9: Ignoring Organisational Measures (O1-O10)
**Issue:** Focusing solely on technical controls (T1-T10) while neglecting organisational controls (O1-O10).

**Assessment:** Organisational measures are equally important for GDPR Art. 32 compliance.

**Gap:** Technical controls without organisational support fail. Example: Encryption (T1) deployed but no training (O2) → users store PII in unencrypted file shares.

**Remediation:**

- Give equal attention to O1-O10
- Ensure organisational measures support technical measures
...
- [ ] All 10 organisational measures (O1-O10) documented
...
- [ ] Governance: Organisational chart, reporting lines, meeting frequency clear
...
- [ ] Evidence currency (technical evidence <3 months, organisational evidence <12 months)
...
- [ ] Evidence current (technical: <3 months, organisational: <12 months)
