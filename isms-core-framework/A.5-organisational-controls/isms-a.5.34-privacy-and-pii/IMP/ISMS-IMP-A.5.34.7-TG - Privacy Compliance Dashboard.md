<!-- ISMS-CORE:IMP:ISMS-IMP-A.5.34.7-TG:framework:TG:a.5.34.7 -->
...
> Auto-generated from `generate_a5347_compliance_dashboard.py`
...
| Property | Value |
|----------|-------|
| **Document ID** | `ISMS-IMP-A.5.34.7` |
| **Output Filename** | `ISMS-IMP-A.5.34.7_Privacy_Compliance_Dashboard_YYYYMMDD.xlsx` |
| **Workbook Title** | Privacy Compliance Dashboard |
...
| A | Domain |
| B | Domain Name |
| C | Evidence Items Required |
| D | Evidence Items Collected |
| E | Completeness % |
| F | Status |
| G | Last Updated |
| H | Notes |
