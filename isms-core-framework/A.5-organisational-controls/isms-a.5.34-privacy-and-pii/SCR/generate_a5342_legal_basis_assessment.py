...
3. Legit. Interest Assessments - LIA balancing tests (Purpose/Necessity/Balancing)
...
def create_sheet3_lia(wb):
    ...
    """
    ws = wb.create_sheet("3. Legit. Interest Assessments")
...
def create_sheet7_dashboard(wb):
    ...
    lia_metrics = [
        ...
        ("LIAs Completed", f"=COUNTA('3. Legit. Interest Assessments'!A2:A{MAX_ROWS_LIA})"),
        ("LIA Completion Rate", f"=IF(B{row}=0, 0, B{row+1}/B{row})"),
        ("LIAs Passed", f"=COUNTIF('3. Legit. Interest Assessments'!M2:M{MAX_ROWS_LIA}, \"Pass*\")"),
        ("LIAs Failed", f"=COUNTIF('3. Legit. Interest Assessments'!M2:M{MAX_ROWS_LIA}, \"Fail*\")"),
        ("LIAs Pending DPO Approval", f"=COUNTIF('3. Legit. Interest Assessments'!P2:P{MAX_ROWS_LIA}, \"Pending\")")
    ]
...
def generate_legal_basis_assessment_workbook(output_file, date_str=None):
    ...
    logger.info("  3. Legit. Interest Assessments")
