<!-- ISMS-CORE:IMP:ISMS-IMP-A.5.19-23.S4-UG:framework:UG:a.5.19-23 -->
**ISMS-IMP-A.5.19-23.S4-UG - Ongoing Governance & Risk Management**
...
| **Document ID** | ISMS-IMP-A.5.19-23.S4-UG |
...
This is the **User Completion Guide**. The companion Technical Specification is documented in ISMS-IMP-A.5.19-23.S4-TG.
...
**Assessment Name:** ISMS-IMP-A.5.19-23.S4 - Ongoing Governance & Risk Management

#### What This Assessment Covers

This assessment evaluates the **operational governance and continuous monitoring** of ALL cloud services identified in your inventory (ISMS-IMP-A.5.19-23.S1). While previous assessments focused on initial selection, configuration, and vendor evaluation, this assessment answers the critical question:
...
**1. Completed Assessment Workbook (ISMS-IMP-A.5.19-23.S4_Governance_YYYYMMDD.xlsx):**
...
```
☐ ISMS-IMP-A.5.19-23.S1 (Inventory) is current (within 90 days)
   Why: You need the authoritative service list to govern
   
☐ ISMS-IMP-A.5.19-23.S2 (Vendor DD) has baseline vendor risk ratings
   Why: Ongoing monitoring tracks changes from baseline
   
☐ ISMS-IMP-A.5.19-23.S3 (Config) has baseline configurations documented
...
```
☐ Last quarter's ISMS-IMP-A.5.19-23.S4 workbook
...
☐ Prepare Service List
  ☐ Export current services from ISMS-IMP-A.5.19-23.S1
...
☐ Notify Stakeholders
  ...
  It's time for our quarterly cloud governance assessment (ISMS-IMP-A.5.19-23.S4).
...
```
ISMS-IMP-A.5.19-23.S4 (This Assessment)
     │
     ├─▶ INPUT FROM:
     │    ├─ ISMS-IMP-A.5.19-23.S1 (Service list)
     │    ├─ ISMS-IMP-A.5.19-23.S2 (Vendor baseline risk)
     │    ├─ ISMS-IMP-A.5.19-23.S3 (Config baseline)
     ...
     │
     └─▶ OUTPUT TO:
          ├─ ISMS-IMP-A.5.19-23.S5 (Dashboard - governance metrics)
...
☐ ISMS-IMP-A.5.19-23.S4_Governance_Q[X]_YYYY.xlsx (main workbook)
...
**Critical Context:** This assessment (ISMS-IMP-A.5.19-23.S4) is ONE component of the comprehensive A.5.19-23 supplier/cloud security framework. It does not operate in isolation.
...
wb = openpyxl.load_workbook("ISMS-IMP-A.5.19-23.S4.xlsx", data_only=True)
...
ISMS-IMP-A.5.19-23.S4_Governance_[YYYY-MM-DD].xlsx

Examples:

- ISMS-IMP-A.5.19-23.S4_Governance_2026-01-20.xlsx (Q1 2026 assessment)
- ISMS-IMP-A.5.19-23.S4_Governance_2026-04-20.xlsx (Q2 2026 assessment)
- ISMS-IMP-A.5.19-23.S4_Governance_2026-07-20.xlsx (Q3 2026 assessment)
- ISMS-IMP-A.5.19-23.S4_Governance_2026-10-20.xlsx (Q4 2026 assessment)
...
\\fileserver\ISMS\Assessments\5.23.4-Governance\Archive\
  ├─ 2025\
  │  ├─ ISMS-IMP-A.5.19-23.S4_Governance_2025-04-15.xlsx
  │  ├─ ISMS-IMP-A.5.19-23.S4_Governance_2025-07-15.xlsx
  │  ├─ ISMS-IMP-A.5.19-23.S4_Governance_2025-10-15.xlsx
  │  └─ ISMS-IMP-A.5.19-23.S4_Governance_2026-01-15.xlsx
  ├─ 2026\
  │  ├─ ISMS-IMP-A.5.19-23.S4_Governance_2026-04-20.xlsx (Q1)
  │  └─ ISMS-IMP-A.5.19-23.S4_Governance_2026-07-20.xlsx (Q2) [CURRENT]
...
- ISMS-IMP-A.5.19-23.S5: Compliance Monitoring & Exit Planning
