...
| **Document ID** | ISMS-IMP-A.5.19-23.S2-UG |
...
This is the **User Completion Guide**. The companion Technical Specification is documented in ISMS-IMP-A.5.19-23.S2-TG.
...
**Assessment Name:** ISMS-IMP-A.5.19-23.S2 - Vendor Due Diligence & Contracts

#### What This Assessment Covers

This assessment evaluates the **security and contractual posture** of ALL cloud service providers identified in your cloud service inventory (ISMS-IMP-A.5.19-23.1). This is where you verify that vendor claims match reality and that contracts protect [Organisation]'s interests.
...
- **ISMS-IMP-A.5.19-23.S2_VendorDD_YYYYMMDD.xlsx** (10-sheet workbook)
