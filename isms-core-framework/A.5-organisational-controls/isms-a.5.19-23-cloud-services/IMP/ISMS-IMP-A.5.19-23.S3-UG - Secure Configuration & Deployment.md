...
| **Document ID** | ISMS-IMP-A.5.19-23.S3-UG |
...
This is the **User Completion Guide**. The companion Technical Specification is documented in ISMS-IMP-A.5.19-23.S3-TG.
...
**Assessment Name:** ISMS-IMP-A.5.19-23.S3 - Secure Configuration & Deployment
...
- **ISMS-IMP-A.5.19-23.S3_SecureConfig_YYYYMMDD.xlsx** (10-sheet workbook)
