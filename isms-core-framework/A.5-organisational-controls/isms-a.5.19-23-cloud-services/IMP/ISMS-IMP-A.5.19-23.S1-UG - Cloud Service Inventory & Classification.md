...
**ISMS-IMP-A.5.19-23.S1-UG - Cloud Service Inventory & Classification**
...
| **Document ID** | ISMS-IMP-A.5.19-23.S1-UG |
...
This is the **User Completion Guide**. The companion Technical Specification is documented in ISMS-IMP-A.5.19-23.S1-TG.
...
**Assessment Name:** ISMS-IMP-A.5.19-23.S1 - Cloud Service Inventory & Classification
...
|------------|-------|--------------------------|
| **ISMS-IMP-A.5.19-23.S1** | **Inventory & Classification** | **WHAT services exist** (START HERE) |
| ISMS-IMP-A.5.19-23.S2 | Vendor Due Diligence | WHO provides services (uses this inventory) |
| ISMS-IMP-A.5.19-23.S3 | Secure Configuration | HOW services are configured (uses this inventory) |
| ISMS-IMP-A.5.19-23.S4 | Ongoing Governance | HOW services are managed (uses this inventory) |
...
- ISMS-IMP-A.5.19-23.S2 (Vendor Due Diligence) - Uses service/vendor list
- ISMS-IMP-A.5.19-23.S3 (Secure Configuration) - Uses service list and criticality
- ISMS-IMP-A.5.19-23.S4 (Ongoing Governance) - Uses service list and ownership
...
```
/Evidence/ISMS-IMP-A.5.19-23.S1/
  /Contracts/
...
```
/Evidence/ISMS-IMP-A.5.19-23.S1/Services/[Vendor_Service_Name]/
...
- **Classification:** Categorisation by data type, criticality, etc.
