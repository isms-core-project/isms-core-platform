...
**ISMS-REF-A.5.19-23 — Cloud Service Provider Reference Registry**
...
| **Document ID** | ISMS-REF-A.5.19-23 |
...
|---------|------|--------|---------|
| 1.0 | [Date] | CISO / IT Operations | Initial registry |
...
- Standardise provider categorisation across ISMS
...
1. **ISMS-IMP-A.5.19-23.x** — Cloud Services Assessment workbooks
