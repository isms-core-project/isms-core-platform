...
│ • ISMS-IMP-A.5.23.S1.md - Inventory & Classification        │
│ • ISMS-IMP-A.5.23.S2.md - Vendor Due Diligence              │
│ • ISMS-IMP-A.5.23.S3.md - Secure Configuration              │
│ • ISMS-IMP-A.5.23.S4.md - Ongoing Governance                │
└─────────────────────────────────────────────────────────────┘
                           ↓
┌─────────────────────────────────────────────────────────────┐
...
- ISMS-IMP-A.5.23.S1 - Inventory & Classification Spec
- ISMS-IMP-A.5.23.S2 - Vendor Due Diligence Spec
- ISMS-IMP-A.5.23.S3 - Secure Configuration Spec
- ISMS-IMP-A.5.23.S4 - Ongoing Governance Spec
