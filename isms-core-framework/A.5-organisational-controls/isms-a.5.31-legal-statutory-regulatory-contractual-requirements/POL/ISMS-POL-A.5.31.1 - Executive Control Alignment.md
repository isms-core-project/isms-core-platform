...
- Requirements categorisation (§2.2): Technical/Organisational/Reporting/Operational classification
...
- Three-tier categorisation structure:
...
│  STRUCTURE: Three-tier categorisation                │
...
- Specifies three-tier categorisation framework (Mandatory/Conditional/Informational)
...
- Requirements categorisation procedures
...
- Requirements Register (ISMS-IMP-A.5.31.3 assessment workbook) - extracted requirements from applicable regulations with categorisation
