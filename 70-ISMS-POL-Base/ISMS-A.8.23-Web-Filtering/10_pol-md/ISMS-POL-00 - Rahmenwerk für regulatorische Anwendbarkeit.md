...
## 1. Regulatory Applicability-Kategorien

### 1.1 Kategoriedefinitionen
...
### 2.4 Weitere Mandatory Regulations
...
### 3.3 Network and Information Security Directive 2 (NIS2)
...
### 3.5 Health Insurance Portability and Accountability Act (HIPAA)
...
### 3.6 Federal Information Security Management Act (FISMA)
...
### 3.7 Weitere Conditional Regulations
...
## 4. Informational Reference / Best Practice (Tier 3)
...
### 4.5 Cloud Security Alliance (CSA)
...
### 4.6 Weitere Best Practice Frameworks
...
## 5. United States Federal Requirements (Spezielle Kategorie)
...
## 6. Bestimmung der Regulatory Applicability

### 6.1 Assessment-Prozess
...
### 6.3 Wann Re-Assessment durchführen
...
## 7. Verwendung in ISMS Policies

### 7.1 Standard-Referenzsprache
...
```markdown
### 1.3 Anwendbarkeit von Regulatory Frameworks
