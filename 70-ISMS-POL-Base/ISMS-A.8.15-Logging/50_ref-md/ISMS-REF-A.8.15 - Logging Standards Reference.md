...
## 2. Syslog Format Standards (RFC 5424)
...
### 2.6 Syslog Configuration Example
...
### 3.5 CEF Examples by Event Type
...
### 4.6 JSON Examples by Event Type
...
## 7. Character Encoding and Escaping
...
### 7.2 Special Character Escaping
...
### 8.1 Log Format Selection Matrix
...
### 8.2 SIEM Integration Considerations
...
### 8.3 Logging Library Recommendations
...
## 10. Relationship to ISMS-POL-A.8.15
