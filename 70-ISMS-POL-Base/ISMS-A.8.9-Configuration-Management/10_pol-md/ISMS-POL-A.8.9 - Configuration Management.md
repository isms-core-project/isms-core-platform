...
### 1.1 ISO/IEC 27001:2022 Control A.8.9
...
### 2.2 Baseline Configuration Management
...
### 2.3 Change Control & Configuration Updates
...
### 2.4 Configuration Monitoring & Drift Detection
...
### 2.5 Security Hardening & Compliance
...
|--------|--------|-----------|-------|
| **Baseline Coverage** | ≥90% of assets | Monthly | Configuration Manager |
