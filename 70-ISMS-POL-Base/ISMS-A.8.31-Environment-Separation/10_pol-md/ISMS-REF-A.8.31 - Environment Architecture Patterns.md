...
### 1.3 Relationship to ISMS Policy
...
## 2. AWS (Amazon Web Services) Multi-Account Pattern
...
### 2.5 Deployment Pipeline Integration
...
## 3. Azure Multi-Subscription Pattern
...
## 4. GCP (Google Cloud Platform) Project Pattern
...
## 5. Kubernetes Environment Separation
...
### 5.2 Namespace-Based Separation
...
## 6. On-Premises / Traditional Infrastructure

### 6.1 VLAN-Based Separation
...
### 6.2 Physical Separation (High Security)
...
## 7. Hybrid Cloud Patterns

### 7.1 Cloud + On-Premises Hybrid
...
### 8.1 AWS Multi-Account Separation
...
### 8.2 Kubernetes Namespace Separation
...
### 9.1 Choosing Separation Approach
