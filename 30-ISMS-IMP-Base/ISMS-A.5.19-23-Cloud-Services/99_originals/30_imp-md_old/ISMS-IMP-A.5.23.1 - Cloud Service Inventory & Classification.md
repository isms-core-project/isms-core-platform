...
#### Header Section
- **Title:** "ISMS-IMP-A.5.23.S1 – Cloud Service Inventory & Classification"
...
- ISMS-IMP-A.5.23.S2: Vendor Due Diligence Assessment (pulls service list from this workbook)
- ISMS-IMP-A.5.23.S3: Secure Configuration Assessment (pulls service list from this workbook)
...
- ISMS-IMP-A.5.23.S5 (Compliance Dashboard) - pulls inventory metrics
- ISMS-IMP-A.5.23.S2 (Vendor DD) - references service names
- ISMS-IMP-A.5.23.S3 (Configuration) - references service names
