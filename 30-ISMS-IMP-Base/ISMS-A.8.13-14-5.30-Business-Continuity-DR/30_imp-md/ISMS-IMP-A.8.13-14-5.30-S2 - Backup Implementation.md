...
| Attribute | Value |
|-----------|-------|
| **Document ID** | ISMS-IMP-A.8.13-14-5.30-S2 |
| **Version** | 1.0 |
| **Assessment Area** | Backup Implementation & Recovery Capability |
| **Related Policy** | ISMS-POL-A.8.13-14-5.30, Section 2.1 (Information Backup Requirements) |
| **Related Assessment** | ISMS-IMP-A.8.13-14-5.30-S1 (BIA - provides RPO requirements) |
...
**END OF ISMS-IMP-A.8.13-14-5.30-S2**
