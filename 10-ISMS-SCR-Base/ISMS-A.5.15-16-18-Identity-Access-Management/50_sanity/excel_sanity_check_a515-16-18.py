...
6. IAM Governance Dashboard (external workbook link validation)
...
def detect_workbook_type(filename):
    ...
    if 'user_inventory' in filename_lower or 'iam_1' in filename_lower:
        return 'WB1', 'User Inventory & Lifecycle Compliance'
    elif 'access_rights_matrix' in filename_lower or 'iam_2' in filename_lower:
        return 'WB2', 'Access Rights Matrix'
    elif 'access_review' in filename_lower or 'iam_3' in filename_lower:
        return 'WB3', 'Access Review Results'
    elif 'role_compliance' in filename_lower or 'iam_4' in filename_lower:
        return 'WB4', 'Role Compliance & SoD'
    elif 'lifecycle_compliance' in filename_lower or 'iam_5' in filename_lower:
