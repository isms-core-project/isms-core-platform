...
**Usage:**
    python3 sanity_check_dashboard_a86.py ISMS_A_8_6_3_Dashboard_YYYYMMDD.xlsx
...
def main():
    if len(sys.argv) < 2:
        ...
        print("\nExample:")
        print("  python3 sanity_check_dashboard_a86.py ISMS_A_8_6_3_Dashboard_20250128.xlsx")
        print("\nExit codes:")
