...
"""
================================================================================
ISMS-IMP-A.7.4.2 - Physical Environmental Protection Assessment Excel Generator
================================================================================
...
Output:
    ISMS-IMP-A.7.4.2_Environmental_Protection_YYYYMMDD.xlsx
...
def create_instructions_sheet(ws, styles):
    ...
    ws["A1"] = (
        "ISMS-IMP-A.7.4.2 - Physical Environmental Protection Assessment\n"
        "ISO/IEC 27001:2022 - Control A.7.4: Physical Security Monitoring"
    )
...
def create_approval_signoff(ws, styles):
    ...
    summary_fields = [
        ("Assessment Document", "ISMS-IMP-A.7.4.2 - Environmental Protection Assessment"),
        ("Assessment Period", ""),
...
if __name__ == "__main__":
    print(f"\n{'='*70}")
    print("ISMS Physical Environmental Protection Assessment (A.7.4.2)")
    print(f"{'='*70}\n")
    
    try:
        wb = create_workbook()
        filename = f"ISMS-IMP-A.7.4.2_Environmental_Protection_{datetime.now().strftime('%Y%m%d')}.xlsx"
        wb.save(filename)
