...
**Usage:**
    python3 sanity_check_a84_dashboard.py ISMS_A_8_4_X_Assessment_YYYYMMDD.xlsx
...
def main():
    if len(sys.argv) < 2:
        ...
        print("\nExamples:")
        print("  python3 sanity_check_a84_dashboard.py ISMS_A_8_4_1_Repository_Access_20250125.xlsx")
        print("  python3 sanity_check_a84_dashboard.py ISMS_A_8_4_2_Branch_Protection_20250125.xlsx")
        print("  python3 sanity_check_a84_dashboard.py ISMS_A_8_4_3_Compliance_Dashboard_20250125.xlsx")
        print("\nBatch check all workbooks:")
        print("  for file in ISMS_A_8_4_*.xlsx; do")
