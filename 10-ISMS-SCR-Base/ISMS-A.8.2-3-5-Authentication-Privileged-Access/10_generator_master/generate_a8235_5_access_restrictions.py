...
"""
================================================================================
ISMS-IMP-A.8.2-3-5-5 - Information Access Restriction Assessment Excel Generator
================================================================================
...
Output:
    ISMS-IMP-A.8.2-3-5.5_Access_Restrictions_Assessment_YYYYMMDD.xlsx
...
DOCUMENT_ID = "ISMS-IMP-A.8.2-3-5.5"
VERSION = "1.0"
CONTROL_REF = "ISO/IEC 27001:2022 A.8.3 (Information Access Restriction)"
...
def setup_styles():
    return {
        ...
        'subheader': {'font': {'bold': True}, 'fill': {'patternType': 'solid', 'fgColor': 'D9E1F2'},
...
def create_workbook():
    ...
    sheets = ["Instructions_Legend", "File_System_Permissions", "Database_Access_Controls",
              ...
              "Evidence_Register", "Approval_Sign_Of"]
...
def populate_instructions(wb, styles):
    ...
    ws['A1'] = "Technical Access Control & Restriction Assessment"
...
def generate_workbook():
    print("\n╔════════════════════════════════════════════════════════════════╗")
    print("║  ISMS Assessment A.8.2/3/5 - Workbook 5: Access Restrictions   ║")
    print("╚════════════════════════════════════════════════════════════════╝\n")
    ...
    filename = f"ISMS-IMP-A.8.2-3-5.5_Access_Restrictions_{GENERATED_TIMESTAMP}.xlsx"
    wb.save(filename)
