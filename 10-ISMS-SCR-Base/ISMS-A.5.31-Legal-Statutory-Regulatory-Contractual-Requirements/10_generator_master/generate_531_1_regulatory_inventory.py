...
def populate_instructions_sheet(wb):
    ...
    title_cell = ws["A1"]
    title_cell.value = "REGULATORY INVENTORY - INSTRUCTIONS"
...
def main():
    ...
    print("Control A.5.31 - Workbook 1: Regulatory Inventory")
    print("=" * 70)
    print()
    ...
    # Populate sheets
    print("📝 Populating Regulatory Inventory sheet...")
    ...
    print(f"   File: ISMS_Assessment_531_1_Regulatory_Inventory.xlsx")
    print(f"   Location: ../90_workbooks/")
    print(f"   Sheets: 3 (Regulatory_Inventory, Instructions, Summary_Metrics)")
    print(f"   Sample Data: 8 example regulations (Tiers 1-3, various jurisdictions)")
    print()
    print("📋 Features:")
    print("   ✓ Data validation (Tier, Applicability Status dropdowns)")
    print("   ✓ Conditional formatting (color-coded by tier and status)")
    ...
    print("   2. Review sample data and structure")
    print("   3. Customize for [Organization]'s regulatory landscape")
    print("   4. Perform applicability assessments (use Workbook 2)")
    print("   5. Extract requirements from applicable regulations (use Workbook 3)")
    print()
    print("=" * 70)
