...
Controls A.8.13, A.8.14, and A.5.30 requirements, supporting evidence-based
...
Basic Usage:
    python3 generate_a813_3_rpo_rto_compliance.py

Advanced Usage:
    # Generate with custom output directory
    python3 generate_a813_3_rpo_rto_compliance.py --output /path/to/dir
    
    # Generate with specific date suffix
    python3 generate_a813_3_rpo_rto_compliance.py --date 20250125
