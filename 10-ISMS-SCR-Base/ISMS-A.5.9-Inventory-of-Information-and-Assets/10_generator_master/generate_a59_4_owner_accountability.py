...
def main():
    ...
    print("="*80)
    print("ISMS Control A.5.9 - Owner Accountability Assessment Generator")
    print("="*80)
    print()
    ...
    print("  2. Populate ownership coverage (assign all assets to owners)")
    print("  3. Launch attestation campaign (email owners)")
    print("  4. Track acknowledgment responses and send reminders")
    print("  5. Conduct awareness checks (owner knowledge verification)")
    print("  6. Assess owner performance (reviews, responsiveness, engagement)")
    print("  7. Review Accountability Metrics for overall accountability index")
    print("  8. Export CSV from Sheet 6 for dashboard consolidation")
    print("  9. Obtain stakeholder review and approval")
    print()
...
def create_instructions_sheet(ws):
    ...
    ws['A1'] = "ISMS Control A.5.9 - Owner Accountability Assessment"
