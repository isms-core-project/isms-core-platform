...
def main():
    ...
    print("="*80)
    print("ISMS Control A.5.9 - Quality & Compliance Assessment Generator")
    print("="*80)
    print()
    ...
    print("  2. Determine sample sizes for accuracy sampling")
    print("  3. Perform accuracy sampling (verify sample records)")
    print("  4. Run completeness checks (mandatory fields)")
    print("  5. Assess currency (data freshness)")
    print("  6. Perform consistency checks (cross-system)")
    print("  7. Evaluate policy compliance")
    print("  8. Review Quality Metrics & Scoring for overall quality index")
    print("  9. Export CSV from Sheet 7 for dashboard consolidation")
    print("  10. Obtain stakeholder review and approval")
    print()
...
def create_instructions_sheet(ws):
    ...
    ws['A1'] = "ISMS Control A.5.9 - Quality & Compliance Assessment"
...
def create_policy_compliance_sheet(ws):
    ...
    requirements = [
        ("Asset Ownership", "[Organization] SHALL assign an owner to each asset", 100),
        ("Classification", "[Organization] SHALL classify information assets by sensitivity", 100),
        ...
        ("Inventory Maintenance", "[Organization] SHALL maintain current and accurate inventory", 100),
        ("Periodic Review", "Asset owners SHALL review assets at least annually", 100),
        ("Decommissioning", "[Organization] SHALL follow secure decommissioning procedures", 100),
    ]
