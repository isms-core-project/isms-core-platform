...
| Field | Value |
|-------|-------|
| **Document ID** | ISMS-IMP-A.6.4-5.2 |
...
**Out of Scope:**
- Disciplinary process leading to termination (covered in ISMS-IMP-A.6.4-5.1)
- Post-employment obligations and NDA tracking (covered in ISMS-IMP-A.6.4-5.3)
...
**CORRECT**: Include NDA reminder in exit interview; provide written summary of continuing obligations; obtain signed acknowledgement; reference ISMS-IMP-A.6.4-5.3
...
| Attribute | Value |
|-----------|-------|
| **Filename** | `ISMS-IMP-A.6.4-5.2_Employment_Exit_Assessment_YYYYMMDD.xlsx` |
...
Standard styling as per ISMS framework - see Section 2.6 of ISMS-IMP-A.6.4-5.1.
