...
| Field | Value |
|-------|-------|
| **Document ID** | ISMS-IMP-A.6.4-5.1 |
...
**Out of Scope:**
- Employment exit procedures (covered in ISMS-IMP-A.6.4-5.2)
- Post-employment obligations (covered in ISMS-IMP-A.6.4-5.3)
...
|-------------|-------|--------------|
| ISMS-IMP-A.6.4-5.2 | Employment Exit Assessment | Exit process post-termination |
| ISMS-IMP-A.6.4-5.3 | Post-Employment Obligations | Continuing obligations tracking |
| ISMS-IMP-A.6.4-5.4 | Employment Exit Dashboard | Metrics and reporting |
...
| Attribute | Value |
|-----------|-------|
| **Filename** | `ISMS-IMP-A.6.4-5.1_Disciplinary_Process_Assessment_YYYYMMDD.xlsx` |
...
└── isms-a.6.4-5-employment-exit/
    └── 90_workbooks/
        └── ISMS-IMP-A.6.4-5.1_Disciplinary_Process_Assessment_YYYYMMDD.xlsx
```
