...
# -*- coding: utf-8 -*-
"""
Normalize A.6.6 Confidentiality/NDA Workbooks

Ensures consistent formatting, cell styling, and data validation
across all assessment workbooks for this control.
"""
...
def main() -> int:
    logger.info("=" * 60)
    logger.info("A.6.6 Workbook Normalization")
    logger.info("=" * 60)
    ...
    workbooks = list(WORKBOOK_DIR.glob("ISMS-IMP-A.6.6*.xlsx"))
